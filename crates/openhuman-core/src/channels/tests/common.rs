...
// `crate::agent::bus` as `BUS_HANDLER_LOCK` (re-exported from
...
// `crate::agent::bus`) or the generic `mock_bus_stub` in
// `crate::core::bus` for arbitrary bus methods.
pub(super) use crate::agent::bus::use_real_agent_handler;
