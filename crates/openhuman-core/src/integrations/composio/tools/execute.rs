//! The `composio_execute` agent tool: sandbox/scope gating, calendar and
//! task-recency argument defaults, dispatch through
//! [`super::super::execute_dispatch`], and response shaping.
