...
//! [`turn_origin`](crate::agent::turn_origin): the embedder scopes a
...
//! let turn = openhuman_core::agent::progress_sink::with_progress_sink(tx, async {
...
/// the same reason [`turn_origin::with_origin`](crate::agent::turn_origin::with_origin)
