...
fn response_to_model_response(
    ...
    if let Some(block) = crate::agent::message_convert::reasoning_content_block(
...
/// crate-native model (e.g. [`OpenHumanBackendModel`](crate::inference::provider::OpenHumanBackendModel))
