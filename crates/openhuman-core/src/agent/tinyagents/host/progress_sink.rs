...
//!
//! Adapts `crate::agent::progress` (the `AgentProgress` UI contract)
...
//! [`crate::web_chat::progress_bridge::spawn_progress_bridge`]: the
        ...
        match ev {
            ...
            ProgressEvent::ToolCallFinished {
                ...
                let failure = if success {
                    ...
                    Some(crate::tools::status::classify(&output, false))
                };
            ...
            ProgressEvent::Finished { run, usage } => {
                ...
                // `crate::agent::cost::TurnCost`, fed from the
