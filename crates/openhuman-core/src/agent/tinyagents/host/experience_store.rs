...
//! procedural memory in [`crate::agent_experience`], written today by
//! [`AgentExperienceCaptureHook`](crate::agent::experience::AgentExperienceCaptureHook)
...
//! confined to
//! [`AGENT_EXPERIENCE_NAMESPACE`](crate::agent::experience::AGENT_EXPERIENCE_NAMESPACE)
...
//!    [`redact_text`](crate::agent::experience::redact_text) over the
