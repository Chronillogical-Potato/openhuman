...
| `middleware/research_budget.rs` | Forces a top-level direct web research turn to answer after eight completed search or fetch calls. |
| `middleware/stream_stall.rs` | Stops repeated streamed narration before it can continue indefinitely. |
