...
- Preserve user-authored task content, acceptance criteria, allowed tools, evidence, blockers, and source metadata unless the user explicitly asks to replace them.
