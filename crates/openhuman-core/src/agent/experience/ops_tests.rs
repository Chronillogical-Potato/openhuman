...
async fn experience_store_round_trips_over_the_bound_driver() {
    ...
    let experience = AgentExperience {
        ...
        outcome: crate::agent::experience::types::ExperienceOutcome::Success,
        error_class: None,
...
fn driver_over(provider: crate::memory::guard::test_support::RecordingProvider) -> DriverMemory {
...
async fn recall_relevant_by_vector_keeps_hits_above_the_vector_floor_only() {
    use crate::memory::guard::test_support::{namespace_hit, RecordingProvider};
