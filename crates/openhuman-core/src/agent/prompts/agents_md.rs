...
//! [`crate::agent::prompts::PromptContext`] and rendered by
...
//! [`crate::agent::prompts::BOOTSTRAP_MAX_CHARS`] with a
//! `[... truncated]` marker.
...
pub fn load_agents_md(dir: &Path) -> Option<String> {
    ...
    if let Err(e) = crate::security::validate_path_within_root(&path, dir) {
        log::warn!(
