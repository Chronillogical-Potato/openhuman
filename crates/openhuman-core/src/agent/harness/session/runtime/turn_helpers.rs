...
impl Agent {
    ...
    pub(in crate::agent::harness::session) fn new_entries_for_turn<'a>(
    ...
    /// associate results.
    pub(in crate::agent::harness::session) fn with_fallback_tool_call_ids(
    ...
    /// returned as-is.
    pub(in crate::agent::harness::session) fn persisted_tool_calls_for_history(
