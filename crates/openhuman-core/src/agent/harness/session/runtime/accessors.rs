...
use super::super::types::{Agent, AgentBuilder};
...
impl Agent {
    ...
    pub(in crate::agent::harness::session) fn event_session_id(&self) -> &str {
        &self.event_session_id
    }

    pub(in crate::agent::harness::session) fn event_channel(&self) -> &str {
        &self.event_channel
    }
    ...
    /// [`AgentBuilder::workspace_descriptor`](crate::agent::AgentBuilder::workspace_descriptor),
    ...
    pub(in crate::agent::harness::session) fn rebuild_tool_policy_session(&mut self) {
