//! Out-of-band provider calls that finish a turn: the tools-disabled wrap-up
//! summary and required-output enforcement / repair.
...
impl Agent {
    ...
    pub(in crate::agent::harness::session::turn) async fn summarize_turn_wrapup(
        &self,
