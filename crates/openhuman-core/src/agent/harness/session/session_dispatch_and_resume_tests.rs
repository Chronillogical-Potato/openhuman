...
async fn turn_with_native_dispatcher_handles_tool_results_variant() {
    ...
    let provider = Arc::new(MockProvider {
        responses: Mutex::new(vec![
            crate::inference::provider::ChatResponse {
...
fn seed_resume_from_messages_is_noop_on_warm_agent() {
    ...
    agent.cached_transcript_messages = Some(vec![
        crate::agent::messages::ChatMessage::system("warm prefix"),
        crate::agent::messages::ChatMessage::user("hi"),
    ]);
    agent
...
fn bound_cached_transcript_messages_without_system_prefix_keeps_tail() {
    ...
    let messages = vec![
        crate::agent::messages::ChatMessage::user("u1"),
        crate::agent::messages::ChatMessage::assistant("a1"),
        crate::agent::messages::ChatMessage::user("u2"),
        crate::agent::messages::ChatMessage::assistant("a2"),
        crate::agent::messages::ChatMessage::user("u3"),
    ];
