...
async fn run_typed_mode(
    ...
    let status = if early_exit_tool.as_deref() == Some("ask_user_clarification") {
        ...
        let checkpoint_data =
            crate::agent::harness::subagent_runner::types::SubagentCheckpointData {
                task_id: task_id.to_string(),
                agent_id: definition.id.clone(),
                worker_thread_id: options.worker_thread_id.clone(),
        ...
        crate::agent::harness::subagent_runner::types::SubagentRunStatus::AwaitingUser {
            question,
            options: options_vec,
            checkpoint,
        }
        ...
        crate::agent::harness::subagent_runner::types::SubagentRunStatus::Incomplete { reason }
    } else if hit_cap {
        ...
        crate::agent::harness::subagent_runner::types::SubagentRunStatus::Incomplete {
        ...
        crate::agent::harness::subagent_runner::types::SubagentRunStatus::Completed
    };
