//! `run_phase` step: fan a phase's agents out on the intra-phase tinyagents
//! graph, aggregate outcomes, and persist the new phase state.
...
pub(crate) enum PhaseExecOutcome {
