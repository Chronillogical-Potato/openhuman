...
async fn fetch_live_connected_toolkit_slugs_once() -> Option<Vec<String>> {
    ...
    match crate::integrations::composio::fetch_connected_integrations_status(&config).await {
        crate::integrations::composio::FetchConnectedIntegrationsStatus::Authoritative(entries) => {
        ...
        crate::integrations::composio::FetchConnectedIntegrationsStatus::Unavailable => None,
    }
}
