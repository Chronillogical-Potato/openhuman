...
pub(crate) fn build(root_config: &Config, params: SearchToolParams) -> Vec<Box<dyn Tool>> {
    ...
    vec![
        Box::new(crate::search::tools::ExaSearchTool::new_web_search_tool(
            api_key.clone(),
            None,
            params.max_results,
            params.timeout_secs,
        )),
        Box::new(crate::search::tools::ExaSearchTool::new(
            api_key.clone(),
            None,
            params.max_results,
            params.timeout_secs,
        )),
        Box::new(crate::search::tools::ExaFindSimilarTool::new(
            api_key.clone(),
            None,
            params.max_results,
            params.timeout_secs,
        )),
        Box::new(crate::search::tools::ExaGetContentsTool::new(
            api_key,
            None,
            params.max_results,
            params.timeout_secs,
