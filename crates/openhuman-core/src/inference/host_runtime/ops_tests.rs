...
fn grant_turn_cwd_adds_a_read_write_root() {
    ...
    assert_eq!(granted.access, crate::security::TrustedAccess::ReadWrite);
}
...
fn grant_turn_cwd_leaves_an_existing_entry_alone() {
    ...
    config
        ...
        .push(crate::security::TrustedRoot {
            ...
            access: crate::security::TrustedAccess::Read,
        });
...
async fn agent_chat_for_rejects_an_unknown_agent_id() {
    use crate::inference::host_runtime::ops::{agent_chat_for, AgentChatTarget};
    let tmp = tempfile::tempdir().unwrap();
...
fn agent_chat_target_default_is_the_orchestrator() {
    use crate::inference::host_runtime::ops::AgentChatTarget;
