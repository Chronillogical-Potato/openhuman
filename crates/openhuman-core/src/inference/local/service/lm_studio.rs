...
impl LocalAiService {
    pub(in crate::inference::local::service) async fn ensure_lm_studio_available(
        &self,
        config: &Config,
    ) -> Result<(), String> {
    ...
    pub(in crate::inference::local::service) async fn list_lm_studio_models(
        &self,
        config: &Config,
    ...
    pub(in crate::inference::local::service) async fn has_lm_studio_model(
        &self,
        config: &Config,
        model: &str,
    ) -> Result<bool, String> {
