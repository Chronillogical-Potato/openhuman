...
impl LocalAiService {
    ...
    pub(in crate::inference::local::service) async fn list_models_at(
        &self,
        base: &str,
    ...
    pub(in crate::inference::local::service) async fn list_models_at_with_timeout(
        &self,
        base: &str,
    ...
    pub(in crate::inference::local::service) async fn fetch_model_show_at(
        &self,
        base_url: &str,
        model: &str,
    ) -> OllamaModelShow {
