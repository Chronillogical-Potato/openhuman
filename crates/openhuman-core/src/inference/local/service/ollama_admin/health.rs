...
pub(in crate::inference::local::service) enum OllamaHealthStatus {
...
impl LocalAiService {
    ...
    pub(in crate::inference::local::service) async fn ollama_health_status_at(
        &self,
        base_url: &str,
    ) -> OllamaHealthStatus {
        tracing::debug!(
    ...
    pub(in crate::inference::local::service) async fn ollama_healthy_at(
        &self,
        base_url: &str,
    ) -> bool {
        tracing::debug!(
    ...
    pub(in crate::inference::local::service) async fn ollama_healthy(&self) -> bool {
    ...
    pub(in crate::inference::local::service) fn ollama_binary_present(
        &self,
        config: &Config,
    ) -> bool {
    ...
    pub(in crate::inference::local::service) async fn ollama_runner_ok_at(
        &self,
        base_url: &str,
    ) -> bool {
        let resp = self
    ...
    /// a desktop app.
    pub(in crate::inference::local::service) async fn kill_ollama_server(&self) {
    ...
    pub(in crate::inference::local::service) fn resolve_binary_path(
        &self,
        config: &Config,
    ) -> Option<String> {
    ...
    pub(in crate::inference::local::service) async fn has_model_for_config(
        &self,
        config: &Config,
        model: &str,
    ) -> Result<bool, String> {
    ...
    pub(in crate::inference::local::service) async fn has_model_at(
        &self,
        base_url: &str,
        model: &str,
    ) -> Result<bool, String> {
