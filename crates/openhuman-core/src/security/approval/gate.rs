...
//!    [`crate::security::live_policy`]). Hit → `Allow`
...
/// `Workflow` [`AgentTurnOrigin`](crate::agent::turn_origin::AgentTurnOrigin),
...
fn publish_flow_gate_notification(
    ...
    use crate::desktop::notifications::bus::publish_core_notification;
