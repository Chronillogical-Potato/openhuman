...
The contract lives in the top-level `crates/openhuman-core/src/media/image/` module and
...
`crates/openhuman-core/src/media/generation/` domain ships **wired, executing** tools that
