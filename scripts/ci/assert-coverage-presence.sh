...
eligible() {
  ...
  case "${f}" in src/* | crates/openhuman-core/src/* | crates/openhuman-embed/src/* | crates/openhuman-rpc/src/* | crates/openhuman-session/src/* | crates/openhuman-tinyhumans/src/* | crates/openhuman-tui/src/*) ;; *) return 1 ;; esac
