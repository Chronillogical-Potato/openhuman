 ...
 *
 * Actual tool names discovered in crates/openhuman-core/src/tools/impl/cron/:
 ...
 * `enabled: true` for agent jobs; see `crates/openhuman-core/src/cron/schemas.rs:359`).
