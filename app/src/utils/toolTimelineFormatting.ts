...
const TOOL_DISPLAY_NAMES: Record<string, string> = {
  ...
  // Harness tool discovery. `tool_search` finds a deferred tool (a Composio
  // action, say) and is NOT a web search, whatever its name and `query` arg
  // suggest; `tool_call` is unwrapped to the tool it invokes in
  // `formatTimelineEntry`, this entry is only its fallback.
  tool_search: 'Searching tools',
  tool_call: 'Using a tool',
  search_tool_catalog: 'Searching tools',
