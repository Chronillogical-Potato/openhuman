...
const messages: TranslationMap = {
  ...
  'share.copiedImage': 'Immagine copiata',
  'share.copyCaption': 'Copia didascalia',
  'share.copiedCaption': 'Didascalia copiata',
  'brain.header.graph':
  ...
  'brain.welcome.nav': 'Benvenuto',
  'brain.welcome.eyebrow': 'Cervello',
  'brain.welcome.title': 'La memoria del tuo agente, mappata',
  'brain.welcome.body':
    'Il Cervello è dove il tuo agente conserva ciò che sa: le persone, le conversazioni, le fonti e gli obiettivi su cui si basa per aiutarti con un contesto reale invece di ripartire da zero ogni volta.',
  'brain.welcome.ctaGraph': 'Apri il grafo della memoria',
  'brain.welcome.ctaGoals': 'Imposta gli obiettivi',
  ...
  'brain.welcome.feat3Body': 'Collega i dati da cui il tuo agente impara e mantienili aggiornati.',
  'feedback.header.title': 'Feedback',
  'feedback.header.desc': 'Condividi idee e vota cosa costruiremo dopo.',
  'feedback.welcome.nav': 'Benvenuto',
  'feedback.welcome.main': 'Bacheca dei feedback',
  'feedback.welcome.eyebrow': 'Feedback',
  'feedback.welcome.title': 'Aiutaci a dare forma a ciò che costruiamo',
  'feedback.welcome.body':
    'Dicci cosa funziona, cosa manca e cosa renderebbe OpenHuman migliore. Pubblica un’idea, vota le proposte degli altri e guarda le migliori salire in cima alla nostra roadmap.',
  'feedback.welcome.ctaShare': 'Condividi un’idea',
  ...
  'feedback.welcome.feat3Body': 'Vedi cosa è pianificato, in corso e rilasciato.',
  'connections.header.composio': 'Collega le app in cui il tuo agente può agire.',
  ...
  'connections.welcome.featsLabel': 'Cosa puoi fare qui',
  'connections.welcome.feat1Title': 'Porta dentro i canali',
  'connections.welcome.feat1Body':
    'Slack, WhatsApp, Telegram, Gmail e altri: collegati in un paio di clic.',
  'connections.welcome.feat2Title': 'Lascia agire il tuo agente',
  'connections.welcome.feat2Body':
    'Legge, redige e risponde con il pieno contesto di tutto ciò che è collegato.',
  'connections.welcome.feat3Title': 'Mantieni il controllo',
  'connections.welcome.feat3Body':
    'Concedi o revoca l’accesso per ogni canale, quando vuoi. Nulla parte senza il tuo consenso.',
  'alerts.header.desc': 'L’attività dell’agente e tutto ciò che richiede la tua attenzione.',
  'notifications.welcome.nav': 'Benvenuto',
  'notifications.welcome.main': 'Avvisi',
  ...
  'rewards.welcome.nav': 'Benvenuto',
  'rewards.welcome.main': 'Premi',
  ...
  'rewards.welcome.feat1Body': 'Le azioni quotidiane e gli inviti si sommano nel tempo.',
  'rewards.welcome.feat2Title': 'Mantieni la tua serie',
  'rewards.welcome.feat2Body': 'Presentati regolarmente per sbloccare i bonus di serie.',
  'rewards.welcome.feat3Title': 'Riscatta i vantaggi',
  'rewards.welcome.feat3Body': 'Trasforma i punti in coupon e premi.',
  'flows.welcome.nav': 'Benvenuto',
  'flows.welcome.main': 'Flussi di lavoro',
  ...
  'flows.welcome.feat3Body': 'Approva i passaggi sensibili prima che qualcosa parta.',
  // Privacy Mode selector (#4435): data-egress posture
  'privacy.mode.title': 'Modalità privacy',
  'privacy.mode.description':
    'Controlla quanti dei tuoi dati possono lasciare questo dispositivo. Distinta dalla modalità di accesso dell’agente.',
  ...
  'skills.recallCalendar.title': 'Calendario di Google',
  ...
  'settings.core.title': 'Connessione al core',
  'settings.core.menuDesc': 'Usa il core locale integrato o connettiti a un core remoto.',
  'settings.core.useRemoteToggle': 'Usa core remoto',
  'settings.core.useRemoteToggleDesc':
    'Connettiti a un core remoto via HTTP invece del core locale integrato.',
  'settings.core.statusConnectedRemote': 'Connesso al core remoto',
  'settings.core.statusConnectedLocal': 'Connesso al core locale',
  'settings.core.statusChecking': 'Verifica della connessione…',
  'settings.core.statusAuthFailed': 'Raggiungibile, ma il token è stato rifiutato',
  'settings.core.statusUnreachable': 'Impossibile raggiungere il core',
  'settings.core.recheck': 'Ricontrolla',
  'settings.core.save': 'Salva e riavvia',
  'settings.core.applyRestartNote': 'Il salvataggio riavvia OpenHuman per riconnettersi.',
  ...
  'conversations.chatError.guardrail.title':
    'Questa richiesta non ha superato un controllo di sicurezza',
  ...
  'conversations.toolFailure.notFound.cause':
    'Ciò che questa azione ha richiesto non esiste o non è disponibile qui.',
  'conversations.toolFailure.notFound.next':
    "Non serve fare nulla. L'assistente può cercare il nome corretto e riprovare.",
  'conversations.toolFailure.unsupported.cause': 'OpenHuman non può ancora farlo automaticamente.',
  'conversations.toolFailure.unsupported.next': "Fallo manualmente o chiedi un'altra opzione.",
  'conversations.backgroundTasks.title': 'Attività in background',
  ...
  'conversations.backgroundTasks.titleWithCount': 'Attività in background ({count})',
  'conversations.backgroundTasks.running': '{count} in esecuzione',
  'conversations.backgroundTasks.noneRunning': 'nessuno che corre',
  'conversations.backgroundTasks.total': '{count} totale',
  'conversations.backgroundTasks.empty':
    "Nessuna attività in background in questa chat. Chiedi all'assistente di fare qualcosa in background e verrà visualizzato qui.",
  ...
  'conversations.backgroundTasks.statusNeedsYou': 'Ha bisogno di te',
  'conversations.backgroundTasks.statusCancelled': 'Annullato',
  'conversations.backgroundTasks.toolCallOne': 'Chiamata utensile {count}',
  'conversations.backgroundTasks.toolCallOther': 'Chiamate dello strumento {count}',
  'conversations.backgroundTasks.steps': '{count} passi',
  'conversations.backgroundTasks.viewDetails': 'Visualizza i dettagli →',
  ...
  'conversations.backgroundTasks.inboxReady': '{count} pronte',
  'conversations.backgroundTasks.inboxInFlight': '{count} in corso',
  'conversations.backgroundTasks.memoryJobTitle': 'Sincronizzazione memoria',
  'conversations.backgroundTasks.cancelJob': 'Annulla',
  ...
  'nav.discord': 'Unisciti al nostro Discord',
  ...
  'nav.workflowRuns': 'Esecuzioni dei flussi',
  'nav.workflowDiscoveries': 'Scopri flussi',
  ...
  'sync.nowSyncing.title': 'Sincronizzazione in corso',
  'sync.nowSyncing.empty': 'Nessuna sincronizzazione in corso.',
  'common.error': 'Errore',
  ...
  'chat.connectionState.dropped': 'Connessione persa. L’esecuzione è proseguita sul server.',
  'chat.connectionState.reconnect': 'Riconnetti',
  'chat.connectionState.reconnecting': 'Riconnessione in corso',
  'chat.connectionState.resumed': 'Lo stream è ripreso.',
  ...
  'chat.reasoning.thinking': 'Sto pensando',
  'chat.reasoning.thoughtFor': 'Ha pensato per {n}',
  'chat.reasoning.thoughtBriefly': 'Ha pensato brevemente',
  'chat.reasoning.thought': 'Ha pensato',
  ...
  'skills.explorer.sourceFilterAria': 'Filtra per origine',
  ...
  'skills.rows.installedTitle': 'Skill installate',
  'skills.rows.installedIntro':
    'Le skill che il tuo agente può eseguire su questa macchina. Aprine una per i dettagli; eseguila, modificala o rimuovila dalla sua riga.',
  'skills.rows.registryTitle': 'Registro delle skill',
  'skills.rows.registryIntro':
    'Cataloghi di skill da installare. Cerca e installane una tra le tue skill utente.',
  'skills.rows.open': 'Apri {name}',
  'skills.rows.run': 'Esegui {name}',
  'skills.rows.edit': 'Modifica {name}',
  'skills.rows.remove': 'Rimuovi {name}',
  ...
  'skills.explorer.notInstallable': 'Non installabile',
  'skills.explorer.notInstallableHint':
    'Questa voce non ha un file SKILL.md da scaricare, quindi non può essere installata da qui.',
  ...
  'connections.browser.notVerified': 'Non verificato',
  'connections.browser.localOverride':
    'Serve un modulo locale finché gli archivi non saranno pubblicati.',
  'connections.browser.testModule': 'Prova modulo',
  'connections.browser.enabled': 'Attiva browser',
  'connections.browser.headless': 'Senza interfaccia',
  'connections.browser.width': 'Larghezza finestra',
  'connections.browser.height': 'Altezza finestra',
  'connections.browser.chromePath': 'Percorso Chrome (facoltativo)',
  'connections.browser.profileMode': 'Profilo',
  'connections.browser.fresh': 'Nuovo profilo',
  'connections.browser.persistent': 'Profilo persistente',
  'connections.browser.profilePath': 'Cartella del profilo',
  'connections.browser.downloadDir': 'Cartella download',
  'connections.browser.maxSteps': 'Numero massimo di passaggi',
  'connections.browser.timeout': 'Timeout (secondi)',
  'connections.browser.allowedWebsites': 'Siti consentiti',
  'connections.browser.sharedPolicy':
    'Browser e ricerca web condividono la stessa regola per i siti.',
  'connections.browser.manageWebsites': 'Gestisci siti consentiti',
  'connections.browser.jevRoute': 'Fatturazione Jev',
  'connections.browser.routeDirect': 'OpenRouter diretto',
  ...
  'connections.browser.chromeReady': 'Chrome pronto',
  'connections.browser.chromeNotReady': 'Chrome non disponibile',
  'connections.browser.readinessChecked': 'Stato verificato',
  'connections.browser.boundsRequired':
    'Usa larghezza 320–3840, altezza 240–2160, passaggi 1–100 e timeout di 5–600 secondi.',
  'connections.browser.noneAllowed': 'Nessun sito consentito',
  'connections.browser.moduleChecked': 'Modulo verificato',
  ...
  'desktop.approvalSummary': '{operation} “{target}” nell’app {app}',
  'desktop.action.click': 'Fai clic su',
  'desktop.action.type_text': 'Scrivi in',
  'desktop.action.check': 'Seleziona',
  'desktop.action.uncheck': 'Deseleziona',
  ...
  'desktop.enabledPending':
    'Attivato. Completa la configurazione qui sotto prima di usare gli strumenti desktop.',
  'desktop.moduleUnavailable': 'Il modulo desktop non è disponibile. Controlla lo stato e riprova.',
  'desktop.pendingUnavailable':
    'Impossibile caricare le approvazioni desktop in attesa. Aggiorna per riprovare.',
  'desktop.unsupported': 'Il controllo desktop non è disponibile in questo ambiente.',
  'desktop.localOnly': 'Questa impostazione vale solo per questo computer.',
  'desktop.permissions': 'Autorizzazioni di sistema',
  'desktop.permission.accessibility': 'Accessibilità',
  'desktop.permission.screen_recording': 'Registrazione schermo',
  'desktop.openSettings': 'Apri impostazioni',
  'desktop.captureNote':
    'La registrazione schermo serve solo per gli screenshot. L’accessibilità serve per esaminare e controllare le app.',
  'desktop.testDescription':
    'Verifica che il core possa vedere le app in esecuzione su questo computer.',
  'desktop.testButton': 'Verifica accesso desktop',
  'desktop.testPassed': 'L’accesso desktop funziona.',
  'desktop.testFailed': 'Impossibile verificare l’accesso desktop.',
  ...
  'memoryTree.status.storedItemsTile': 'Elementi archiviati',
  ...
  'settings.costDashboard.unknownProvider': 'Nessuno',
  ...
  'mcp.tab.officialBadge': 'Ufficiale',
  'mcp.tab.officialHint': 'Server ufficiale del fornitore',
  ...
  'mcp.tab.tablistAria': 'Viste MCP',
  'mcp.rows.showTools': 'Mostra gli strumenti di {name}',
  'mcp.rows.hideTools': 'Nascondi gli strumenti di {name}',
  'mcp.rows.toolsLoading': 'Lettura degli strumenti…',
  'mcp.rows.toolsFailed': 'Impossibile leggere gli strumenti.',
  'mcp.rows.add': 'Aggiungi server',
  ...
  'mcp.form.transportStdio': 'Comando locale (stdio)',
  ...
  'mcp.form.keepStored': 'Memorizzato (lascia vuoto per mantenerlo)',
  'mcp.form.removeRow': 'Rimuovi riga',
  'mcp.form.addEnv': 'Aggiungi variabile',
  'mcp.form.url': 'URL',
  'mcp.form.auth': 'Autenticazione',
  'mcp.form.authNone': 'Nessuna',
  'mcp.form.authBearer': 'Token Bearer',
  'mcp.form.authHeader': 'Header personalizzato',
  'mcp.form.authOauth': 'Accedi con il browser (OAuth)',
  'mcp.form.token': 'Token',
  ...
  'mcp.form.saving': 'Salvataggio…',
  'mcp.form.saveFailed': 'Impossibile salvare il server.',
  'mcp.rows.title': 'Server installati',
  'mcp.rows.intro':
    'I server MCP che il tuo agente può usare, come dichiarati in mcp.json. Apri un server per le sue credenziali e i suoi strumenti.',
  'mcp.rows.open': 'Apri {name}',
  'mcp.rows.connect': 'Connetti {name}',
  'mcp.rows.disconnect': 'Disconnetti {name}',
  'mcp.rows.enable': 'Abilita {name}',
  'mcp.rows.disable': 'Disabilita {name}',
  'mcp.rows.remove': 'Rimuovi {name}',
  'mcp.rows.removeTitle': 'Rimuovere {name}?',
  'mcp.rows.removeBody':
    'Il server e le credenziali memorizzate vengono rimossi. Dichiararlo di nuovo in mcp.json riparte da zero.',
  'mcp.rows.opFailed': 'L’azione non è riuscita.',
  'mcp.json.invalidTitle': 'Questo file non può ancora essere salvato',
  'mcp.json.unsaved': 'Modifiche non salvate',
  'mcp.registry.title': 'Directory MCP',
  'mcp.tab.section.servers': 'Server',
  'mcp.tab.section.json': 'mcp.json',
  'mcp.tab.section.registry': 'Registro',
  'mcp.tab.back': 'Torna ai server',
  'mcp.tab.action.openPage': 'Apri pagina',
  ...
  'mcp.json.intro':
    'I tuoi server MCP in un unico documento, nella forma usata dagli altri client MCP. Incolla il blocco di un server dalla sua pagina di installazione e salva.',
  'mcp.json.credentialsNote':
    'Le credenziali sono di sola scrittura: i valori di env e headers vengono memorizzati al salvataggio e mai più mostrati. Una voce salvata senza di essi mantiene ciò che è memorizzato; imposta una chiave a "" per rimuoverla.',
  'mcp.json.editorAria': 'Documento mcp.json',
  'mcp.json.refusedTitle': 'Il core ha rifiutato questo documento',
  'mcp.json.saved': 'Salvato: {added} aggiunti, {updated} aggiornati, {removed} rimossi.',
  'mcp.json.saving': 'Salvataggio…',
  'mcp.json.save': 'Salva',
  'mcp.json.revert': 'Ripristina',
  'mcp.json.exampleTitle': 'Esempio',
  'mcp.json.saveFailed': 'Impossibile salvare mcp.json.',
  'mcp.json.parseError.empty': 'Il documento è vuoto. Nessun server è { "mcpServers": {} }.',
  'mcp.json.parseError.invalidJson': 'JSON non valido: {detail}',
  'mcp.json.parseError.rootNotObject': 'mcp.json contiene un oggetto con una chiave `mcpServers`.',
  'mcp.json.parseError.missingRoot':
    'Manca la chiave `mcpServers`: ogni server sta al suo interno.',
  'mcp.json.parseError.rootNotMap':
    '`mcpServers` associa il nome di un server alle sue impostazioni.',
  'mcp.json.parseError.emptyName':
    'Un server ha bisogno di un nome: la chiave di una voce è vuota.',
  'mcp.json.parseError.entryNotObject':
    '`{name}` contiene un oggetto, ad es. { "command": "npx", "args": ["-y", "…"] } oppure { "url": "https://…" }.',
  'mcp.json.parseError.needsUrlOrCommand':
    '`{name}` richiede una `url` (hosted) o un `command` (eseguito in locale).',
  'mcp.json.parseError.bothUrlAndCommand':
    '`{name}` indica sia `url` sia `command`; un server si raggiunge in un solo modo.',
  ...
  'mnemonic.walletAlreadyConfigured': 'Il tuo portafoglio è già configurato.',
  'mnemonic.walletSource': 'Fonte',
  'mnemonic.walletWordCount': 'Lunghezza della frase di recupero',
  'mnemonic.walletLastUpdated': 'Ultimo aggiornamento',
  'mnemonic.replaceWallet': 'Sostituisci portafoglio',
  ...
  'mnemonic.hidePhrase': 'Nascondi frase',
  'mnemonic.importAnExistingWallet': 'Importa un portafoglio esistente',
  'mnemonic.createANewWallet': 'Crea un nuovo portafoglio',
  'mnemonic.importWallet': 'Importa portafoglio',
  ...
  'voice.providers.desc':
    "Scegli quale motore in cloud trascrive la tua voce e dove viene eseguita la sintesi. Il riconoscimento vocale funziona sempre in cloud; solo la sintesi ha un'opzione locale (Piper), installata con il pulsante Installa localmente. Nessuna configurazione manuale di PIPER_BIN richiesta.",
  ...
  'memorySources.stage.requested': 'Avvio',
  'memorySources.stage.running': 'Sincronizzazione',
  'memorySources.stage.fetching': 'Recupero',
  'memorySources.stage.stored': 'Salvataggio',
  'memorySources.stage.queued': 'Elaborazione nella memoria',
  'memorySources.stage.ingesting': 'Elaborazione nella memoria',
  'memorySources.stage.unknown': 'Sincronizzazione',
  ...
  'app.openhumanLink.status.loading': 'Caricamento…',
  'app.openhumanLink.status.needsSignIn': 'Accesso richiesto',
  'app.openhumanLink.status.timedOut': 'Tempo scaduto',
  ...
  'conversations.composer.context.usage': 'Utilizzo del contesto',
  'conversations.composer.context.full': 'Pieno al {percent}%',
  'conversations.composer.context.reasoning': 'Ragionamento',
  'conversations.composer.context.headroom': 'Spazio libero',
  'conversations.composer.context.meterLabel': 'Utilizzo del contesto: {label}',
  'conversations.composer.context.meterValue': '{used} di {limit}',
  'conversations.composer.context.loading': 'Misurazione del contesto…',
  'conversations.composer.context.errorTitle': 'Ripartizione del contesto non disponibile',
  ...
  'conversations.composer.command.new': 'Inizia una nuova conversazione',
  'conversations.composer.command.stop': 'Interrompi la risposta in corso',
  'conversations.composer.command.plan':
    'Prima pianifica: rivedi i passaggi prima di eseguire qualcosa',
  'conversations.composer.command.build': 'Costruisci: lascia agire direttamente l’agente',
  'conversations.composer.trigger.back': 'Indietro',
  'conversations.composer.trigger.loading': 'Caricamento…',
  'conversations.composer.trigger.emptyCategories': 'Nessun elemento disponibile',
  'conversations.composer.slash.empty': 'Nessun comando corrispondente',
  'conversations.composer.mention.empty': 'Nessun elemento corrispondente',
  'conversations.composer.mention.memory': 'Memoria',
  'conversations.composer.mention.files': 'File',
  ...
  'conversations.planReview.feedbackPlaceholder': 'Descrivi cosa cambiare…',
  'conversations.planReview.sendFeedback': 'Invia feedback',
  'conversations.planReview.revise': 'Rivedi',
  'conversations.runMode.plan': 'Piano',
  'conversations.runMode.build': 'Build',
  'conversations.runMode.toggleLabel': 'Passa dalla modalità piano alla modalità build',
  ...
  'conversations.tools.inspectDesktop.active': 'Ispezione del desktop in corso',
  'conversations.tools.inspectDesktop.done': 'Desktop ispezionato',
  'conversations.tools.controlDesktop.active': 'Controllo del desktop in corso',
  'conversations.tools.controlDesktop.done': 'Desktop controllato',
  ...
  'conversations.tools.document.title': 'Documento',
  'conversations.tools.presentation.title': 'Presentazione',
  ...
  'conversations.subagent.transcript.instruction': 'istruzione',
  'conversations.subagent.transcript.agent': 'agente',
  'conversations.subagent.transcript.system': 'sistema',
  'conversations.tasks.taskOne': 'attività',
  'conversations.tasks.taskOther': 'attività',
  'conversations.tasks.running': 'in corso',
  'conversations.tasks.waitingForInput': 'in attesa di risposta',
  'conversations.tasks.done': 'completata',
  'conversations.tasks.failed': 'non riuscita',
  'conversations.tasks.of': 'di',
  ...
  'conversations.memoryChips.remembered': '{n} memorizzati',
  'conversations.memoryChips.idle': 'memoria',
  'conversations.memoryChips.forgetAriaLabel': 'Dimentica "{text}"',
  'conversations.scheduleCard.next': 'successivo',
  'conversations.scheduleCard.paused': 'in pausa',
  ...
  'conversations.agentTaskInsights.done': 'Completato',
  'conversations.agentTaskInsights.failed': 'Non riuscito',
  'conversations.agentTaskInsights.running': 'In corso',
  'conversations.agentTaskInsights.cancelled': 'Annullato',
  'conversations.agentTaskInsights.awaitingUser': 'In attesa di input',
  'conversations.agentTaskInsights.viewDetails': 'Vedi dettagli',
  'conversations.agentTaskInsights.subagentsHeading': 'Sotto-agenti',
  ...
  'notifications.flow.approveTitle': "Il workflow richiede l'approvazione",
  'notifications.flow.approve': 'Approva',
  'notifications.flow.approving': 'Approvazione in corso…',
  'notifications.flow.dismiss': 'Ignora',
  'notifications.flow.error': 'Impossibile riprendere il workflow. Riprova.',
  ...
  'flowRuns.inspector.output': 'Mostra output grezzo',
  ...
  'flows.discoveries.title': 'Scoperte dei flussi',
  'flows.discoveries.description': 'Automazioni suggerite da Flow Scout, in base a come lavori.',
  'flows.allRuns.title': 'Esecuzioni dei flussi',
  'flows.allRuns.description': 'Ogni esecuzione di flusso nel tuo spazio, dalle più recenti.',
  'flows.allRuns.loading': 'Caricamento esecuzioni…',
  'flows.allRuns.empty': 'Nessuna esecuzione di flusso ancora.',
  'flows.allRuns.unknownWorkflow': 'Flusso sconosciuto',
  'flows.allRuns.status.running': 'In corso',
  'flows.allRuns.status.completed': 'Completato',
  'flows.allRuns.status.completed_with_warnings': 'Completato con avvisi',
  ...
  'flows.promptBar.placeholder': 'Descrivi il tuo flusso di lavoro',
  'flows.promptBar.copilotTitle': 'Copilota',
  'flows.promptBar.submit': 'Crea',
  'flows.promptBar.startBuilding': 'Inizia a creare',
  'flows.promptBar.disclaimer':
    'Il Copilota usa IA e può commettere errori. Controlla le risposte.',
  ...
  'flows.copilot.tool.proposing': 'Proposta del flusso di lavoro…',
  ...
  'flows.nodeKind.tool_call': 'Chiamata strumento',
  'flows.nodeKind.http_request': 'Richiesta HTTP',
  'flows.nodeKind.code': 'Codice',
  'flows.nodeKind.condition': 'Condizione',
  'flows.nodeKind.switch': 'Switch',
  'flows.nodeKind.merge': 'Unisci',
  'flows.nodeKind.split_out': 'Dividi output',
  ...
  'flows.nodeSummary.trigger.appEvent': "Viene eseguito da un evento dell'app",
  'flows.nodeSummary.trigger.unknownKind': 'Tipo di trigger: {kind}',
  'flows.nodeSummary.agent.defaultModel': 'modello predefinito',
  'flows.nodeSummary.agent.withPrompt': '“{prompt}” · {model}',
  'flows.nodeSummary.agent.default': 'Interroga {model}',
  'flows.nodeSummary.toolCall.runsNative': 'Esegue {name}',
  'flows.nodeSummary.toolCall.pickNative': 'Esegue uno strumento OpenHuman (scegline uno)',
  'flows.nodeSummary.toolCall.runs': 'Esegue {slug}',
  'flows.nodeSummary.toolCall.pick': "Esegue un'azione dell'app (scegline una)",
  'flows.nodeSummary.http.withUrl': '{method} {url}',
  'flows.nodeSummary.http.noUrl': 'Richiesta {method} (imposta un URL)',
  'flows.nodeSummary.code.runs': 'Esegue codice {lang}',
  'flows.nodeSummary.condition.withField': 'Se {field} → vero / falso',
  'flows.nodeSummary.condition.default': 'Si dirama in vero / falso',
  'flows.nodeSummary.switch.byExpr': 'Instrada in base a {expr}',
  'flows.nodeSummary.switch.byExprWithRoutes': 'Instrada in base a {expr} ({count} percorsi)',
  'flows.nodeSummary.switch.byValue': 'Instrada in base a un valore',
  'flows.nodeSummary.switch.byValueWithRoutes': 'Instrada in base a un valore ({count} percorsi)',
  'flows.nodeSummary.merge': 'Unisce i rami paralleli',
  'flows.nodeSummary.splitOut.withPath': 'Divide ogni {path}',
  'flows.nodeSummary.splitOut.default': 'Divide un elenco in elementi',
  'flows.nodeSummary.transform.default': 'Rimodella ogni elemento',
  'flows.nodeSummary.transform.setFieldsSingular': 'Imposta {n} campo su ogni elemento',
  'flows.nodeSummary.transform.setFieldsPlural': 'Imposta {n} campi su ogni elemento',
  'flows.nodeSummary.outputParser': "Analizza l'output precedente",
  'flows.nodeSummary.subWorkflow': 'Esegue un flusso di lavoro annidato',
  'flows.nodeSummary.memory.flavourWith': 'Legge lo stile "{flavour}"',
  'flows.nodeSummary.memory.flavour': 'Legge uno stile di memoria',
  'flows.nodeSummary.memory.people': 'Consulta la memoria delle persone',
  'flows.nodeSummary.memory.remember': 'Salva un valore in questo flusso di lavoro',
  'flows.nodeSummary.memory.forget': 'Dimentica un valore da questo flusso di lavoro',
  'flows.nodeSummary.memory.searchScoped': 'Cerca nella memoria ({scope})',
  'flows.nodeSummary.memory.search': 'Cerca nella memoria',
  'flows.nodeSummary.memory.recallScoped': 'Richiama dalla memoria ({scope})',
  ...
  'flows.editor.confirm.runTitle': 'Eseguire il flusso di lavoro?',
  'flows.editor.confirm.runBody': 'Questo eseguirà il flusso di lavoro ora.',
  'flows.editor.confirm.saveTitle': 'Salvare le modifiche?',
  'flows.editor.confirm.saveBody': 'Questo salverà le tue modifiche al flusso di lavoro.',
  'flows.editor.confirm.discardTitle': 'Annullare le modifiche?',
  'flows.editor.confirm.discardBody':
    'Questo annulla tutte le modifiche non salvate e non può essere ripristinato.',
  'flows.editor.confirm.confirm': 'Conferma',
  'flows.editor.confirm.cancel': 'Annulla',
  ...
  'flows.nodeConfig.trigger.scheduleDays': 'Nei giorni (facoltativo: lascia vuoto per ogni giorno)',
  ...
  'flows.cron.customSchedule': 'Pianificazione personalizzata ({expr})',
  'flows.cron.noScheduleSet': 'Nessuna pianificazione impostata',
  'flows.cron.weekdays': 'giorni feriali',
  'flows.cron.weekends': 'weekend',
  'flows.cron.everyMinute': 'Ogni minuto',
  'flows.cron.everyMinuteOnDays': 'Ogni minuto nei {days}',
  'flows.cron.everyNMinutes': 'Ogni {n} minuti',
  'flows.cron.everyNMinutesOnDays': 'Ogni {n} minuti nei {days}',
  'flows.cron.everyHour': 'Ogni ora',
  'flows.cron.everyHourOnDays': 'Ogni ora nei {days}',
  'flows.cron.everyNHours': 'Ogni {n} ore',
  'flows.cron.everyNHoursOnDays': 'Ogni {n} ore nei {days}',
  'flows.cron.everyDayAtTime': 'Ogni giorno alle {time}',
  'flows.cron.atTimeOnDays': 'Alle {time} nei {days}',
  'flows.cron.invalidInterval': 'Intervallo non valido',
  'flows.cron.dailyEvery24h': 'Giornaliero (ogni 24 h)',
  'flows.cron.everyNDays': 'Ogni {n} giorni',
  'flows.cron.everyNHoursShort': 'Ogni {n} h',
  'flows.cron.everyNMinutesShort': 'Ogni {n} min',
  'flows.cron.everySecond': 'Ogni secondo',
  'flows.cron.everyNSeconds': 'Ogni {n} s',
  'flows.cron.onceAtRaw': 'Una volta il {at}',
  'flows.cron.onceAt': 'Una volta il {at}',
  ...
  'flows.nodeConfig.agent.modelManagedTiers': 'Ruoli del carico di lavoro',
  ...
  'flows.enableApproval.intro':
    'Questo workflow richiede la tua autorizzazione per le azioni seguenti. L’approvazione vale solo per questo workflow.',
  'flows.enableApproval.approveAll': 'Approva tutto',
  'flows.enableApproval.deny': 'Nega',
  'flows.enableApproval.enableAnyway': 'Attiva comunque',
  'flows.enableApproval.granting': 'Approvazione in corso…',
  'flows.enableApproval.error': 'Impossibile salvare le approvazioni. Riprova.',
  'flows.enableApproval.blockedHint': 'Bloccato dalle impostazioni di accesso dell’agente.',
  'flows.enableApproval.dynamicHint': 'Deciso durante l’esecuzione; ti chiederà se necessario.',
  'flows.enableApproval.agentHint':
    'Questo passaggio IA può chiedere separatamente per le proprie azioni.',
  'flows.enableApproval.deniedDisabled': 'Salvato, ma il workflow è rimasto disattivato.',
  ...
  'settings.ai.providers.groupLocal': 'Runtime locali',
  'settings.ai.providers.groupCli': 'Accessi CLI',
  'settings.ai.providers.cliDetail': 'Usa un accesso che un altro strumento CLI possiede già',
  'settings.ai.providers.connected': 'Connesso',
  'settings.ai.providers.managedDetail': 'OpenHuman sceglie un modello per ogni attività',
  'settings.ai.providers.rowActions': 'Altre azioni per {provider}',
  'settings.ai.providers.replaceKey': 'Sostituisci chiave API',
  'settings.ai.providers.custom': 'Personalizzato',
  'settings.ai.providers.addProvider': 'Aggiungi un provider',
  'settings.ai.providers.addProviderSubtitle':
    'Scegli un provider da connettere. Puoi aggiungerne altri in qualsiasi momento.',
  'settings.ai.providers.placeholderCloud': 'Scegli un provider cloud…',
  ...
  'settings.ai.providers.groupConnected': 'Connesso',
  'settings.ai.providers.localDetail': 'Viene eseguito su questo dispositivo',
  ...
  'settings.ai.routing.workload.chat.hint':
    'Consigliato: un modello di chat veloce economico o di medio costo con token/sec elevati e bassa latenza. I modelli locali open source possono funzionare bene qui se si sentono reattivi.',
  'settings.ai.routing.workload.reasoning.label': 'Reasoning',
  'settings.ai.routing.workload.reasoning.description':
    'Agente della chat principale, riepilogo della riunione: modalità "Ragionamento" in Conversazioni',
  'settings.ai.routing.workload.reasoning.hint':
    "Consigliato: una frontiera più costosa o un modello di ragionamento forte per una riflessione profonda. Viene utilizzato per l'agente di chat principale, i riepiloghi delle riunioni e la sintesi delle risposte più pesante.",
  'settings.ai.routing.workload.agentic.label': 'Agentic',
  'settings.ai.routing.workload.agentic.description':
    'Corridori di sub-agenti, cicli di strumenti, decisioni GIF',
  'settings.ai.routing.workload.agentic.hint':
    'Consigliato: un modello affidabile che segue le istruzioni con un forte utilizzo degli strumenti. I modelli di frontiera a medio costo sono generalmente i più sicuri; i modelli open source capaci possono funzionare se la chiamata dello strumento è stabile.',
  'settings.ai.routing.workload.coding.label': 'Coding',
  'settings.ai.routing.workload.coding.description':
    'Generazione del codice e passaggi di refactoring',
  'settings.ai.routing.workload.coding.hint':
    'Consigliato: un modello ottimizzato per la codifica con un forte seguito delle istruzioni, qualità di modifica e prestazioni a lungo contesto. Di solito vale la pena spendere di più per questo.',
  'settings.ai.routing.workload.vision.label': 'Vision',
  'settings.ai.routing.workload.vision.description':
    "Comprensione dell'immagine per il sub-agente visione: sempre multimodale",
  ...
  'settings.ai.workload.columnHeader': 'Carico di lavoro',
  ...
  'settings.composio.invalidApiKey': 'La chiave API di Composio non è valida.',
  ...
  'settings.theme.variantAuto': 'Automatico',
  'settings.theme.variantAria': 'Variante del tema',
  'settings.theme.backdropHeading': 'Sfondo',
  'settings.theme.backdrop.mesh': 'Reticolo',
  ...
  'settings.theme.autoForkHint':
    'Modificando un preset le tue modifiche vengono salvate automaticamente come nuovo tema personalizzato.',
  'settings.theme.title': 'Studio Temi',
  'settings.theme.menuDesc':
    'Personalizza completamente colori e caratteri, oppure scegli un tema predefinito.',
  'settings.theme.presetsHeading': 'Temi',
  'settings.theme.builtInBadge': 'Predefinito',
  'settings.theme.customBadge': 'Personalizzato',
  'settings.theme.customizeHint':
    'I temi predefiniti sono di sola lettura. Duplica questo tema per modificarne colori e caratteri.',
  'settings.theme.duplicate': 'Duplica e personalizza',
  'settings.theme.copyName': '{name} (personalizzato)',
  'settings.theme.importedName': 'Tema importato',
  'settings.theme.contrastWarn':
    'Contrasto ridotto tra testo e sfondo: questo tema potrebbe risultare difficile da leggere.',
  'settings.theme.group.surfaces': 'Superfici',
  'settings.theme.group.text': 'Testo',
  'settings.theme.group.borders': 'Bordi',
  'settings.theme.group.accents': "Colori d'accento",
  'settings.theme.showShades': "Mostra tutte le tonalità d'accento",
  'settings.theme.hideShades': "Nascondi tutte le tonalità d'accento",
  'settings.theme.fontsHeading': 'Caratteri',
  'settings.theme.fontRole.title': 'Titolo',
  'settings.theme.fontRole.heading': 'Intestazione',
  'settings.theme.fontRole.body': 'Corpo',
  'settings.theme.fontRole.mono': 'Monospazio',
  'settings.theme.fontRole.serif': 'Con grazie',
  'settings.theme.fontCurrent': 'Attuale',
  'settings.theme.actions': 'Gestisci tema',
  'settings.theme.reset': 'Reimposta personalizzazioni',
  'settings.theme.delete': 'Elimina tema',
  'settings.theme.export': 'Copia JSON',
  'settings.theme.copied': 'Copiato!',
  'settings.theme.import': 'Importa tema',
  'settings.theme.importHint':
    'Incolla il JSON di un tema esportato per aggiungerlo come tema personalizzato.',
  'settings.theme.importApply': 'Importa',
  'settings.theme.importError': 'Impossibile analizzare quel JSON del tema.',
  ...
  'settings.persona.templates.heading': 'Parti da un modello',
  'settings.persona.templates.desc':
    'Scegli un punto di partenza: compila Personalità e Stile di comunicazione. Dopo puoi modificare tutto.',
  'settings.persona.templates.doctor.label': 'Assistente clinico',
  'settings.persona.templates.doctor.desc': 'Attento, cita le fonti, segnala l’incertezza',
  'settings.persona.templates.researcher.label': 'Assistente di ricerca',
  'settings.persona.templates.researcher.desc': 'Rigoroso, strutturato, basato sulle prove',
  'settings.persona.templates.executive.label': 'Assistente esecutivo',
  'settings.persona.templates.executive.desc': 'Conciso, deciso, orientato all’azione',
  'settings.persona.templates.teacher.label': 'Insegnante',
  'settings.persona.templates.teacher.desc': 'Paziente, spiega passo dopo passo',
  'settings.persona.templates.student.label': 'Compagno di studio',
  'settings.persona.templates.student.desc': 'Incoraggiante, fa domande, linguaggio semplice',
  'settings.persona.templates.family.label': 'Assistente per la famiglia',
  ...
  'skills.meetingBots.couldNotLeaveTitle': 'Impossibile uscire dalla riunione',
  ...
  'skills.setup.voice.sttNotReadyDesc':
    'Voice Intelligence richiede un motore di riconoscimento vocale funzionante. Scegline uno in Impostazioni › Voce.',
  ...
  'composer.settings.loadingModels': 'Caricamento modelli…',
  ...
  'settings.ai.picker.searchPlaceholder': 'Cerca modelli',
