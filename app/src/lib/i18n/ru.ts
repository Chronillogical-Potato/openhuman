...
const messages: TranslationMap = {
  ...
  'skills.rows.installedIntro': 'Навыки, которые ваш агент может запускать на этом компьютере. Откройте навык для подробностей; запускайте, редактируйте или удаляйте его из строки.',
  'skills.rows.registryTitle': 'Реестр навыков',
  'skills.rows.registryIntro': 'Каталоги навыков для установки. Найдите и установите навык в свои пользовательские навыки.',
