...
const messages: TranslationMap = {
  ...
  'brain.header.graph': 'Как связаны знания вашего агента: люди, темы и воспоминания.',
  'brain.header.goals': 'К чему стремится ваш агент и почему.',
  'brain.header.sources': 'Данные, на которых учится ваш агент.',
  'brain.header.sync': 'Держите память в актуальном состоянии и просматривайте изменения.',
  'brain.welcome.nav': 'Добро пожаловать',
  'brain.welcome.eyebrow': 'Мозг',
  'brain.welcome.title': 'Память вашего агента: на карте',
  'brain.welcome.body':
    'Мозг: это место, где ваш агент хранит всё, что знает: людей, разговоры, источники и цели, на которые он опирается, чтобы помогать вам с реальным контекстом, а не начинать с нуля каждый раз.',
  'brain.welcome.ctaGraph': 'Открыть граф памяти',
  'brain.welcome.ctaGoals': 'Задать цели',
  'brain.welcome.ctaSources': 'Подключить источники',
  'brain.welcome.featsLabel': 'Что здесь находится',
  'brain.welcome.feat1Title': 'Граф памяти',
  'brain.welcome.feat1Body': 'Взгляните, как связаны люди, темы и сообщения: с первого взгляда.',
  'brain.welcome.feat2Title': 'Цели и фокус',
  'brain.welcome.feat2Body': 'Скажите агенту, что важно, чтобы он расставлял приоритеты правильно.',
  'brain.welcome.feat3Title': 'Источники и синхронизация',
  'brain.welcome.feat3Body': 'Подключите данные, на которых учится агент, и держите их свежими.',
  'feedback.header.title': 'Отзывы',
  'feedback.header.desc': 'Делитесь идеями и голосуйте за то, что мы создадим дальше.',
  'feedback.welcome.nav': 'Добро пожаловать',
  'feedback.welcome.main': 'Доска отзывов',
  'feedback.welcome.eyebrow': 'Отзывы',
  'feedback.welcome.title': 'Помогите определить, что мы создадим',
  'feedback.welcome.body':
    'Расскажите нам, что работает, чего не хватает и что сделало бы OpenHuman лучше. Опубликуйте идею, голосуйте за предложения других и наблюдайте, как лучшие поднимаются на вершину нашей дорожной карты.',
  'feedback.welcome.ctaShare': 'Поделиться идеей',
  'feedback.welcome.ctaBoard': 'Смотреть доску',
  'feedback.welcome.featsLabel': 'Что вы можете сделать',
  'feedback.welcome.feat1Title': 'Делитесь идеями',
  'feedback.welcome.feat1Body': 'Ошибки, запросы функций, черновые мысли: всё приветствуется.',
  'feedback.welcome.feat2Title': 'Голосуйте',
  'feedback.welcome.feat2Body': 'Голосуйте за то, что важно, чтобы мы знали, что приоритетно.',
  'feedback.welcome.feat3Title': 'Отслеживайте прогресс',
  'feedback.welcome.feat3Body': 'Смотрите, что запланировано, в работе и выпущено.',
  'connections.header.composio': 'Подключите приложения, в которых может действовать ваш агент.',
  ...
  'connections.welcome.featsLabel': 'Что вы можете здесь делать',
  'connections.welcome.feat1Title': 'Подключайте каналы',
  'connections.welcome.feat1Body':
    'Slack, WhatsApp, Telegram, Gmail и другие: подключаются в пару кликов.',
  'connections.welcome.feat2Title': 'Позвольте агенту действовать',
  'connections.welcome.feat2Body':
    'Он читает, составляет черновики и отвечает с полным контекстом из всего подключённого.',
  'connections.welcome.feat3Title': 'Оставайтесь у руля',
  'connections.welcome.feat3Body':
    'Предоставляйте или отзывайте доступ для каждого канала в любой момент. Ничего не запускается без вашего согласия.',
  'alerts.header.desc': 'Активность агента и всё, что требует вашего внимания.',
  'notifications.welcome.nav': 'Добро пожаловать',
  'notifications.welcome.main': 'Уведомления',
  ...
  'notifications.welcome.feat1Body': 'Решения и упоминания, которые агенты отметили для человека.',
  ...
  'rewards.welcome.feat1Body': 'Повседневные действия и приглашения складываются со временем.',
  'rewards.welcome.feat2Title': 'Поддерживайте серию',
  'rewards.welcome.feat2Body': 'Заходите регулярно, чтобы получать бонусы за серию.',
  'rewards.welcome.feat3Title': 'Обменивайте привилегии',
  'rewards.welcome.feat3Body': 'Превращайте баллы в купоны и награды.',
  'flows.welcome.nav': 'Добро пожаловать',
  'flows.welcome.main': 'Рабочие процессы',
  ...
  'flows.welcome.feat1Title': 'Опишите словами',
  'flows.welcome.feat1Body': 'Скажите, что хотите, простым языком; конструктор составит поток.',
  'flows.welcome.feat2Title': 'Запускайте по расписанию',
  'flows.welcome.feat2Body': 'Срабатывает по таймеру, событию или кнопке: на ваш выбор.',
  'flows.welcome.feat3Title': 'Оставляйте человека в цикле',
  'flows.welcome.feat3Body': 'Одобряйте чувствительные шаги, прежде чем что-либо будет отправлено.',
  ...
  'conversations.backgroundTasks.titleWithCount': 'Фоновые задачи ({count})',
  'conversations.backgroundTasks.running': '{count} работает',
  'conversations.backgroundTasks.noneRunning': 'никто не работает',
  'conversations.backgroundTasks.total': '{count} всего',
  'conversations.backgroundTasks.empty':
    'В этом чате нет фоновых задач. Попросите помощника сделать что-нибудь в фоновом режиме, и оно появится здесь.',
  ...
  'conversations.backgroundTasks.statusNeedsYou': 'Ты нужен',
  'conversations.backgroundTasks.statusCancelled': 'Отменено',
  'conversations.backgroundTasks.toolCallOne': 'Вызов инструмента {count}',
  'conversations.backgroundTasks.toolCallOther': 'Вызовы инструментов {count}',
  'conversations.backgroundTasks.steps': '{count} шаги',
  'conversations.backgroundTasks.viewDetails': 'Подробнее →',
  ...
  'conversations.backgroundTasks.inboxReady': '{count} готово',
  'conversations.backgroundTasks.inboxInFlight': '{count} выполняется',
  'conversations.backgroundTasks.memoryJobTitle': 'Синхронизация памяти',
  'conversations.backgroundTasks.cancelJob': 'Отмена',
  ...
  'nav.workflowRuns': 'Запуски процессов',
  'nav.workflowDiscoveries': 'Найти процессы',
  ...
  'chat.connectionState.dropped': 'Соединение потеряно. Выполнение продолжилось на сервере.',
  'chat.connectionState.reconnect': 'Переподключиться',
  'chat.connectionState.reconnecting': 'Переподключение',
  'chat.connectionState.resumed': 'Поток снова подхвачен.',
  ...
  'skills.rows.installedTitle': 'Установленные навыки',
  'skills.rows.installedIntro':
    'Навыки, которые ваш агент может запускать на этом компьютере. Откройте навык для подробностей; запускайте, редактируйте или удаляйте его из строки.',
  'skills.rows.registryTitle': 'Реестр навыков',
  'skills.rows.registryIntro':
    'Каталоги навыков для установки. Найдите и установите навык в свои пользовательские навыки.',
  'skills.rows.open': 'Открыть {name}',
  'skills.rows.run': 'Запустить {name}',
  'skills.rows.edit': 'Изменить {name}',
  'skills.rows.remove': 'Удалить {name}',
  ...
  'connections.browser.notVerified': 'Не проверено',
  'connections.browser.localOverride': 'До публикации архивов требуется локальный модуль.',
  'connections.browser.testModule': 'Проверить модуль',
  'connections.browser.enabled': 'Включить браузер',
  'connections.browser.headless': 'Без интерфейса',
  'connections.browser.width': 'Ширина окна',
  'connections.browser.height': 'Высота окна',
  'connections.browser.chromePath': 'Путь Chrome (необязательно)',
  'connections.browser.profileMode': 'Профиль',
  'connections.browser.fresh': 'Новый профиль',
  'connections.browser.persistent': 'Постоянный профиль',
  'connections.browser.profilePath': 'Папка профиля',
  'connections.browser.downloadDir': 'Папка загрузок',
  'connections.browser.maxSteps': 'Максимум шагов',
  'connections.browser.timeout': 'Тайм-аут (секунды)',
  'connections.browser.allowedWebsites': 'Разрешённые сайты',
  'connections.browser.sharedPolicy': 'Браузер и веб-поиск используют общую политику сайтов.',
  'connections.browser.manageWebsites': 'Управлять сайтами',
  'connections.browser.jevRoute': 'Маршрут оплаты Jev',
  ...
  'connections.browser.chromeReady': 'Chrome готов',
  'connections.browser.chromeNotReady': 'Chrome недоступен',
  'connections.browser.readinessChecked': 'Готовность проверена',
  'connections.browser.boundsRequired':
    'Укажите ширину 320–3840, высоту 240–2160, 1–100 шагов и тайм-аут 5–600 секунд.',
  'connections.browser.noneAllowed': 'Нет разрешённых сайтов',
  'connections.browser.moduleChecked': 'Модуль проверен',
  'connections.tabs.skills': 'Навыки',
  'connections.tabs.meetings': 'Встречи',
  'connections.groups.integrations': 'Интеграции',
  'connections.groups.desktop': 'Рабочий стол',
  'desktop.approvalSummary': '{operation} «{target}» в {app}',
  'desktop.action.click': 'Нажать',
  'desktop.action.type_text': 'Ввести текст в',
  'desktop.action.check': 'Отметить',
  'desktop.action.uncheck': 'Снять отметку',
  'desktop.action.expand': 'Развернуть',
  'desktop.action.collapse': 'Свернуть',
  'desktop.action.scroll': 'Прокрутить',
  ...
  'desktop.enabledPending':
    'Включено. Завершите настройку ниже перед использованием инструментов рабочего стола.',
  'desktop.moduleUnavailable':
    'Модуль рабочего стола недоступен. Проверьте его состояние и повторите попытку.',
  'desktop.pendingUnavailable':
    'Не удалось загрузить ожидающие подтверждения действий на рабочем столе. Обновите страницу и повторите попытку.',
  'desktop.unsupported': 'Управление рабочим столом недоступно в этой среде.',
  'desktop.localOnly': 'Эта настройка действует только на этом компьютере.',
  'desktop.permissions': 'Системные разрешения',
  'desktop.permission.accessibility': 'Универсальный доступ',
  'desktop.permission.screen_recording': 'Запись экрана',
  'desktop.openSettings': 'Открыть настройки',
  'desktop.captureNote':
    'Запись экрана нужна только для снимков. Универсальный доступ нужен для просмотра приложений и управления ими.',
  'desktop.testDescription': 'Проверьте, видит ли ядро приложения, запущенные на этом компьютере.',
  'desktop.testButton': 'Проверить доступ к рабочему столу',
  'desktop.testPassed': 'Доступ к рабочему столу работает.',
  'desktop.testFailed': 'Не удалось проверить доступ к рабочему столу.',
  ...
  'settings.costDashboard.unknownProvider': 'Нет',
  ...
  'mcp.tab.tablistAria': 'Представления MCP',
  'mcp.rows.showTools': 'Показать инструменты {name}',
  'mcp.rows.hideTools': 'Скрыть инструменты {name}',
  'mcp.rows.toolsLoading': 'Чтение инструментов…',
  'mcp.rows.toolsFailed': 'Не удалось прочитать инструменты.',
  'mcp.rows.add': 'Добавить сервер',
  ...
  'mcp.form.transportStdio': 'Локальная команда (stdio)',
  'mcp.form.transportHttp': 'Удалённый URL (HTTP)',
  'mcp.form.command': 'Команда',
  ...
  'mcp.form.authNone': 'Нет',
  'mcp.form.authBearer': 'Токен Bearer',
  'mcp.form.authHeader': 'Свой заголовок',
  'mcp.form.authOauth': 'Войти через браузер (OAuth)',
  'mcp.form.token': 'Токен',
  ...
  'mcp.form.saving': 'Сохранение…',
  'mcp.form.saveFailed': 'Не удалось сохранить сервер.',
  'mcp.rows.title': 'Установленные серверы',
  'mcp.rows.intro':
    'MCP-серверы, которые может вызывать ваш агент, как объявлено в mcp.json. Откройте сервер, чтобы увидеть его учётные данные и инструменты.',
  'mcp.rows.open': 'Открыть {name}',
  'mcp.rows.connect': 'Подключить {name}',
  'mcp.rows.disconnect': 'Отключить {name}',
  'mcp.rows.enable': 'Включить {name}',
  'mcp.rows.disable': 'Выключить {name}',
  'mcp.rows.remove': 'Удалить {name}',
  'mcp.rows.removeTitle': 'Удалить {name}?',
  'mcp.rows.removeBody':
    'Сервер и его сохранённые учётные данные будут удалены. Повторное объявление в mcp.json начнётся с нуля.',
  'mcp.rows.opFailed': 'Действие не удалось.',
  ...
  'mcp.tab.action.openPage': 'Открыть страницу',
  ...
  'mcp.json.saving': 'Сохранение…',
  'mcp.json.save': 'Сохранить',
  ...
  'voice.providers.desc':
    'Выберите, какой облачный движок распознаёт вашу речь и где выполняется синтез. Распознавание речи всегда работает в облаке; локальный вариант есть только у синтеза (Piper); он ставится кнопкой «Установить локально». Настраивать PIPER_BIN вручную не нужно.',
  'voice.providers.sttProvider': 'Поставщик преобразования речи в текст',
  'voice.providers.sttProviderAria': 'Поставщик STT',
  'voice.providers.backendSttProxy': 'Облако (прокси-сервер Whisper)',
  ...
  'conversations.composer.context.usage': 'Использование контекста',
  'conversations.composer.context.full': 'Заполнено на {percent}%',
  'conversations.composer.context.reasoning': 'Рассуждение',
  'conversations.composer.context.headroom': 'Свободно',
  'conversations.composer.context.meterLabel': 'Использование контекста: {label}',
  'conversations.composer.context.meterValue': '{used} из {limit}',
  'conversations.composer.context.loading': 'Измерение контекста…',
  'conversations.composer.context.errorTitle': 'Разбивка контекста недоступна',
  ...
  'conversations.composer.command.stop': 'Остановить текущий ответ',
  'conversations.composer.command.plan': 'Сначала план: просмотрите шаги перед запуском',
  'conversations.composer.command.build': 'Сборка: агент действует сразу',
  'conversations.composer.trigger.back': 'Назад',
  'conversations.composer.trigger.loading': 'Загрузка…',
  'conversations.composer.trigger.emptyCategories': 'Нет доступных элементов',
  'conversations.composer.slash.empty': 'Нет подходящих команд',
  'conversations.composer.mention.empty': 'Нет подходящих элементов',
  'conversations.composer.mention.memory': 'Память',
  'conversations.composer.mention.files': 'Файлы',
  ...
  'conversations.planReview.revise': 'Изменить',
  'conversations.runMode.plan': 'План',
  'conversations.runMode.build': 'Сборка',
  'conversations.runMode.toggleLabel': 'Переключение между режимом плана и режимом сборки',
  ...
  'conversations.tools.inspectDesktop.active': 'Проверка рабочего стола',
  'conversations.tools.inspectDesktop.done': 'Рабочий стол проверен',
  'conversations.tools.controlDesktop.active': 'Управление рабочим столом',
  'conversations.tools.controlDesktop.done': 'Управление рабочим столом завершено',
  ...
  'conversations.tools.document.title': 'Документ',
  'conversations.tools.presentation.title': 'Презентация',
  ...
  'conversations.subagent.transcript.instruction': 'инструкция',
  'conversations.subagent.transcript.agent': 'агент',
  'conversations.subagent.transcript.system': 'система',
  'conversations.tasks.taskOne': 'задача',
  'conversations.tasks.taskOther': 'задач',
  'conversations.tasks.running': 'выполняется',
  'conversations.tasks.waitingForInput': 'ожидает ответа',
  'conversations.tasks.done': 'готово',
  'conversations.tasks.failed': 'сбой',
  'conversations.tasks.of': 'из',
  ...
  'conversations.agentTaskInsights.memoryCitationFallbackTitle': 'Память',
  'conversations.memoryChips.remembered': 'запомнено {n}',
  'conversations.memoryChips.idle': 'память',
  'conversations.memoryChips.forgetAriaLabel': 'Забыть «{text}»',
  'conversations.scheduleCard.next': 'следующий',
  'conversations.scheduleCard.paused': 'приостановлено',
  'conversations.scheduleCard.recentRuns': 'последние запуски',
  'conversations.scheduleCard.ok': 'ок',
  'conversations.scheduleCard.failed': 'ошибка',
  'conversations.conversationSearch.placeholder': 'Поиск в разговоре',
  'conversations.conversationSearch.previousMatch': 'Предыдущее совпадение',
  'conversations.conversationSearch.nextMatch': 'Следующее совпадение',
  'conversations.conversationSearch.timelineToggle': 'Хронология',
  ...
  'notifications.flow.approveTitle': 'Рабочий процесс требует одобрения',
  'notifications.flow.approve': 'Одобрить',
  'notifications.flow.approving': 'Одобрение…',
  'notifications.flow.dismiss': 'Скрыть',
  'notifications.flow.error': 'Не удалось возобновить рабочий процесс. Попробуйте снова.',
  ...
  'flowRuns.inspector.output': 'Показать необработанный вывод',
  ...
  'flows.discoveries.title': 'Открытия процессов',
  'flows.discoveries.description':
    'Автоматизации, которые предлагает Flow Scout, исходя из того, как вы работаете.',
  'flows.allRuns.title': 'Запуски процессов',
  'flows.allRuns.description':
    'Каждый запуск процесса в вашем рабочем пространстве, сначала новые.',
  'flows.allRuns.loading': 'Загрузка запусков…',
  'flows.allRuns.empty': 'Пока нет запусков процессов.',
  'flows.allRuns.unknownWorkflow': 'Неизвестный процесс',
  'flows.allRuns.status.running': 'Выполняется',
  'flows.allRuns.status.completed': 'Завершено',
  'flows.allRuns.status.completed_with_warnings': 'Завершено с предупреждениями',
  ...
  'flows.copilot.tool.proposing': 'Предлагается рабочий процесс…',
  ...
  'flows.nodeKind.tool_call': 'Вызов инструмента',
  'flows.nodeKind.http_request': 'HTTP-запрос',
  'flows.nodeKind.code': 'Код',
  'flows.nodeKind.condition': 'Условие',
  'flows.nodeKind.switch': 'Переключатель',
  'flows.nodeKind.merge': 'Объединение',
  'flows.nodeKind.split_out': 'Разделение вывода',
  ...
  'flows.nodeSummary.trigger.appEvent': 'Запускается событием приложения',
  'flows.nodeSummary.trigger.unknownKind': 'Триггер: {kind}',
  'flows.nodeSummary.agent.defaultModel': 'модель по умолчанию',
  'flows.nodeSummary.agent.withPrompt': '«{prompt}» · {model}',
  'flows.nodeSummary.agent.default': 'Обращается к {model}',
  'flows.nodeSummary.toolCall.runsNative': 'Запускает {name}',
  'flows.nodeSummary.toolCall.pickNative': 'Запускает инструмент OpenHuman (выберите один)',
  'flows.nodeSummary.toolCall.runs': 'Запускает {slug}',
  'flows.nodeSummary.toolCall.pick': 'Запускает действие приложения (выберите одно)',
  'flows.nodeSummary.http.withUrl': '{method} {url}',
  'flows.nodeSummary.http.noUrl': 'Запрос {method} (укажите URL)',
  'flows.nodeSummary.code.runs': 'Запускает код на {lang}',
  'flows.nodeSummary.condition.withField': 'Если {field} → истина / ложь',
  'flows.nodeSummary.condition.default': 'Разветвляется на истина / ложь',
  'flows.nodeSummary.switch.byExpr': 'Маршрутизирует по {expr}',
  'flows.nodeSummary.switch.byExprWithRoutes': 'Маршрутизирует по {expr} (маршрутов: {count})',
  'flows.nodeSummary.switch.byValue': 'Маршрутизирует по значению',
  'flows.nodeSummary.switch.byValueWithRoutes': 'Маршрутизирует по значению (маршрутов: {count})',
  'flows.nodeSummary.merge': 'Объединяет параллельные ветви',
  'flows.nodeSummary.splitOut.withPath': 'Разбивает каждое {path}',
  'flows.nodeSummary.splitOut.default': 'Разбивает список на элементы',
  'flows.nodeSummary.transform.default': 'Преобразует каждый элемент',
  'flows.nodeSummary.transform.setFieldsSingular': 'Устанавливает {n} поле в каждом элементе',
  'flows.nodeSummary.transform.setFieldsPlural': 'Устанавливает {n} полей в каждом элементе',
  'flows.nodeSummary.outputParser': 'Разбирает предыдущий вывод',
  'flows.nodeSummary.subWorkflow': 'Запускает вложенный процесс',
  'flows.nodeSummary.memory.flavourWith': 'Читает стиль «{flavour}»',
  'flows.nodeSummary.memory.flavour': 'Читает стиль из памяти',
  'flows.nodeSummary.memory.people': 'Ищет в памяти о людях',
  'flows.nodeSummary.memory.remember': 'Сохраняет значение в этом процессе',
  'flows.nodeSummary.memory.forget': 'Забывает значение из этого процесса',
  'flows.nodeSummary.memory.searchScoped': 'Ищет в памяти ({scope})',
  'flows.nodeSummary.memory.search': 'Ищет в памяти',
  'flows.nodeSummary.memory.recallScoped': 'Вспоминает из памяти ({scope})',
  ...
  'flows.cron.customSchedule': 'Особое расписание ({expr})',
  'flows.cron.noScheduleSet': 'Расписание не задано',
  'flows.cron.weekdays': 'будни',
  'flows.cron.weekends': 'выходные',
  'flows.cron.everyMinute': 'Каждую минуту',
  'flows.cron.everyMinuteOnDays': 'Каждую минуту по {days}',
  'flows.cron.everyNMinutes': 'Каждые {n} минут',
  'flows.cron.everyNMinutesOnDays': 'Каждые {n} минут по {days}',
  'flows.cron.everyHour': 'Каждый час',
  'flows.cron.everyHourOnDays': 'Каждый час по {days}',
  'flows.cron.everyNHours': 'Каждые {n} часов',
  'flows.cron.everyNHoursOnDays': 'Каждые {n} часов по {days}',
  'flows.cron.everyDayAtTime': 'Каждый день в {time}',
  'flows.cron.atTimeOnDays': 'В {time} по {days}',
  'flows.cron.invalidInterval': 'Недопустимый интервал',
  'flows.cron.dailyEvery24h': 'Ежедневно (каждые 24 ч)',
  'flows.cron.everyNDays': 'Каждые {n} дней',
  'flows.cron.everyNHoursShort': 'Каждые {n} ч',
  'flows.cron.everyNMinutesShort': 'Каждые {n} мин',
  'flows.cron.everySecond': 'Каждую секунду',
  'flows.cron.everyNSeconds': 'Каждые {n} с',
  'flows.cron.onceAtRaw': 'Один раз в {at}',
  'flows.cron.onceAt': 'Один раз в {at}',
  ...
  'settings.ai.providers.groupLocal': 'Локальные среды',
  'settings.ai.providers.groupCli': 'Входы через CLI',
  'settings.ai.providers.cliDetail': 'Использует вход, который уже есть у другого CLI',
  'settings.ai.providers.connected': 'Подключено',
  'settings.ai.providers.managedDetail': 'OpenHuman выбирает модель для каждой задачи',
  'settings.ai.providers.rowActions': 'Другие действия для {provider}',
  ...
  'settings.ai.providers.placeholderCloud': 'Выберите облачного провайдера…',
  ...
  'settings.ai.providers.localDetail': 'Работает на этом устройстве',
  ...
  'settings.ai.routing.defaultModel': 'Модель по умолчанию',
  'settings.ai.routing.defaultModelDesc':
    'Модель, на которой выполняется управляемый ход чата. Рабочие нагрузки ниже, оставшиеся управляемыми, используют её.',
  'settings.ai.routing.defaultModelUnset': 'Не задано',
  ...
  'settings.ai.routing.workload.chat.hint':
    'Рекомендуется: дешевая или средняя стоимость модели быстрого чата с большим количеством токенов в секунду и низкой задержкой. Локальные модели с открытым исходным кодом могут здесь хорошо работать, если они чувствуют себя отзывчивыми.',
  'settings.ai.routing.workload.reasoning.label': 'Reasoning',
  'settings.ai.routing.workload.reasoning.description':
    'Главный чат-агент, сумматор встреч: режим «Рассуждение» в «Беседах».',
  'settings.ai.routing.workload.reasoning.hint':
    'Рекомендуется: более дорогая модель или модель сильного рассуждения для глубокого мышления. Это используется для основного чат-агента, сводок встреч и более подробного синтеза ответов.',
  'settings.ai.routing.workload.agentic.label': 'Agentic',
  'settings.ai.routing.workload.agentic.description':
    'Исполнители субагентов, циклы инструментов, решения GIF',
  'settings.ai.routing.workload.agentic.hint':
    'Рекомендуется: надежная модель, выполняющая инструкции и требующая интенсивного использования инструментов. Пограничные модели средней стоимости обычно самые безопасные; Подходящие модели с открытым исходным кодом могут работать, если вызовы инструментов стабильны.',
  'settings.ai.routing.workload.coding.label': 'Coding',
  'settings.ai.routing.workload.coding.description': 'Генерация кода и этапы рефакторинга',
  'settings.ai.routing.workload.coding.hint':
    'Рекомендуется: модель, настроенная на кодирование, с четким соблюдением инструкций, качеством редактирования и производительностью в длительном контексте. Обычно на это стоит потратить больше.',
  'settings.ai.routing.workload.vision.label': 'Vision',
  'settings.ai.routing.workload.vision.description':
    'Понимание изображения для субагента видения: всегда мультимодально',
  ...
  'settings.ai.workload.columnHeader': 'Задача',
  ...
  'skills.setup.voice.sttNotReadyDesc':
    'Голосовому интеллекту нужен работающий движок распознавания речи. Выберите его в разделе «Настройки › Голос».',
  ...
  'composer.settings.loadingModels': 'Загрузка моделей…',
