...
const messages: TranslationMap = {
  ...
  'conversations.toolFailure.notFound.cause': '이 작업이 요청한 항목이 없거나 여기서 사용할 수 없습니다.',
  'conversations.toolFailure.notFound.next': '따로 할 일은 없습니다. 어시스턴트가 올바른 이름을 찾아 다시 시도할 수 있습니다.',
  'conversations.toolFailure.unsupported.cause': 'OpenHuman은 아직 이 작업을 자동으로 할 수 없습니다.',
