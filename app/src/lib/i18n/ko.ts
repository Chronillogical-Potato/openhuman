...
const messages: TranslationMap = {
  ...
  'brain.welcome.featsLabel': '여기에 담기는 것',
  ...
  'feedback.header.desc': '아이디어를 공유하고 다음에 만들 것에 투표하세요.',
  'feedback.welcome.nav': '환영합니다',
  'feedback.welcome.main': '피드백 보드',
  'feedback.welcome.eyebrow': '피드백',
  'feedback.welcome.title': '우리가 만들 것을 함께 만들어가세요',
  'feedback.welcome.body':
    '무엇이 잘 되고 있는지, 무엇이 부족한지, 무엇이 OpenHuman을 더 좋게 만들지 알려주세요. 아이디어를 올리고, 다른 사람의 제안에 투표하고, 최고의 아이디어가 우리 로드맵의 최상단으로 올라가는 것을 지켜보세요.',
  'feedback.welcome.ctaShare': '아이디어 공유',
  ...
  'feedback.welcome.feat3Body': '계획된 것, 진행 중인 것, 출시된 것을 확인하세요.',
  'connections.header.composio': '당신의 에이전트가 활동할 수 있는 앱을 연결하세요.',
  'connections.header.channels': '당신의 커뮤니티가 머무는 채팅 앱을 연결하세요.',
  ...
  'connections.welcome.feat3Title': '통제권 유지',
  'connections.welcome.feat3Body':
    '언제든 채널별로 접근 권한을 부여하거나 철회하세요. 당신의 허락 없이는 아무것도 실행되지 않습니다.',
  'alerts.header.desc': '에이전트 활동과 당신의 주의가 필요한 모든 것.',
  'notifications.welcome.nav': '환영합니다',
  'notifications.welcome.main': '알림',
  ...
  'notifications.welcome.feat1Body': '에이전트가 사람에게 넘긴 결정과 언급.',
  ...
  'rewards.welcome.feat1Body': '일상적인 활동과 추천이 시간이 지나며 쌓입니다.',
  'rewards.welcome.feat2Title': '연속 기록 유지',
  'rewards.welcome.feat2Body': '꾸준히 방문해 연속 기록 보너스를 잠금 해제하세요.',
  'rewards.welcome.feat3Title': '혜택 사용',
  'rewards.welcome.feat3Body': '포인트를 쿠폰과 리워드로 바꾸세요.',
  'flows.welcome.nav': '환영합니다',
  'flows.welcome.main': '워크플로',
  ...
  'conversations.backgroundTasks.inboxReady': '{count}개 준비됨',
  'conversations.backgroundTasks.inboxInFlight': '{count}개 진행 중',
  'conversations.backgroundTasks.memoryJobTitle': '메모리 동기화',
  'conversations.backgroundTasks.cancelJob': '취소',
  ...
  'wallet.tabs.balance': '지갑 잔액',
  'wallet.tabs.recovery': '복구',
  'wallet.ariaLabel': '지갑 보기',
  ...
  'common.filter': '필터',
  'skills.explorer.colSkill': '스킬',
  'skills.explorer.colDescription': '설명',
  'skills.explorer.colProvider': '제공자',
  'skills.explorer.colAction': '작업',
  'sync.runs': '동기화 실행',
  'sync.totalCost': '합계',
  'sync.when': '시간',
  'sync.source': '소스',
  ...
  'settings.tokenUsage.savingsTitle': '절감',
  'settings.tokenUsage.attributedTo': '{model} 기준으로 비용 책정됨',
  'settings.tokenUsage.tokensSaved': '절약된 토큰',
  'settings.tokenUsage.costSaved': '절약된 비용',
  'settings.tokenUsage.cacheOccupancy': '캐시된 원본',
  'settings.tokenUsage.compactions': '압축 횟수',
  'settings.tokenUsage.overEvents': '{count}회 압축에 걸쳐',
  'settings.tokenUsage.byCompressor': '압축기별',
  'settings.tokenUsage.refresh': '새로고침',
  'settings.tokenUsage.reset': '통계 재설정',
  'settings.tokenUsage.compressionTitle': '압축',
  'settings.tokenUsage.compressionDesc':
    '대용량 도구 출력이 모델 컨텍스트에 들어가기 전에 콘텐츠를 인식하여 압축합니다.',
  'settings.tokenUsage.routerEnabled': '압축 활성화',
  'settings.tokenUsage.routerEnabledDesc': '콘텐츠 라우터의 마스터 스위치입니다.',
  'settings.tokenUsage.search': '검색 결과',
  'settings.tokenUsage.searchDesc':
    'grep/검색 출력을 관련성 순으로 정렬하고 상위 일치 항목을 유지합니다.',
  'settings.tokenUsage.code': '소스 코드',
  ...
  'settings.tokenUsage.ccrEnabled': '복구를 위해 원본 유지',
  'settings.tokenUsage.ccrEnabledDesc':
    '원본을 오프로드하고 검색 표식을 추가하여 아무것도 손실되지 않도록 합니다.',
  'settings.tokenUsage.ccrMinTokens': '캐시할 최소 크기',
  'settings.tokenUsage.ccrMinTokensDesc':
    '이 토큰 수 이상으로 추정되는 결과만 캐시하고 손실 압축합니다.',
  'settings.tokenUsage.tokensUnit': '토큰',
  ...
  'chat.newWindowPrompt': '오늘 무엇을 도와드릴까요?',
  'chat.welcomeSuggestion.calendarToday': '오늘 내 일정은 뭐야?',
  'chat.welcomeSuggestion.unreadEmail': '읽지 않은 이메일을 요약해 줘.',
  'chat.welcomeSuggestion.draftReply': '마지막 메시지에 대한 답장 초안을 써 줘.',
  'chat.welcomeSuggestion.followUps': '이번 주에 후속 조치하겠다고 한 일이 뭐야?',
  ...
  'chat.messageQueue.running': '실행 중',
  'chat.messageQueue.queuedCount': '{count}개 대기 중',
  'chat.messageQueue.pendingHint': '이 작업이 끝나면 전송됩니다',
  'chat.messageQueue.remove': '대기열에서 "{text}" 제거',
  'chat.connectionState.dropped': '연결이 끊겼습니다. 서버에서는 실행이 계속되었습니다.',
  'chat.connectionState.reconnect': '다시 연결',
  'chat.connectionState.reconnecting': '다시 연결하는 중',
  'chat.connectionState.resumed': '스트림을 다시 이어받았습니다.',
  ...
  'connections.tabs.browser': '브라우저 제어',
  'connections.browser.description': '브라우저 작업을 설정하고 준비 상태를 확인하세요.',
  'connections.earlyAlphaNotice':
    '초기 알파: 브라우저 및 데스크톱 제어는 아직 테스트 중입니다. 동작이 예상과 다르거나 릴리스마다 변경될 수 있습니다.',
  'connections.browser.module': '모듈',
  'connections.browser.chrome': 'Chrome',
  'connections.browser.unknown': '알 수 없음',
  'connections.browser.notVerified': '확인되지 않음',
  'connections.browser.localOverride': '릴리스 파일이 게시되기 전에는 로컬 모듈이 필요합니다.',
  'connections.browser.testModule': '모듈 테스트',
  'connections.browser.enabled': '브라우저 활성화',
  'connections.browser.headless': '헤드리스',
  'connections.browser.width': '화면 너비',
  'connections.browser.height': '화면 높이',
  'connections.browser.chromePath': 'Chrome 경로(선택)',
  'connections.browser.profileMode': '프로필',
  'connections.browser.fresh': '새 프로필',
  'connections.browser.persistent': '유지되는 프로필',
  'connections.browser.profilePath': '프로필 폴더',
  'connections.browser.downloadDir': '다운로드 폴더',
  'connections.browser.maxSteps': '최대 작업 단계',
  'connections.browser.timeout': '시간 제한(초)',
  'connections.browser.allowedWebsites': '허용된 웹사이트',
  'connections.browser.sharedPolicy': '브라우저와 웹 검색은 같은 웹사이트 정책을 사용합니다.',
  'connections.browser.manageWebsites': '허용된 웹사이트 관리',
  'connections.browser.jevRoute': 'Jev 결제 경로',
  ...
  'connections.browser.chromeReady': 'Chrome 준비됨',
  'connections.browser.chromeNotReady': 'Chrome 사용 불가',
  'connections.browser.readinessChecked': '준비 상태 확인됨',
  'connections.browser.boundsRequired':
    '너비 320–3840, 높이 240–2160, 단계 1–100, 시간 제한 5–600초를 사용하세요.',
  'connections.browser.noneAllowed': '허용된 웹사이트 없음',
  'connections.browser.moduleChecked': '모듈 확인됨',
  'connections.tabs.skills': '스킬',
  'connections.tabs.meetings': '미팅',
  'connections.groups.integrations': '통합',
  'connections.groups.desktop': '데스크톱',
  'desktop.approvalSummary': '{app}에서 “{target}” {operation}',
  'desktop.action.click': '클릭',
  'desktop.action.type_text': '텍스트 입력',
  'desktop.action.check': '선택',
  'desktop.action.uncheck': '선택 해제',
  'desktop.action.expand': '펼치기',
  'desktop.action.collapse': '접기',
  'desktop.action.scroll': '스크롤',
  'desktop.title': '데스크톱 제어',
  'desktop.description': '에이전트가 이 컴퓨터의 앱에서 작업하도록 허용합니다.',
  'desktop.enabledPending':
    '활성화되었습니다. 데스크톱 도구를 사용하기 전에 아래 설정을 완료하세요.',
  'desktop.moduleUnavailable':
    '데스크톱 모듈을 사용할 수 없습니다. 상태를 확인하고 다시 시도하세요.',
  'desktop.pendingUnavailable':
    '대기 중인 데스크톱 승인을 불러올 수 없습니다. 새로고침 후 다시 시도하세요.',
  'desktop.unsupported': '이 실행 환경에서는 데스크톱 제어를 사용할 수 없습니다.',
  'desktop.localOnly': '이 설정은 이 컴퓨터에만 적용됩니다.',
  'desktop.permissions': '시스템 권한',
  'desktop.permission.accessibility': '손쉬운 사용',
  'desktop.permission.screen_recording': '화면 기록',
  'desktop.openSettings': '설정 열기',
  'desktop.captureNote':
    '화면 기록은 스크린샷에만 필요합니다. 앱을 살펴보고 제어하려면 손쉬운 사용 권한이 필요합니다.',
  'desktop.testDescription': '코어가 이 컴퓨터에서 실행 중인 앱을 볼 수 있는지 확인합니다.',
  'desktop.testButton': '데스크톱 접근 테스트',
  'desktop.testPassed': '데스크톱 접근이 작동합니다.',
  'desktop.testFailed': '데스크톱 접근을 확인할 수 없습니다.',
  ...
  'mcp.rows.showTools': '{name}의 도구 표시',
  'mcp.rows.hideTools': '{name}의 도구 숨기기',
  'mcp.rows.toolsLoading': '도구를 읽는 중…',
  'mcp.rows.toolsFailed': '도구를 읽을 수 없습니다.',
  'mcp.rows.add': '서버 추가',
  ...
  'mcp.form.transportStdio': '로컬 명령 (stdio)',
  'mcp.form.transportHttp': '원격 URL (HTTP)',
  'mcp.form.command': '명령',
  'mcp.form.args': '인수',
  'mcp.form.argsHint': '공백으로 구분합니다. 공백이 포함된 인수는 따옴표로 감싸세요.',
  'mcp.form.env': '환경 변수',
  'mcp.form.envHint': '명령에 전달됩니다. 값은 암호화되어 저장되며 다시 표시되지 않습니다.',
  ...
  'mcp.form.url': 'URL',
  'mcp.form.auth': '인증',
  'mcp.form.authNone': '없음',
  'mcp.form.authBearer': 'Bearer 토큰',
  'mcp.form.authHeader': '사용자 지정 헤더',
  'mcp.form.authOauth': '브라우저로 로그인 (OAuth)',
  'mcp.form.token': '토큰',
  ...
  'mcp.form.saving': '저장 중…',
  'mcp.form.saveFailed': '서버를 저장할 수 없습니다.',
  ...
  'mcp.tab.action.openPage': '페이지 열기',
  ...
  'mnemonic.importAnExistingWallet': '기존 지갑 가져오기',
  'mnemonic.createANewWallet': '새 지갑 만들기',
  'mnemonic.importWallet': '지갑 가져오기',
  ...
  'voice.providers.desc':
    '어떤 호스팅 엔진이 음성을 전사할지, 합성은 어디에서 실행할지 선택하세요. 음성 인식은 항상 클라우드에서 실행되며, 합성만 로컬 옵션(Piper)이 있고 로컬 설치 버튼으로 설치합니다. PIPER_BIN을 직접 설정할 필요는 없습니다.',
  'voice.providers.sttProvider': '음성-텍스트 공급자',
  'voice.providers.sttProviderAria': 'STT 공급자',
  'voice.providers.backendSttProxy': '클라우드(속삭임 프록시)',
  ...
  'chat.approval.expiresIn': '{time} 후 만료',
  'chat.elicitation.send': '보내기',
  'chat.elicitation.decline': '거부',
  'chat.elicitation.needsInput': '입량 필요',
  'chat.elicitation.sentTo': '{server}로 전송되',
  'chat.elicitation.declined': '거부될',
  'chat.elicitation.title': '응답이 필요합니다',
  ...
  'conversations.composer.context.usage': '컨텍스트 사용량',
  'conversations.composer.context.full': '{percent}% 사용됨',
  'conversations.composer.context.reasoning': '추론',
  'conversations.composer.context.headroom': '남은 공간',
  'conversations.composer.context.meterLabel': '{label} 컨텍스트 사용량',
  ...
  'conversations.composer.command.plan': '먼저 계획: 실행 전에 단계를 검토하세요',
  'conversations.composer.command.build': '빌드: 에이전트가 바로 실행하도록 하기',
  'conversations.composer.trigger.back': '뒤로',
  'conversations.composer.trigger.loading': '불러오는 중…',
  'conversations.composer.trigger.emptyCategories': '사용 가능한 항목이 없습니다',
  'conversations.composer.slash.empty': '일치하는 명령이 없습니다',
  'conversations.composer.mention.empty': '일치하는 항목이 없습니다',
  'conversations.composer.mention.memory': '메모리',
  'conversations.composer.mention.files': '파일',
  ...
  'conversations.planReview.feedbackPlaceholder': '무엇을 바꿀지 설명하세요…',
  'conversations.planReview.sendFeedback': '의견 보내기',
  'conversations.planReview.revise': '수정',
  'conversations.runMode.plan': '계획',
  'conversations.runMode.build': '빌드',
  'conversations.runMode.toggleLabel': '계획 모드와 빌드 모드 전환',
  ...
  'conversations.tools.inspectDesktop.active': '데스크톱 확인 중',
  'conversations.tools.inspectDesktop.done': '데스크톱 확인 완료',
  'conversations.tools.controlDesktop.active': '데스크톱 제어 중',
  'conversations.tools.controlDesktop.done': '데스크톱 제어 완료',
  ...
  'conversations.tools.document.title': '문서',
  'conversations.tools.presentation.title': '프레젠테이션',
  ...
  'conversations.subagent.transcript.instruction': '지시',
  'conversations.subagent.transcript.agent': '에이전트',
  'conversations.subagent.transcript.system': '시스템',
  'conversations.tasks.taskOne': '작업',
  'conversations.tasks.taskOther': '작업',
  'conversations.tasks.running': '실행 중',
  'conversations.tasks.waitingForInput': '입력 대기 중',
  'conversations.tasks.done': '완료',
  'conversations.tasks.failed': '실패',
  'conversations.tasks.of': '중',
  ...
  'conversations.memoryChips.remembered': '{n}개 저장됨',
  'conversations.memoryChips.idle': '메모리',
  'conversations.memoryChips.forgetAriaLabel': '"{text}" 잊기',
  'conversations.scheduleCard.next': '다음',
  'conversations.scheduleCard.paused': '일시중지',
  'conversations.scheduleCard.recentRuns': '최근 실행',
  'conversations.scheduleCard.ok': '성공',
  'conversations.scheduleCard.failed': '실패',
  'conversations.conversationSearch.placeholder': '대화 내 검색',
  'conversations.conversationSearch.previousMatch': '이전 일치',
  'conversations.conversationSearch.nextMatch': '다음 일치',
  'conversations.conversationSearch.timelineToggle': '타임라인',
  ...
  'notifications.flow.approveTitle': '워크플로에 승인이 필요합니다',
  'notifications.flow.approve': '승인',
  'notifications.flow.approving': '승인 중…',
  'notifications.flow.dismiss': '닫기',
  'notifications.flow.error': '워크플로를 다시 시작할 수 없습니다. 다시 시도해 주세요.',
  ...
  'flowRuns.inspector.output': '원본 출력 보기',
  ...
  'flows.page.emptyTitle': '아직 워크플로가 없습니다',
  ...
  'flows.list.runNow': '실행',
  'flows.list.running': '실행 중…',
  'flows.list.viewRuns': '실행 내역 보기',
  ...
  'flows.nodeKind.tool_call': '도구 호출',
  'flows.nodeKind.http_request': 'HTTP 요청',
  'flows.nodeKind.code': '코드',
  'flows.nodeKind.condition': '조건',
  'flows.nodeKind.switch': '스위치',
  'flows.nodeKind.merge': '병합',
  'flows.nodeKind.split_out': '분할 출력',
  ...
  'flows.nodeSummary.trigger.appEvent': '앱 이벤트로 실행됩니다',
  'flows.nodeSummary.trigger.unknownKind': '트리거: {kind}',
  'flows.nodeSummary.agent.defaultModel': '기본 모델',
  'flows.nodeSummary.agent.withPrompt': '“{prompt}” · {model}',
  'flows.nodeSummary.agent.default': '{model}에 질문합니다',
  'flows.nodeSummary.toolCall.runsNative': '{name} 실행',
  'flows.nodeSummary.toolCall.pickNative': 'OpenHuman 도구를 실행합니다 (하나 선택)',
  'flows.nodeSummary.toolCall.runs': '{slug} 실행',
  'flows.nodeSummary.toolCall.pick': '앱 작업을 실행합니다 (하나 선택)',
  'flows.nodeSummary.http.withUrl': '{method} {url}',
  'flows.nodeSummary.http.noUrl': '{method} 요청 (URL 설정 필요)',
  'flows.nodeSummary.code.runs': '{lang} 코드 실행',
  'flows.nodeSummary.condition.withField': '{field}이(가) 참이면 → 참 / 거짓',
  'flows.nodeSummary.condition.default': '참 / 거짓으로 분기합니다',
  'flows.nodeSummary.switch.byExpr': '{expr}에 따라 라우팅합니다',
  'flows.nodeSummary.switch.byExprWithRoutes': '{expr}에 따라 라우팅합니다 (경로 {count}개)',
  'flows.nodeSummary.switch.byValue': '값에 따라 라우팅합니다',
  'flows.nodeSummary.switch.byValueWithRoutes': '값에 따라 라우팅합니다 (경로 {count}개)',
  'flows.nodeSummary.merge': '병렬 분기를 병합합니다',
  'flows.nodeSummary.splitOut.withPath': '{path}별로 분할합니다',
  'flows.nodeSummary.splitOut.default': '목록을 항목으로 분할합니다',
  'flows.nodeSummary.transform.default': '각 항목의 형태를 변경합니다',
  'flows.nodeSummary.transform.setFieldsSingular': '각 항목에 {n}개 필드를 설정합니다',
  'flows.nodeSummary.transform.setFieldsPlural': '각 항목에 {n}개 필드를 설정합니다',
  'flows.nodeSummary.outputParser': '이전 출력을 분석합니다',
  'flows.nodeSummary.subWorkflow': '중첩된 워크플로를 실행합니다',
  'flows.nodeSummary.memory.flavourWith': '"{flavour}" 스타일을 읽습니다',
  'flows.nodeSummary.memory.flavour': '메모리 스타일을 읽습니다',
  'flows.nodeSummary.memory.people': '사람 메모리를 조회합니다',
  'flows.nodeSummary.memory.remember': '이 워크플로에 값을 저장합니다',
  'flows.nodeSummary.memory.forget': '이 워크플로에서 값을 잊습니다',
  'flows.nodeSummary.memory.searchScoped': '메모리를 검색합니다 ({scope})',
  'flows.nodeSummary.memory.search': '메모리를 검색합니다',
  'flows.nodeSummary.memory.recallScoped': '메모리에서 회상합니다 ({scope})',
  ...
  'flows.cron.customSchedule': '사용자 지정 일정 ({expr})',
  'flows.cron.noScheduleSet': '설정된 일정이 없습니다',
  'flows.cron.weekdays': '평일',
  'flows.cron.weekends': '주말',
  'flows.cron.everyMinute': '매분',
  'flows.cron.everyMinuteOnDays': '{days}마다 매분',
  'flows.cron.everyNMinutes': '{n}분마다',
  'flows.cron.everyNMinutesOnDays': '{days} {n}분마다',
  'flows.cron.everyHour': '매시간',
  'flows.cron.everyHourOnDays': '{days} 매시간',
  'flows.cron.everyNHours': '{n}시간마다',
  'flows.cron.everyNHoursOnDays': '{days} {n}시간마다',
  'flows.cron.everyDayAtTime': '매일 {time}에',
  'flows.cron.atTimeOnDays': '{days} {time}에',
  'flows.cron.invalidInterval': '잘못된 간격',
  'flows.cron.dailyEvery24h': '매일 (24시간마다)',
  'flows.cron.everyNDays': '{n}일마다',
  'flows.cron.everyNHoursShort': '{n}시간마다',
  'flows.cron.everyNMinutesShort': '{n}분마다',
  'flows.cron.everySecond': '매초',
  'flows.cron.everyNSeconds': '{n}초마다',
  'flows.cron.onceAtRaw': '{at}에 한 번',
  'flows.cron.onceAt': '{at}에 한 번',
  ...
  'flows.nodeConfig.agent.modelManagedTiers': '워크로드 역할',
  ...
  'settings.ai.providers.groupLocal': '로컬 런타임',
  'settings.ai.providers.groupCli': 'CLI 로그인',
  'settings.ai.providers.cliDetail': '다른 CLI가 이미 가진 로그인을 사용합니다',
  'settings.ai.providers.connected': '연결됨',
  'settings.ai.providers.managedDetail': 'OpenHuman이 작업마다 모델을 선택합니다',
  'settings.ai.providers.rowActions': '{provider} 추가 작업',
  ...
  'settings.ai.providers.addProviderSubtitle':
    '연결할 제공자를 고르세요. 언제든지 더 추가할 수 있습니다.',
  'settings.ai.providers.placeholderCloud': '클라우드 제공자 선택…',
  ...
  'settings.ai.providers.localDetail': '이 기기에서 실행됩니다',
  ...
  'settings.theme.variantAuto': '자동',
  'settings.theme.variantAria': '테마 변형',
  'settings.theme.backdropHeading': '배경',
  'settings.theme.backdrop.mesh': '메시',
  ...
  'settings.theme.group.accents': '강조 색상',
  'settings.theme.showShades': '모든 강조 음영 표시',
  'settings.theme.hideShades': '모든 강조 음영 숨기기',
  'settings.theme.fontsHeading': '글꼴',
  'settings.theme.fontRole.title': '제목',
  'settings.theme.fontRole.heading': '헤딩',
  'settings.theme.fontRole.body': '본문',
  'settings.theme.fontRole.mono': '고정폭',
  'settings.theme.fontRole.serif': '세리프',
  'settings.theme.fontCurrent': '현재',
  'settings.theme.actions': '테마 관리',
  'settings.theme.reset': '재정의 초기화',
  'settings.theme.delete': '테마 삭제',
  'settings.theme.export': 'JSON 복사',
  'settings.theme.copied': '복사됨!',
  'settings.theme.import': '테마 가져오기',
  'settings.theme.importHint': '내보낸 테마 JSON을 붙여넣어 사용자 지정 테마로 추가하세요.',
  'settings.theme.importApply': '가져오기',
  'settings.theme.importError': '해당 테마 JSON을 구문 분석할 수 없습니다.',
  ...
  'skills.setup.voice.sttNotReadyDesc':
    '음성 인텔리전스에는 작동하는 음성 인식 엔진이 필요합니다. 설정 › 음성에서 하나를 선택하세요.',
  ...
  'walletBalances.earlyAlphaNotice':
    '초기 알파: 지갑 잔액은 아직 테스트 중입니다. 금액과 지원 네트워크는 릴리스마다 변경될 수 있습니다.',
  'walletBalances.allNetworks': '모든 네트워크',
  'walletBalances.manageTokens': '토큰 관리',
  'walletBalances.noFilterMatches': '필터와 일치하는 잔액이 없습니다',
  'walletBalances.colToken': '토큰',
  ...
  'settings.ai.picker.searchPlaceholder': '모델 검색',
  ...
  'settings.ai.burnRateSampleDetail': '{hours}시간 표본에서 시간당 {rows}행',
  'settings.ai.needTimestampsForBurnRate': '최소 두 개의 지출 행에 대한 타임스탬프가 필요합니다.',
  'settings.ai.projectedEmptyDetail': '최근 소비 속도 기준 마지막 지출 후 {hours}시간',
  'settings.ai.noProjectionWithoutSpend': '최근 시간당 지출이 없으면 예측할 수 없습니다.',
  'settings.ai.readsPerDollar': '{count}회 읽기/$',
  ...
  'settings.mcpServer.tools.runSubagent': '프롬프트로 서브에이전트를 실행합니다',
  'settings.mcpServer.tools.memorySearch': '시맨틱 쿼리로 메모리를 검색합니다',
  'settings.mcpServer.tools.memoryRecall': 'ID로 특정 메모리를 불러옵니다',
  ...
  'settings.notifications.category.skills.desc': '스킬 동기화 이벤트 및 OAuth 상태 변경.',
  ...
  'settings.cron.jobs.scheduleEvery': '{ms}ms마다',
  'skills.category.all': '전체',
  'skills.category.builtIn': '내장',
  'skills.category.channels': '채널',
  'skills.category.productivity': '생산성',
  'skills.category.chat': '채팅',
  'skills.category.toolsAutomation': '도구 및 자동화',
  'skills.category.social': '소셜',
  'skills.category.platform': '플랫폼',
  'skills.category.other': '기타',
  'workspace.wipeSuccessTitle': '메모리 삭제됨',
  'workspace.wipeSuccessMessage':
    '{rows}개 행과 {dirs}개 폴더가 제거되었으며, 동기화 상태 커서 {cursors}개가 초기화되었습니다. 다시 채우려면 연결된 소스에서 동기화를 클릭하세요.',
  'workspace.wipeFailedTitle': '재설정 실패',
  'workspace.resetTreeSuccessTitle': '메모리 트리 재구성 중',
  'workspace.resetTreeSuccessMessage':
    '트리 행 {treeRows}개가 삭제되었으며, 청크 {chunks}개가 다시 대기열에 추가되었습니다(추출 작업 {jobs}개). 워커가 진행됨에 따라 그래프가 다시 채워집니다.',
  'workspace.resetTreeFailedTitle': '메모리 트리를 재설정할 수 없습니다',
  'workspace.buildTreesFailedTitle': '요약 트리를 생성할 수 없습니다',
  'invites.redeemHeading': '추천 코드가 있나요?',
  'invites.redeemPlaceholder': '추천 코드',
  'invites.redeemSubmit': '사용하기',
};
