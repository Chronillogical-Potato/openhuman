...
const messages: TranslationMap = {
  ...
  'brain.header.graph': 'كيف يترابط معرفة وكيلك: الأشخاص والمواضيع والذكريات.',
  'brain.header.goals': 'ما الذي يعمل وكيلك على تحقيقه، ولماذا.',
  'brain.header.sources': 'البيانات التي يتعلّم منها وكيلك.',
  'brain.header.sync': 'حافظ على حداثة ذاكرتك وراجع ما تغيّر.',
  'brain.welcome.nav': 'مرحبًا',
  'brain.welcome.eyebrow': 'العقل',
  'brain.welcome.title': 'ذاكرة وكيلك، مرسومة',
  'brain.welcome.body':
    'العقل هو المكان الذي يحتفظ فيه وكيلك بما يعرفه: الأشخاص والمحادثات والمصادر والأهداف التي يستند إليها لمساعدتك بسياق حقيقي بدلاً من البدء من الصفر في كل مرة.',
  'brain.welcome.ctaGraph': 'افتح رسم الذاكرة',
  'brain.welcome.ctaGoals': 'حدّد الأهداف',
  'brain.welcome.ctaSources': 'اربط المصادر',
  'brain.welcome.featsLabel': 'ما الذي يوجد هنا',
  'brain.welcome.feat1Title': 'رسم الذاكرة',
  'brain.welcome.feat1Body': 'شاهد كيف يترابط الأشخاص والمواضيع والرسائل في لمحة.',
  'brain.welcome.feat2Title': 'الأهداف والتركيز',
  'brain.welcome.feat2Body': 'أخبر وكيلك بما يهم كي يعطي الأولوية للعمل الصحيح.',
  'brain.welcome.feat3Title': 'المصادر والمزامنة',
  'brain.welcome.feat3Body': 'اربط البيانات التي يتعلّم منها وكيلك وحافظ على حداثتها.',
  'feedback.header.title': 'الملاحظات',
  'feedback.header.desc': 'شارك الأفكار وصوّت على ما نبنيه لاحقًا.',
  'feedback.welcome.nav': 'مرحبًا',
  'feedback.welcome.main': 'لوحة الملاحظات',
  'feedback.welcome.eyebrow': 'الملاحظات',
  'feedback.welcome.title': 'ساعد في تشكيل ما نبنيه',
  'feedback.welcome.body':
    'أخبرنا بما ينجح وما ينقص وما الذي سيجعل OpenHuman أفضل. انشر فكرة، وصوّت على ما يقترحه الآخرون، وشاهد أفضل الأفكار ترتقي إلى قمة خارطة طريقنا.',
  'feedback.welcome.ctaShare': 'شارك فكرة',
  'feedback.welcome.ctaBoard': 'شاهد اللوحة',
  'feedback.welcome.featsLabel': 'ما الذي يمكنك فعله',
  'feedback.welcome.feat1Title': 'شارك الأفكار',
  'feedback.welcome.feat1Body': 'العلل وطلبات الميزات والأفكار الأولية: كلها مرحّب بها.',
  'feedback.welcome.feat2Title': 'صوّت',
  'feedback.welcome.feat2Body': 'صوّت لصالح ما يهم كي نعرف ما الذي نعطيه الأولوية.',
  'feedback.welcome.feat3Title': 'تتبّع التقدّم',
  'feedback.welcome.feat3Body': 'شاهد ما هو مخطّط له وقيد التنفيذ وما تم إطلاقه.',
  'connections.header.composio': 'اربط التطبيقات التي يمكن لوكيلك التصرّف فيها.',
  'connections.header.channels': 'اربط تطبيقات الدردشة التي يعيش فيها مجتمعك.',
  'connections.header.mcp': 'أضف خوادم MCP لتوسيع أدوات وكيلك.',
  'connections.header.skills': 'ثبّت مهارات الوكيل وأدرها.',
  'connections.header.meetings': 'اربط التقاويم ودع وكيلك ينضم إلى المكالمات.',
  'connections.header.llm':
    'اضبط مزوّدي الذكاء الاصطناعي والنماذج المحلية وأداة اختبار محادثة الوكيل.',
  ...
  'notifications.welcome.feat1Body': 'القرارات والإشارات التي وسمها وكلاؤك لإنسان.',
  'notifications.welcome.feat2Title': 'نشاط الوكيل',
  'notifications.welcome.feat2Body': 'سجل مستمر لما جرى تشغيله وما أنتجه.',
  'notifications.welcome.feat3Title': 'مُصنّف حسب الفئة',
  'notifications.welcome.feat3Body': 'الرسائل والاجتماعات والتذكيرات: مُقسّمة كما تفكّر.',
  'rewards.header.desc': 'نقاطك وسلاسل حضورك وإحالاتك ومزاياك.',
  'rewards.welcome.nav': 'مرحبًا',
  'rewards.welcome.main': 'المكافآت',
  ...
  'rewards.welcome.feat1Body': 'الإجراءات اليومية والإحالات تتراكم بمرور الوقت.',
  'rewards.welcome.feat2Title': 'حافظ على سلسلتك',
  'rewards.welcome.feat2Body': 'احضر بانتظام لفتح مكافآت السلسلة.',
  'rewards.welcome.feat3Title': 'استبدل المزايا',
  'rewards.welcome.feat3Body': 'حوّل النقاط إلى قسائم ومكافآت.',
  'flows.welcome.nav': 'مرحبًا',
  'flows.welcome.main': 'سير العمل',
  ...
  'flows.welcome.feat1Title': 'صِف بالكلمات',
  'flows.welcome.feat1Body': 'قل ما تريد بلغة بسيطة؛ والمُنشئ يصوغ السير.',
  'flows.welcome.feat2Title': 'شغّل وفق جدول',
  'flows.welcome.feat2Body': 'شغّل عبر مؤقّت أو حدث أو زر: القرار لك.',
  'flows.welcome.feat3Title': 'أبقِ البشر في الحلقة',
  'flows.welcome.feat3Body': 'وافق على الخطوات الحساسة قبل أن يخرج أي شيء.',
  ...
  'conversations.assistantUi.edit.ariaLabel': 'تحرير رسالتك',
  'conversations.assistantUi.edit.discardedRepliesOne': 'الإرسال سيؤدي إلى حذف {count} رد',
  'conversations.assistantUi.edit.discardedRepliesOther': 'الإرسال سيؤدي إلى حذف {count} من الردود',
  'conversations.assistantUi.stoppedRun.reasonUserStop': 'متوقف',
  'conversations.assistantUi.stoppedRun.reasonSuperseded': 'تم استبداله برسالة أحدث',
  ...
  'conversations.backgroundTasks.titleWithCount': 'مهام الخلفية ({count})',
  'conversations.backgroundTasks.running': 'تشغيل {count}',
  'conversations.backgroundTasks.noneRunning': 'لا شيء قيد التشغيل',
  'conversations.backgroundTasks.total': 'مجموع {count}',
  'conversations.backgroundTasks.empty':
    'لا توجد مهام خلفية في هذه الدردشة. اطلب من المساعد أن يفعل شيئًا ما في الخلفية وسيظهر هنا.',
  ...
  'conversations.backgroundTasks.statusNeedsYou': 'يحتاجك',
  'conversations.backgroundTasks.statusCancelled': 'أُلغيت',
  'conversations.backgroundTasks.toolCallOne': 'استدعاء أداة {count}',
  'conversations.backgroundTasks.toolCallOther': 'استدعاءات أداة {count}',
  'conversations.backgroundTasks.steps': 'خطوات {count}',
  'conversations.backgroundTasks.viewDetails': 'عرض التفاصيل →',
  ...
  'conversations.backgroundTasks.inboxReady': '{count} جاهز',
  'conversations.backgroundTasks.inboxInFlight': '{count} قيد التنفيذ',
  'conversations.backgroundTasks.memoryJobTitle': 'مزامنة الذاكرة',
  'conversations.backgroundTasks.cancelJob': 'إلغاء',
  ...
  'nav.brain': 'الدماغ',
  'nav.flows': 'سير العمل',
  'nav.workflowRuns': 'تشغيلات سير العمل',
  'nav.workflowDiscoveries': 'اكتشاف سير العمل',

  'wallet.tabs.balance': 'رصيد المحفظة',
  'wallet.tabs.recovery': 'الاسترداد',
  'wallet.ariaLabel': 'طرق عرض المحفظة',
  ...
  'common.filter': 'تصفية',
  'skills.explorer.colSkill': 'المهارة',
  'skills.explorer.colDescription': 'الوصف',
  'skills.explorer.colProvider': 'المصدر',
  'skills.explorer.colAction': 'إجراء',
  ...
  'chat.newWindowPrompt': 'كيف يمكنني مساعدتك اليوم؟',
  'chat.welcomeSuggestion.calendarToday': 'ما هي مواعيدي اليوم؟',
  'chat.welcomeSuggestion.unreadEmail': 'لخّص رسائلي غير المقروءة.',
  'chat.welcomeSuggestion.draftReply': 'اكتب ردًا على آخر رسالة وصلتني.',
  'chat.welcomeSuggestion.followUps': 'ما الذي قلت إنني سأتابعه هذا الأسبوع؟',
  ...
  'chat.messageQueue.running': 'قيد التشغيل',
  'chat.messageQueue.queuedCount': '{count} في قائمة الانتظار',
  'chat.messageQueue.pendingHint': 'يُرسَل عند انتهاء هذا',
  'chat.messageQueue.remove': 'إزالة "{text}" من قائمة الانتظار',
  'chat.connectionState.dropped': 'انقطع الاتصال. استمر التشغيل على الخادم.',
  'chat.connectionState.reconnect': 'إعادة الاتصال',
  'chat.connectionState.reconnecting': 'جارٍ إعادة الاتصال',
  'chat.connectionState.resumed': 'تم استئناف البث.',
  ...
  'connections.tabs.browser': 'التحكم بالمتصفح',
  'connections.browser.description': 'اضبط مهام المتصفح وتحقق من الجاهزية.',
  'connections.earlyAlphaNotice':
    'ألفا مبكرة: لا يزال التحكم في المتصفح وسطح المكتب قيد الاختبار. قد تعمل الإجراءات بشكل غير متوقع أو تتغير بين الإصدارات.',
  'connections.browser.module': 'الوحدة',
  'connections.browser.chrome': 'Chrome',
  'connections.browser.unknown': 'غير معروف',
  'connections.browser.notVerified': 'لم يتم التحقق',
  'connections.browser.localOverride': 'يلزم تجاوز محلي للوحدة حتى نشر ملفات الإصدار.',
  'connections.browser.testModule': 'اختبار الوحدة',
  'connections.browser.enabled': 'تفعيل المتصفح',
  'connections.browser.headless': 'دون واجهة',
  'connections.browser.width': 'عرض النافذة',
  'connections.browser.height': 'ارتفاع النافذة',
  'connections.browser.chromePath': 'مسار Chrome (اختياري)',
  'connections.browser.profileMode': 'الملف الشخصي',
  'connections.browser.fresh': 'ملف جديد',
  'connections.browser.persistent': 'ملف دائم',
  'connections.browser.profilePath': 'مجلد الملف الشخصي',
  'connections.browser.downloadDir': 'مجلد التنزيلات',
  'connections.browser.maxSteps': 'أقصى خطوات المهمة',
  'connections.browser.timeout': 'المهلة (ثوانٍ)',
  'connections.browser.allowedWebsites': 'المواقع المسموحة',
  'connections.browser.sharedPolicy': 'يشترك المتصفح وبحث الويب في سياسة المواقع نفسها.',
  'connections.browser.manageWebsites': 'إدارة المواقع المسموحة',
  'connections.browser.jevRoute': 'مسار فوترة Jev',
  ...
  'connections.browser.chromeReady': 'Chrome جاهز',
  'connections.browser.chromeNotReady': 'Chrome غير متاح',
  'connections.browser.readinessChecked': 'تم فحص الجاهزية',
  'connections.browser.boundsRequired':
    'استخدم عرضاً بين 320–3840 وارتفاعاً بين 240–2160 وخطوات بين 1–100 ومهلة بين 5–600 ثانية.',
  'connections.browser.noneAllowed': 'لا توجد مواقع مسموحة',
  'connections.browser.moduleChecked': 'تم فحص الوحدة',
  'connections.tabs.skills': 'المهارات',
  'connections.tabs.meetings': 'الاجتماعات',
  'connections.groups.integrations': 'التكاملات',
  'connections.groups.desktop': 'سطح المكتب',
  'desktop.approvalSummary': '{operation} «{target}» في {app}',
  'desktop.action.click': 'انقر على',
  'desktop.action.type_text': 'أدخل نصًا في',
  'desktop.action.check': 'فعّل',
  'desktop.action.uncheck': 'ألغِ التفعيل',
  'desktop.action.expand': 'وسّع',
  'desktop.action.collapse': 'اطوِ',
  'desktop.action.scroll': 'مرّر',
  ...
  'desktop.moduleUnavailable': 'وحدة سطح المكتب غير متاحة. تحقق من حالتها وحاول مجددًا.',
  'desktop.pendingUnavailable':
    'تعذر تحميل موافقات سطح المكتب المعلقة. حدّث الصفحة للمحاولة مجددًا.',
  'desktop.unsupported': 'التحكم بسطح المكتب غير متاح في بيئة التشغيل هذه.',
  'desktop.localOnly': 'ينطبق هذا الإعداد على هذا الكمبيوتر فقط.',
  'desktop.permissions': 'أذونات النظام',
  'desktop.permission.accessibility': 'إمكانية الوصول',
  'desktop.permission.screen_recording': 'تسجيل الشاشة',
  'desktop.openSettings': 'فتح الإعدادات',
  'desktop.captureNote':
    'يلزم تسجيل الشاشة للقطات الشاشة فقط. وتلزم إمكانية الوصول لفحص التطبيقات والتحكم بها.',
  'desktop.testDescription': 'تحقق من قدرة النواة على رؤية التطبيقات العاملة على هذا الكمبيوتر.',
  'desktop.testButton': 'اختبار الوصول لسطح المكتب',
  'desktop.testPassed': 'يعمل الوصول لسطح المكتب.',
  'desktop.testFailed': 'تعذر التحقق من الوصول لسطح المكتب.',
  ...
  'settings.costDashboard.unknownProvider': 'لا شيء',
  ...
  'mcp.rows.showTools': 'إظهار أدوات {name}',
  'mcp.rows.hideTools': 'إخفاء أدوات {name}',
  'mcp.rows.toolsLoading': 'جارٍ قراءة الأدوات…',
  'mcp.rows.toolsFailed': 'تعذّر قراءة الأدوات.',
  'mcp.rows.add': 'إضافة خادم',
  ...
  'mcp.form.transportStdio': 'أمر محلي (stdio)',
  'mcp.form.transportHttp': 'عنوان URL بعيد (HTTP)',
  'mcp.form.command': 'الأمر',
  'mcp.form.args': 'الوسائط',
  'mcp.form.argsHint': 'مفصولة بمسافات؛ ضع الوسيطة التي تحتوي مسافات بين علامتي اقتباس.',
  'mcp.form.env': 'متغيرات البيئة',
  'mcp.form.envHint': 'تُمرَّر إلى الأمر. تُخزَّن القيم مشفّرة ولا تُعرض مجددًا.',
  ...
  'mcp.form.authNone': 'بدون',
  'mcp.form.authBearer': 'رمز Bearer',
  'mcp.form.authHeader': 'ترويسة مخصصة',
  'mcp.form.authOauth': 'تسجيل الدخول عبر المتصفح (OAuth)',
  'mcp.form.token': 'الرمز',
  'mcp.form.tokenHint': 'يُرسل كـ Authorization: Bearer <token>.',
  'mcp.form.headerName': 'اسم الترويسة',
  'mcp.form.headerValue': 'قيمة الترويسة',
  'mcp.form.oauthHint': 'بعد الحفظ يفتح متصفحك صفحة تسجيل الدخول للخادم؛ يكتمل الاتصال عند عودتك.',
  'mcp.form.add': 'إضافة الخادم',
  'mcp.form.save': 'حفظ',
  'mcp.form.saveAndSignIn': 'حفظ وتسجيل الدخول',
  'mcp.form.saving': 'جارٍ الحفظ…',
  'mcp.form.saveFailed': 'تعذّر حفظ الخادم.',
  ...
  'mcp.tab.action.openPage': 'فتح الصفحة',
  ...
  'mcp.json.saving': 'جارٍ الحفظ…',
  'mcp.json.save': 'حفظ',
  'mcp.json.revert': 'تراجع',
  ...
  'voice.providers.desc':
    'اختر محرك النسخ المستضاف الذي يحوّل كلامك، ومكان تشغيل التوليف. تحويل الكلام إلى نص يعمل دائماً في السحابة؛ التوليف وحده له خيار محلي (Piper) يُثبَّت بزر «التثبيت محلياً». لا حاجة لإعداد PIPER_BIN يدوياً.',
  'voice.providers.sttProvider': 'موفر تحويل الكلام إلى نص',
  'voice.providers.sttProviderAria': 'موفر STT',
  'voice.providers.backendSttProxy': 'السحابة (وكيل الهمس)',
  ...
  'chat.approval.expiresIn': 'تنتهي الصلاحية بعد {time}',
  'chat.elicitation.send': 'إرسال',
  'chat.elicitation.decline': 'رفض',
  'chat.elicitation.needsInput': 'يتطلب إدخالاً',
  'chat.elicitation.sentTo': 'تم الإرسال إلى {server}',
  'chat.elicitation.declined': 'مرفوض',
  'chat.elicitation.title': 'يتطلب ردك',
  ...
  'conversations.composer.context.usage': 'استخدام السياق',
  'conversations.composer.context.full': 'ممتلئ بنسبة {percent}%',
  'conversations.composer.context.reasoning': 'الاستدلال',
  'conversations.composer.context.headroom': 'المساحة المتبقية',
  'conversations.composer.context.meterLabel': 'استخدام السياق لـ {label}',
  'conversations.composer.context.meterValue': '{used} من {limit}',
  'conversations.composer.context.loading': 'جارٍ قياس السياق…',
  'conversations.composer.context.errorTitle': 'تفصيل السياق غير متاح',
  ...
  'conversations.composer.command.plan': 'التخطيط أولاً: راجع الخطوات قبل تنفيذ أي شيء',
  'conversations.composer.command.build': 'التنفيذ: دع الوكيل يتصرف مباشرة',
  'conversations.composer.trigger.back': 'رجوع',
  'conversations.composer.trigger.loading': 'جارٍ التحميل…',
  'conversations.composer.trigger.emptyCategories': 'لا توجد عناصر متاحة',
  'conversations.composer.slash.empty': 'لا توجد أوامر مطابقة',
  'conversations.composer.mention.empty': 'لا توجد عناصر مطابقة',
  'conversations.composer.mention.memory': 'الذاكرة',
  'conversations.composer.mention.files': 'الملفات',
  ...
  'conversations.planReview.revise': 'تنقيح',
  'conversations.runMode.plan': 'خطة',
  'conversations.runMode.build': 'بناء',
  'conversations.runMode.toggleLabel': 'التبديل بين وضع الخطة ووضع البناء',
  ...
  'conversations.tools.inspectDesktop.active': 'جارٍ فحص سطح المكتب',
  'conversations.tools.inspectDesktop.done': 'تم فحص سطح المكتب',
  'conversations.tools.controlDesktop.active': 'جارٍ التحكم بسطح المكتب',
  'conversations.tools.controlDesktop.done': 'تم التحكم بسطح المكتب',
  ...
  'conversations.tools.document.title': 'مستند',
  'conversations.tools.presentation.title': 'عرض تقديمي',
  ...
  'conversations.subagent.transcript.instruction': 'تعليمة',
  'conversations.subagent.transcript.agent': 'وكيل',
  'conversations.subagent.transcript.system': 'نظام',
  'conversations.tasks.taskOne': 'مهمة',
  'conversations.tasks.taskOther': 'مهام',
  'conversations.tasks.running': 'قيد التشغيل',
  'conversations.tasks.waitingForInput': 'في انتظار الإدخال',
  'conversations.tasks.done': 'منتهية',
  'conversations.tasks.failed': 'فاشلة',
  'conversations.tasks.of': 'من',
  ...
  'conversations.memoryChips.remembered': 'تم تذكر {n}',
  'conversations.memoryChips.idle': 'الذاكرة',
  'conversations.memoryChips.forgetAriaLabel': 'نسيان "{text}"',
  'conversations.scheduleCard.next': 'التالي',
  'conversations.scheduleCard.paused': 'متوقف',
  'conversations.scheduleCard.recentRuns': 'التشغيلات الأخيرة',
  'conversations.scheduleCard.ok': 'تم',
  'conversations.scheduleCard.failed': 'فشل',
  'conversations.conversationSearch.placeholder': 'بحث في المحادثة',
  'conversations.conversationSearch.previousMatch': 'التطابق السابق',
  'conversations.conversationSearch.nextMatch': 'التطابق التالي',
  'conversations.conversationSearch.timelineToggle': 'الخط الزمني',
  ...
  'flowRuns.inspector.output': 'إظهار المخرجات الخام',
  ...
  'flows.discoveries.title': 'اكتشافات سير العمل',
  'flows.discoveries.description': 'أتمتة يقترحها Flow Scout بناءً على طريقة عملك.',
  'flows.allRuns.title': 'تشغيلات سير العمل',
  'flows.allRuns.description': 'كل تشغيلات سير العمل في مساحة عملك، الأحدث أولاً.',
  'flows.allRuns.loading': 'جارٍ تحميل التشغيلات…',
  'flows.allRuns.empty': 'لا توجد تشغيلات سير عمل بعد.',
  'flows.allRuns.unknownWorkflow': 'سير عمل غير معروف',
  'flows.allRuns.status.running': 'قيد التشغيل',
  'flows.allRuns.status.completed': 'مكتمل',
  'flows.allRuns.status.completed_with_warnings': 'مكتمل مع تحذيرات',
  ...
  'flows.promptBar.placeholder': 'صف سير عملك',
  'flows.promptBar.copilotTitle': 'كوبايلوت',
  'flows.promptBar.submit': 'إنشاء',
  'flows.promptBar.startBuilding': 'ابدأ الإنشاء',
  'flows.promptBar.disclaimer': 'الكوبايلوت ذكاء اصطناعي وقد يخطئ. يُرجى التحقق من الردود.',
  ...
  'flows.copilot.tool.proposing': 'اقتراح سير العمل…',
  ...
  'flows.nodeSummary.trigger.appEvent': 'يعمل عند حدث في التطبيق',
  'flows.nodeSummary.trigger.unknownKind': 'المُشغِّل: {kind}',
  'flows.nodeSummary.agent.defaultModel': 'النموذج الافتراضي',
  'flows.nodeSummary.agent.withPrompt': '“{prompt}” · {model}',
  'flows.nodeSummary.agent.default': 'يسأل {model}',
  'flows.nodeSummary.toolCall.runsNative': 'يُشغّل {name}',
  'flows.nodeSummary.toolCall.pickNative': 'يُشغّل أداة من OpenHuman (اختر واحدة)',
  'flows.nodeSummary.toolCall.runs': 'يُشغّل {slug}',
  'flows.nodeSummary.toolCall.pick': 'يُشغّل إجراء تطبيق (اختر واحدًا)',
  'flows.nodeSummary.http.withUrl': '{method} {url}',
  'flows.nodeSummary.http.noUrl': 'طلب {method} (حدد عنوان URL)',
  'flows.nodeSummary.code.runs': 'يُشغّل كود {lang}',
  'flows.nodeSummary.condition.withField': 'إذا {field} ← صحيح / خطأ',
  'flows.nodeSummary.condition.default': 'يتفرّع إلى صحيح / خطأ',
  'flows.nodeSummary.switch.byExpr': 'يوجّه حسب {expr}',
  'flows.nodeSummary.switch.byExprWithRoutes': 'يوجّه حسب {expr} ({count} مسارات)',
  'flows.nodeSummary.switch.byValue': 'يوجّه حسب قيمة',
  'flows.nodeSummary.switch.byValueWithRoutes': 'يوجّه حسب قيمة ({count} مسارات)',
  'flows.nodeSummary.merge': 'يدمج الفروع المتوازية',
  'flows.nodeSummary.splitOut.withPath': 'يقسّم كل {path}',
  'flows.nodeSummary.splitOut.default': 'يقسّم قائمة إلى عناصر',
  'flows.nodeSummary.transform.default': 'يعيد تشكيل كل عنصر',
  'flows.nodeSummary.transform.setFieldsSingular': 'يضبط {n} حقل في كل عنصر',
  'flows.nodeSummary.transform.setFieldsPlural': 'يضبط {n} حقول في كل عنصر',
  'flows.nodeSummary.outputParser': 'يحلّل المخرجات السابقة',
  'flows.nodeSummary.subWorkflow': 'يُشغّل سير عمل متداخل',
  'flows.nodeSummary.memory.flavourWith': 'يقرأ نمط "{flavour}"',
  'flows.nodeSummary.memory.flavour': 'يقرأ نمطًا من الذاكرة',
  'flows.nodeSummary.memory.people': 'يبحث في ذاكرة الأشخاص',
  'flows.nodeSummary.memory.remember': 'يحفظ قيمة في سير العمل هذا',
  'flows.nodeSummary.memory.forget': 'ينسى قيمة من سير العمل هذا',
  'flows.nodeSummary.memory.searchScoped': 'يبحث في الذاكرة ({scope})',
  'flows.nodeSummary.memory.search': 'يبحث في الذاكرة',
  'flows.nodeSummary.memory.recallScoped': 'يسترجع من الذاكرة ({scope})',
  ...
  'flows.cron.customSchedule': 'جدولة مخصصة ({expr})',
  'flows.cron.noScheduleSet': 'لم يتم ضبط جدولة',
  'flows.cron.weekdays': 'أيام الأسبوع',
  'flows.cron.weekends': 'عطلة نهاية الأسبوع',
  'flows.cron.everyMinute': 'كل دقيقة',
  'flows.cron.everyMinuteOnDays': 'كل دقيقة في {days}',
  'flows.cron.everyNMinutes': 'كل {n} دقيقة',
  'flows.cron.everyNMinutesOnDays': 'كل {n} دقيقة في {days}',
  'flows.cron.everyHour': 'كل ساعة',
  'flows.cron.everyHourOnDays': 'كل ساعة في {days}',
  'flows.cron.everyNHours': 'كل {n} ساعة',
  'flows.cron.everyNHoursOnDays': 'كل {n} ساعة في {days}',
  'flows.cron.everyDayAtTime': 'كل يوم في {time}',
  'flows.cron.atTimeOnDays': 'في {time} في {days}',
  'flows.cron.invalidInterval': 'فاصل زمني غير صالح',
  'flows.cron.dailyEvery24h': 'يوميًا (كل 24 ساعة)',
  'flows.cron.everyNDays': 'كل {n} يوم',
  'flows.cron.everyNHoursShort': 'كل {n} س',
  'flows.cron.everyNMinutesShort': 'كل {n} د',
  'flows.cron.everySecond': 'كل ثانية',
  'flows.cron.everyNSeconds': 'كل {n} ث',
  'flows.cron.onceAtRaw': 'مرة واحدة في {at}',
  'flows.cron.onceAt': 'مرة واحدة في {at}',
  ...
  'pages.settings.account.migration': 'استيراد',
  ...
  'settings.ai.providers.groupLocal': 'بيئات محلية',
  'settings.ai.providers.groupCli': 'تسجيلات دخول CLI',
  'settings.ai.providers.cliDetail': 'يستخدم تسجيل دخول موجودًا لدى أداة CLI أخرى',
  'settings.ai.providers.connected': 'متصل',
  'settings.ai.providers.managedDetail': 'يختار OpenHuman نموذجًا لكل مهمة',
  'settings.ai.providers.rowActions': 'إجراءات أخرى لـ {provider}',
  ...
  'settings.ai.providers.placeholderCloud': 'اختر مزودًا سحابيًا…',
  'settings.ai.providers.placeholderLocal': 'اختر بيئة محلية…',
  'settings.ai.providers.placeholderCli': 'اختر تسجيل دخول CLI…',
  'settings.ai.providers.helperCloud': 'نماذج مستضافة. أنت توفر مفتاح API.',
  'settings.ai.providers.helperLocal': 'نماذج تعمل على هذا الجهاز. أنت توفر نقطة النهاية.',
  'settings.ai.providers.helperCli': 'يعيد استخدام تسجيل دخول موجود لدى أداة سطر أوامر أخرى.',
  'settings.ai.providers.categoryAllConnected': 'الكل متصل',
  'settings.ai.providers.addCustomAction': 'إضافة مزود مخصص',
  'settings.ai.providers.customDetail': 'نقطة نهاية خاصة بك متوافقة مع OpenAI',
  'settings.ai.providers.groupConnected': 'متصل',
  'settings.ai.providers.localDetail': 'يعمل على هذا الجهاز',
  ...
  'settings.ai.routing.workload.chat.hint':
    'موصى به: نموذج دردشة سريع رخيص أو متوسط ​​التكلفة مع رموز مميزة عالية/ثانية وزمن وصول منخفض. يمكن للنماذج المحلية مفتوحة المصدر أن تعمل بشكل جيد هنا إذا شعرت بالاستجابة.',
  'settings.ai.routing.workload.reasoning.label': 'Reasoning',
  'settings.ai.routing.workload.reasoning.description':
    'وكيل الدردشة الرئيسي، ملخص الاجتماع: وضع "الاستدلال" في المحادثات',
  'settings.ai.routing.workload.reasoning.hint':
    'موصى به: حدود أكثر تكلفة أو نموذج تفكير قوي للتفكير العميق. يتم استخدام هذا لوكيل الدردشة الرئيسي وملخصات الاجتماعات وتوليف الإجابات الأثقل.',
  'settings.ai.routing.workload.agentic.label': 'Agentic',
  'settings.ai.routing.workload.agentic.description':
    'مشغلو الوكيل الفرعي، وحلقات الأدوات، وقرارات GIF',
  'settings.ai.routing.workload.agentic.hint':
    'موصى به: نموذج موثوق لمتابعة التعليمات مع استخدام قوي للأداة. عادةً ما تكون النماذج الحدودية متوسطة التكلفة هي الأكثر أمانًا؛ يمكن أن تعمل النماذج مفتوحة المصدر القادرة على العمل إذا كان استدعاء الأداة مستقرًا.',
  'settings.ai.routing.workload.coding.label': 'Coding',
  'settings.ai.routing.workload.coding.description': 'يمر إنشاء التعليمات البرمجية وإعادة البناء',
  'settings.ai.routing.workload.coding.hint':
    'موصى به: نموذج تم ضبطه بالبرمجة مع اتباع تعليمات قوية، وجودة التحرير، وأداء السياق الطويل. وهذا عادة ما يستحق إنفاق المزيد عليه.',
  'settings.ai.routing.workload.vision.label': 'Vision',
  'settings.ai.routing.workload.vision.description':
    'فهم الصورة للوكيل الفرعي للرؤية: متعدد الوسائط دائمًا',
  ...
  'skills.setup.voice.sttNotReadyDesc':
    'يحتاج ذكاء الصوت إلى محرك تحويل كلام إلى نص يعمل. اختر واحداً من الإعدادات › الصوت.',
  ...
  'walletBalances.earlyAlphaNotice':
    'ألفا مبكرة: لا تزال أرصدة المحفظة قيد الاختبار. قد تتغير المبالغ والشبكات المدعومة بين الإصدارات.',
  'walletBalances.allNetworks': 'جميع الشبكات',
  'walletBalances.manageTokens': 'إدارة الرموز',
  'walletBalances.noFilterMatches': 'لا توجد أرصدة تطابق عوامل التصفية',
  'walletBalances.colToken': 'الرمز',
  ...
  'composer.settings.loadingModels': 'جارٍ تحميل النماذج…',
  ...
  'settings.ai.resetsAt': 'يُعاد الضبط في {time}',
  'settings.ai.usedAmount': 'تم استخدام {amount}',
  ...
  'settings.ai.burnRateSampleDetail': '{rows} صف/ساعة على عينة مدتها {hours} ساعة',
  'settings.ai.needTimestampsForBurnRate': 'يلزم وجود طوابع زمنية لصفّي إنفاق على الأقل.',
  'settings.ai.projectedEmptyDetail': '{hours} ساعة بعد آخر إنفاق بمعدّل الاستهلاك الأخير',
  'settings.ai.noProjectionWithoutSpend': 'لا يوجد توقّع بدون إنفاق ساعي حديث.',
  'settings.ai.readsPerDollar': '{count} قراءة/$',
  'settings.ai.apiReadsFormula':
    'قراءات واجهة برمجة التطبيقات الخلفية/أسبوعيًا / المتبقّي = {reads} / {remaining}',
  'settings.ai.needUsageToEstimate': 'تلزم استجابة الاستخدام للتقدير.',
  ...
  'settings.mcpServer.tools.runSubagent': 'يشغّل وكيلًا فرعيًا بمُوجِّه',
  'settings.mcpServer.tools.memorySearch': 'يبحث في الذاكرة باستعلام دلالي',
  'settings.mcpServer.tools.memoryRecall': 'يسترجع ذكريات محددة عبر المعرّف',
  ...
  'skills.category.all': 'الكل',
  'skills.category.builtIn': 'مدمجة',
  'skills.category.channels': 'القنوات',
  'skills.category.productivity': 'الإنتاجية',
  'skills.category.chat': 'المحادثة',
  'skills.category.toolsAutomation': 'الأدوات والأتمتة',
  'skills.category.social': 'اجتماعي',
  'skills.category.platform': 'المنصة',
  'skills.category.other': 'أخرى',
  'workspace.wipeSuccessTitle': 'تم مسح الذاكرة',
  'workspace.wipeSuccessMessage':
    'تمت إزالة {rows} صف و{dirs} مجلد؛ وتم مسح {cursors} من مؤشرات حالة المزامنة. انقر على مزامنة عند مصدر متصل لإعادة التعبئة.',
  'workspace.wipeFailedTitle': 'فشلت إعادة الضبط',
  'workspace.resetTreeSuccessTitle': 'جارٍ إعادة بناء شجرة الذاكرة',
  'workspace.resetTreeSuccessMessage':
    'تم مسح {treeRows} صف من الشجرة؛ وأعيد إدراج {chunks} مقطع في قائمة الانتظار ({jobs} من مهام الاستخراج). سيمتلئ الرسم البياني تدريجيًا مع تقدّم العامل.',
  'workspace.resetTreeFailedTitle': 'تعذّرت إعادة ضبط شجرة الذاكرة',
  'workspace.buildTreesFailedTitle': 'تعذّر إنشاء أشجار الملخصات',
