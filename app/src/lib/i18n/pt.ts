...
const messages: TranslationMap = {
  ...
  'share.modalSubtitle': 'Publique o que o seu agente fez no X ou no LinkedIn',
  'share.drafting': 'A criar o seu cartão...',
  'share.cardAlt': 'Pré-visualização do cartão de partilha',
  ...
  'share.privacyNote':
    'Apenas o título, a legenda, o nome do agente e a marca são partilhados. O seu chat, a memória e os ficheiros permanecem privados.',
  'share.defaultHeadline': 'Veja o que o meu agente OpenHuman acabou de fazer',
  'share.defaultAgentName': 'O meu agente',
  'share.defaultCaption': 'Veja o que o meu agente OpenHuman acabou de fazer.',
  'share.captionWithHeadline': '{headline}. Feito com o meu agente OpenHuman.',
  'share.linkedInHint': 'Legenda copiada. Cole-a na sua publicação do LinkedIn.',
  'share.shareX': 'Partilhar no X',
  'share.shareLinkedIn': 'Partilhar no LinkedIn',
  ...
  'brain.header.graph': 'Como o conhecimento do seu agente se conecta: pessoas, temas e memórias.',
  'brain.header.goals': 'Aquilo em que o seu agente está a trabalhar, e porquê.',
  'brain.header.sources': 'Os dados com que o seu agente aprende.',
  'brain.header.sync': 'Mantenha a sua memória atualizada e reveja o que mudou.',
  'brain.welcome.nav': 'Bem-vindo',
  'brain.welcome.eyebrow': 'Cérebro',
  'brain.welcome.title': 'A memória do seu agente, mapeada',
  'brain.welcome.body':
    'O Cérebro é onde o seu agente guarda o que sabe: as pessoas, conversas, fontes e objetivos de que se serve para o ajudar com contexto real em vez de começar do zero de cada vez.',
  'brain.welcome.ctaGraph': 'Abrir grafo de memória',
  'brain.welcome.ctaGoals': 'Definir objetivos',
  'brain.welcome.ctaSources': 'Ligar fontes',
  'brain.welcome.featsLabel': 'O que vive aqui',
  'brain.welcome.feat1Title': 'Grafo de memória',
  'brain.welcome.feat1Body': 'Veja num relance como pessoas, temas e mensagens se conectam.',
  ...
  'feedback.welcome.main': 'Quadro de comentários',
  'feedback.welcome.eyebrow': 'Comentários',
  'feedback.welcome.title': 'Ajude a moldar o que construímos',
  'feedback.welcome.body':
    'Diga-nos o que funciona, o que falta e o que tornaria o OpenHuman melhor. Publique uma ideia, vote nas sugestões dos outros e veja as melhores subirem ao topo do nosso roteiro.',
  'feedback.welcome.ctaShare': 'Partilhar uma ideia',
  ...
  'feedback.welcome.feat3Body': 'Veja o que está planeado, em curso e concluído.',
  'connections.header.composio': 'Ligue as aplicações em que o seu agente pode agir.',
  'connections.header.channels': 'Ligue as aplicações de chat onde a sua comunidade vive.',
  ...
  'connections.welcome.body':
    'Ligue as suas aplicações de mensagens, email, calendário e ferramentas para que o seu agente possa ler o contexto e agir em todas elas, sem copiar e colar entre uma dúzia de separadores. Você mantém o controlo daquilo em que ele pode tocar.',
  'connections.welcome.ctaChannel': 'Ligar um canal',
  'connections.welcome.ctaApps': 'Ligar aplicações',
  'connections.welcome.ctaSkills': 'Explorar competências',
  'connections.welcome.featsLabel': 'O que pode fazer aqui',
  'connections.welcome.feat1Title': 'Traga os canais',
  'connections.welcome.feat1Body':
    'Slack, WhatsApp, Telegram, Gmail e mais: ligados em poucos cliques.',
  'connections.welcome.feat2Title': 'Deixe o seu agente agir',
  'connections.welcome.feat2Body':
    'Ele lê, redige e responde com todo o contexto de tudo o que está ligado.',
  'connections.welcome.feat3Title': 'Mantenha o controlo',
  'connections.welcome.feat3Body':
    'Conceda ou revogue o acesso por canal, a qualquer momento. Nada corre sem a sua palavra.',
  'alerts.header.desc': 'Atividade do agente e tudo o que precisa da sua atenção.',
  'notifications.welcome.nav': 'Bem-vindo',
  'notifications.welcome.main': 'Alertas',
  'notifications.welcome.eyebrow': 'Notificações',
  'notifications.welcome.title': 'Apenas o que realmente precisa de si',
  'notifications.welcome.body':
    'Um resumo calmo e classificado do que os seus agentes fizeram e do que precisa de uma decisão, para que o importante venha à tona e o ruído fique fora do seu caminho.',
  ...
  'rewards.welcome.title': 'Seja recompensado por aparecer',
  'rewards.welcome.body':
    'Ganhe pontos à medida que usa o OpenHuman e convida outros, mantenha a sua sequência viva e resgate o que ganhou, tudo registado num só lugar.',
  'rewards.welcome.ctaView': 'Ver recompensas',
  'rewards.welcome.featsLabel': 'Como funciona',
  'rewards.welcome.feat1Title': 'Ganhe pontos',
  'rewards.welcome.feat1Body': 'Ações do dia a dia e indicações somam-se ao longo do tempo.',
  'rewards.welcome.feat2Title': 'Mantenha a sequência',
  'rewards.welcome.feat2Body': 'Apareça regularmente para desbloquear bónus de sequência.',
  'rewards.welcome.feat3Title': 'Resgate vantagens',
  'rewards.welcome.feat3Body': 'Transforme pontos em cupões e recompensas.',
  'flows.welcome.nav': 'Bem-vindo',
  'flows.welcome.main': 'Fluxos de trabalho',
  ...
  'flows.welcome.feat1Title': 'Descreva por palavras',
  'flows.welcome.feat1Body': 'Diga o que quer em linguagem simples; o construtor redige o fluxo.',
  'flows.welcome.feat2Title': 'Execute num horário',
  'flows.welcome.feat2Body': 'Dispare por temporizador, por evento ou por um botão: você decide.',
  'flows.welcome.feat3Title': 'Mantenha os humanos no circuito',
  'flows.welcome.feat3Body': 'Aprove passos sensíveis antes de qualquer coisa sair.',
  ...
  'conversations.backgroundTasks.titleWithCount': 'Tarefas em segundo plano ({count})',
  'conversations.backgroundTasks.running': '{count} em execução',
  'conversations.backgroundTasks.noneRunning': 'nenhum correndo',
  'conversations.backgroundTasks.total': 'Total {count}',
  'conversations.backgroundTasks.empty':
    'Não há tarefas em segundo plano neste chat. Peça ao assistente para fazer algo em segundo plano e isso aparecerá aqui.',
  ...
  'conversations.backgroundTasks.statusNeedsYou': 'Precisa de você',
  'conversations.backgroundTasks.statusCancelled': 'Cancelado',
  'conversations.backgroundTasks.toolCallOne': 'Chamada de ferramenta {count}',
  'conversations.backgroundTasks.toolCallOther': 'Chamadas de ferramenta {count}',
  'conversations.backgroundTasks.steps': 'Etapas {count}',
  'conversations.backgroundTasks.viewDetails': 'Ver detalhes →',
  ...
  'conversations.backgroundTasks.inboxReady': '{count} concluídas',
  'conversations.backgroundTasks.inboxInFlight': '{count} em andamento',
  'conversations.backgroundTasks.memoryJobTitle': 'Sincronização de memória',
  'conversations.backgroundTasks.cancelJob': 'Cancelar',
  ...
  'nav.discord': 'Entrar no nosso Discord',
  ...
  'nav.workflowRuns': 'Execuções de fluxos',
  'nav.workflowDiscoveries': 'Descobrir fluxos',

  'wallet.tabs.balance': 'Saldo da carteira',
  'wallet.tabs.recovery': 'Recuperação',
  'wallet.ariaLabel': 'Visualizações da carteira',
  ...
  'brain.refreshError':
    'Não foi possível atualizar seu cérebro. Exibindo os últimos dados carregados.',
  ...
  'skills.explorer.colSkill': 'Habilidade',
  'skills.explorer.colDescription': 'Descrição',
  'skills.explorer.colProvider': 'Fornecedor',
  'skills.explorer.colAction': 'Ação',
  ...
  'sync.nowSyncing.title': 'Sincronizando agora',
  'sync.nowSyncing.empty': 'Nada está sendo sincronizado agora.',
  'common.error': 'Erro',
  ...
  'chat.connectionState.dropped': 'Conexão perdida. A execução continuou no servidor.',
  'chat.connectionState.reconnect': 'Reconectar',
  'chat.connectionState.reconnecting': 'Reconectando',
  'chat.connectionState.resumed': 'A transmissão foi retomada.',
  ...
  'chat.reasoning.thoughtFor': 'Pensou por {n}',
  'chat.reasoning.thoughtBriefly': 'Pensou brevemente',
  ...
  'skills.explorer.sourceFilterAria': 'Filtrar por origem',
  ...
  'skills.rows.remove': 'Remover {name}',
  ...
  'connections.tabs.browser': 'Controle do navegador',
  'connections.browser.description': 'Configure tarefas do navegador e verifique o estado.',
  'connections.earlyAlphaNotice':
    'Alfa inicial: o controle do navegador e da área de trabalho ainda está em teste. As ações podem se comportar de forma inesperada ou mudar entre versões.',
  'connections.browser.module': 'Módulo',
  'connections.browser.chrome': 'Chrome',
  'connections.browser.unknown': 'Desconhecido',
  'connections.browser.notVerified': 'Não verificado',
  'connections.browser.localOverride':
    'É necessário um módulo local até a publicação dos arquivos.',
  'connections.browser.testModule': 'Testar módulo',
  'connections.browser.enabled': 'Ativar navegador',
  'connections.browser.headless': 'Sem interface',
  'connections.browser.width': 'Largura da janela',
  'connections.browser.height': 'Altura da janela',
  'connections.browser.chromePath': 'Caminho do Chrome (opcional)',
  'connections.browser.profileMode': 'Perfil',
  'connections.browser.fresh': 'Perfil novo',
  'connections.browser.persistent': 'Perfil persistente',
  'connections.browser.profilePath': 'Pasta do perfil',
  'connections.browser.downloadDir': 'Pasta de downloads',
  'connections.browser.maxSteps': 'Máximo de etapas',
  'connections.browser.timeout': 'Tempo limite (segundos)',
  'connections.browser.allowedWebsites': 'Sites permitidos',
  'connections.browser.sharedPolicy':
    'O navegador e a busca web compartilham a mesma política de sites.',
  'connections.browser.manageWebsites': 'Gerenciar sites permitidos',
  'connections.browser.jevRoute': 'Cobrança Jev',
  ...
  'connections.browser.chromeNotReady': 'Chrome indisponível',
  'connections.browser.readinessChecked': 'Estado verificado',
  'connections.browser.boundsRequired':
    'Use largura 320–3840, altura 240–2160, etapas 1–100 e tempo limite de 5–600 segundos.',
  'connections.browser.noneAllowed': 'Nenhum site permitido',
  'connections.browser.moduleChecked': 'Módulo verificado',
  'connections.tabs.skills': 'Habilidades',
  'connections.tabs.meetings': 'Reuniões',
  'connections.groups.integrations': 'Integrações',
  'connections.groups.desktop': 'Área de trabalho',
  'desktop.approvalSummary': '{operation} “{target}” em {app}',
  'desktop.action.click': 'Clique em',
  'desktop.action.type_text': 'Digite texto em',
  'desktop.action.check': 'Marque',
  'desktop.action.uncheck': 'Desmarque',
  ...
  'desktop.enabledPending':
    'Ativado. Conclua a configuração abaixo antes de usar as ferramentas do computador.',
  'desktop.moduleUnavailable':
    'O módulo de desktop está indisponível. Verifique o estado e tente novamente.',
  'desktop.pendingUnavailable':
    'Não foi possível carregar as aprovações de desktop pendentes. Atualize para tentar novamente.',
  'desktop.unsupported': 'O controle do computador não está disponível neste ambiente.',
  'desktop.localOnly': 'Esta configuração vale apenas para este computador.',
  'desktop.permissions': 'Permissões do sistema',
  'desktop.permission.accessibility': 'Acessibilidade',
  'desktop.permission.screen_recording': 'Gravação de tela',
  'desktop.openSettings': 'Abrir configurações',
  'desktop.captureNote':
    'A gravação de tela só é necessária para capturas. A acessibilidade é necessária para inspecionar e controlar aplicativos.',
  'desktop.testDescription':
    'Verifique se o núcleo consegue ver os aplicativos em execução neste computador.',
  'desktop.testButton': 'Testar acesso ao computador',
  'desktop.testPassed': 'O acesso ao computador funciona.',
  'desktop.testFailed': 'Não foi possível verificar o acesso ao computador.',
  ...
  'memoryTree.status.jobQueue':
    'Tarefas de memória: {ready} aguardando, {running} em execução, {failed} com falha',
  ...
  'settings.about.starCta.title': 'Gostando do OpenHuman?',
  'settings.about.starCta.body': 'Dê uma estrela no GitHub. Assim mais pessoas nos encontram.',
  'settings.about.starCta.star': 'Marcar com estrela no GitHub',
  'settings.about.starCta.dismiss': 'Agora não',
  ...
  'settings.costDashboard.unknownProvider': 'Nenhum',
  ...
  'mcp.rows.showTools': 'Mostrar as ferramentas de {name}',
  'mcp.rows.hideTools': 'Ocultar as ferramentas de {name}',
  'mcp.rows.toolsLoading': 'Lendo as ferramentas…',
  'mcp.rows.toolsFailed': 'Não foi possível ler as ferramentas.',
  'mcp.rows.add': 'Adicionar servidor',
  'mcp.rows.edit': 'Editar {name}',
  'mcp.form.addTitle': 'Adicionar servidor MCP',
  'mcp.form.editTitle': 'Editar {name}',
  'mcp.form.subtitle':
    'Um comando local ou um endpoint remoto, com o que ele precisa para autenticar. Gravado no seu mcp.json.',
  'mcp.form.name': 'Nome',
  'mcp.form.nameHint': 'Letras, dígitos, pontos, hífens. Esta é a chave em mcp.json.',
  'mcp.form.transport': 'Transporte',
  'mcp.form.transportStdio': 'Comando local (stdio)',
  'mcp.form.transportHttp': 'URL remota (HTTP)',
  'mcp.form.command': 'Comando',
  'mcp.form.args': 'Argumentos',
  'mcp.form.argsHint':
    'Separados por espaço; coloque entre aspas um argumento que contenha espaços.',
  'mcp.form.env': 'Variáveis de ambiente',
  'mcp.form.envHint':
    'Passadas ao comando. Os valores são armazenados criptografados e nunca mais exibidos.',
  ...
  'mcp.form.authNone': 'Nenhuma',
  'mcp.form.authBearer': 'Token Bearer',
  'mcp.form.authHeader': 'Cabeçalho personalizado',
  'mcp.form.authOauth': 'Entrar com o navegador (OAuth)',
  'mcp.form.token': 'Token',
  'mcp.form.tokenHint': 'Enviado como Authorization: Bearer <token>.',
  'mcp.form.headerName': 'Nome do cabeçalho',
  'mcp.form.headerValue': 'Valor do cabeçalho',
  'mcp.form.oauthHint':
    'Após salvar, seu navegador abre a página de login do servidor; a conexão é concluída quando você voltar.',
  'mcp.form.add': 'Adicionar servidor',
  'mcp.form.save': 'Salvar',
  'mcp.form.saveAndSignIn': 'Salvar e entrar',
  'mcp.form.saving': 'Salvando…',
  'mcp.form.saveFailed': 'Não foi possível salvar o servidor.',
  'mcp.rows.title': 'Servidores instalados',
  'mcp.rows.intro':
    'Os servidores MCP que seu agente pode usar, conforme declarados em mcp.json. Abra um servidor para ver suas credenciais e ferramentas.',
  'mcp.rows.open': 'Abrir {name}',
  'mcp.rows.connect': 'Conectar {name}',
  'mcp.rows.disconnect': 'Desconectar {name}',
  'mcp.rows.enable': 'Ativar {name}',
  'mcp.rows.disable': 'Desativar {name}',
  'mcp.rows.remove': 'Remover {name}',
  'mcp.rows.removeTitle': 'Remover {name}?',
  'mcp.rows.removeBody':
    'O servidor e suas credenciais armazenadas são removidos. Declará-lo novamente em mcp.json começa do zero.',
  'mcp.rows.opFailed': 'A ação falhou.',
  'mcp.json.invalidTitle': 'Este arquivo ainda não pode ser salvo',
  'mcp.json.unsaved': 'Alterações não salvas',
  'mcp.registry.title': 'Diretório MCP',
  'mcp.tab.section.servers': 'Servidores',
  'mcp.tab.section.json': 'mcp.json',
  'mcp.tab.section.registry': 'Registro',
  'mcp.tab.back': 'Voltar aos servidores',
  'mcp.tab.action.openPage': 'Abrir página',
  ...
  'mcp.json.credentialsNote':
    'As credenciais são somente de escrita: os valores de env e headers são armazenados ao salvar e nunca mais exibidos. Uma entrada salva sem eles mantém o que está armazenado; defina uma chave como "" para removê-la.',
  'mcp.json.editorAria': 'Documento mcp.json',
  'mcp.json.refusedTitle': 'O núcleo recusou este documento',
  'mcp.json.saved': 'Salvo: {added} adicionados, {updated} atualizados, {removed} removidos.',
  'mcp.json.saving': 'Salvando…',
  'mcp.json.save': 'Salvar',
  'mcp.json.revert': 'Reverter',
  ...
  'mcp.json.parseError.needsUrlOrCommand':
    '`{name}` precisa de uma `url` (hospedado) ou de um `command` (executado localmente).',
  'mcp.json.parseError.bothUrlAndCommand':
    '`{name}` indica tanto `url` quanto `command`; um servidor é acessado de uma só forma.',
  ...
  'mnemonic.importAnExistingWallet': 'Importar uma carteira existente',
  'mnemonic.createANewWallet': 'Criar uma nova carteira',
  'mnemonic.importWallet': 'Importar carteira',
  ...
  'voice.mode.stop': 'Encerrar chat de voz',
  'voice.mode.connecting': 'Conectando…',
  'voice.mode.listening': 'Ouvindo',
  'voice.mode.speaking': 'Falando',
  'voice.providers.title': 'Provedores de voz',
  'voice.providers.desc':
    'Escolha qual motor hospedado transcreve sua fala e onde a síntese é executada. O reconhecimento de fala sempre roda na nuvem; só a síntese tem opção local (Piper), instalada pelo botão Instalar localmente. Não é necessário configurar PIPER_BIN manualmente.',
  'voice.providers.sttProvider': 'Provedor de fala para texto',
  'voice.providers.sttProviderAria': 'Provedor STT',
  'voice.providers.backendSttProxy': 'Nuvem (proxy Whisper)',
  ...
  'notifications.routing.level.reactDesc': 'Média prioridade: aciona uma resposta focada do agente',
  'notifications.routing.level.escalate': 'Escalar',
  'notifications.routing.level.escalateDesc': 'Alta prioridade: encaminhada ao agente orquestrador',
  ...
  'memorySources.stage.fetching': 'Buscando',
  'memorySources.stage.stored': 'Salvando',
  'memorySources.stage.queued': 'Processando na memória',
  'memorySources.stage.ingesting': 'Processando na memória',
  ...
  'composio.colApp': 'Aplicativo',
  'composio.colStatus': 'Status',
  'composio.colAccounts': 'Contas',
  ...
  'chat.approval.expiresIn': 'Expira em {time}',
  'chat.elicitation.send': 'Enviar',
  'chat.elicitation.decline': 'Recusar',
  'chat.elicitation.needsInput': 'precisa de informações',
  'chat.elicitation.sentTo': 'Enviado para {server}',
  'chat.elicitation.declined': 'Recusado',
  'chat.elicitation.title': 'Precisa da sua resposta',
  ...
  'conversations.composer.context.usage': 'Uso do contexto',
  'conversations.composer.context.full': '{percent}% cheio',
  'conversations.composer.context.reasoning': 'Raciocínio',
  'conversations.composer.context.headroom': 'Espaço livre',
  'conversations.composer.context.meterLabel': 'Uso do contexto: {label}',
  ...
  'conversations.composer.trigger.emptyCategories': 'Nenhum item disponível',
  'conversations.composer.slash.empty': 'Nenhum comando correspondente',
  'conversations.composer.mention.empty': 'Nenhum item correspondente',
  'conversations.composer.mention.memory': 'Memória',
  'conversations.composer.mention.files': 'Arquivos',
  ...
  'conversations.planReview.revise': 'Revisar',
  'conversations.runMode.plan': 'Plano',
  'conversations.runMode.build': 'Build',
  'conversations.runMode.toggleLabel': 'Alternar entre o modo de plano e o modo de build',
  ...
  'conversations.tools.parallelAgentsAggregating': 'Agregando resultados',
  ...
  'conversations.tools.inspectDesktop.active': 'Inspecionando a área de trabalho',
  'conversations.tools.inspectDesktop.done': 'Área de trabalho inspecionada',
  'conversations.tools.controlDesktop.active': 'Controlando a área de trabalho',
  'conversations.tools.controlDesktop.done': 'Área de trabalho controlada',
  ...
  'conversations.tools.presentation.title': 'Apresentação',
  ...
  'conversations.subagent.transcript.instruction': 'instrução',
  'conversations.subagent.transcript.agent': 'agente',
  'conversations.subagent.transcript.system': 'sistema',
  'conversations.tasks.taskOne': 'tarefa',
  'conversations.tasks.taskOther': 'tarefas',
  'conversations.tasks.running': 'em execução',
  'conversations.tasks.waitingForInput': 'aguardando resposta',
  'conversations.tasks.done': 'concluída',
  'conversations.tasks.failed': 'falhou',
  'conversations.tasks.of': 'de',
  ...
  'conversations.agentTaskInsights.memoryCitationFallbackTitle': 'Memória',
  'conversations.memoryChips.remembered': '{n} lembrado(s)',
  'conversations.memoryChips.idle': 'memória',
  'conversations.memoryChips.forgetAriaLabel': 'Esquecer "{text}"',
  'conversations.scheduleCard.next': 'próximo',
  'conversations.scheduleCard.paused': 'pausado',
  'conversations.scheduleCard.recentRuns': 'execuções recentes',
  'conversations.scheduleCard.ok': 'ok',
  'conversations.scheduleCard.failed': 'falhou',
  'conversations.conversationSearch.placeholder': 'Localizar na conversa',
  'conversations.conversationSearch.previousMatch': 'Correspondência anterior',
  'conversations.conversationSearch.nextMatch': 'Próxima correspondência',
  'conversations.conversationSearch.timelineToggle': 'Linha do tempo',
  ...
  'flowRuns.inspector.output': 'Mostrar saída bruta',
  'flowRuns.inspector.summary.failedPrefix': 'Não foi possível concluir:',
  'flowRuns.inspector.summary.unknownError': 'algo deu errado',
  'flowRuns.inspector.summary.itemsFetched': '{count} item(ns) obtido(s)',
  'flowRuns.inspector.summary.completed': 'Etapa concluída',
  'flowRuns.inspector.summary.noOutput': 'Nenhuma saída produzida',
  ...
  'flows.discoveries.title': 'Descobertas de fluxos',
  'flows.discoveries.description':
    'Automações que o Flow Scout sugere, com base em como você trabalha.',
  'flows.allRuns.title': 'Execuções de fluxos',
  'flows.allRuns.description': 'Cada execução de fluxo no seu espaço, as mais recentes primeiro.',
  'flows.allRuns.loading': 'Carregando execuções…',
  'flows.allRuns.empty': 'Ainda não há execuções de fluxos.',
  'flows.allRuns.unknownWorkflow': 'Fluxo desconhecido',
  'flows.allRuns.status.running': 'Em execução',
  'flows.allRuns.status.completed': 'Concluído',
  'flows.allRuns.status.completed_with_warnings': 'Concluído com avisos',
  ...
  'flows.promptBar.placeholder': 'Descreva seu fluxo de trabalho',
  'flows.promptBar.copilotTitle': 'Copiloto',
  'flows.promptBar.submit': 'Criar',
  'flows.promptBar.startBuilding': 'Começar a criar',
  'flows.promptBar.disclaimer': 'O Copiloto usa IA e pode cometer erros. Confira as respostas.',
  ...
  'flows.copilot.tool.proposing': 'Propondo fluxo de trabalho…',
  ...
  'flows.canvas.description': 'Crie esta automação passo a passo e depois salve e execute.',
  ...
  'flows.nodeSummary.trigger.appEvent': 'Executa a partir de um evento de app',
  'flows.nodeSummary.trigger.unknownKind': 'Gatilho: {kind}',
  'flows.nodeSummary.agent.defaultModel': 'modelo padrão',
  'flows.nodeSummary.agent.withPrompt': '“{prompt}” · {model}',
  'flows.nodeSummary.agent.default': 'Consulta o {model}',
  'flows.nodeSummary.toolCall.runsNative': 'Executa {name}',
  'flows.nodeSummary.toolCall.pickNative': 'Executa uma ferramenta do OpenHuman (escolha uma)',
  'flows.nodeSummary.toolCall.runs': 'Executa {slug}',
  'flows.nodeSummary.toolCall.pick': 'Executa uma ação de app (escolha uma)',
  'flows.nodeSummary.http.withUrl': '{method} {url}',
  'flows.nodeSummary.http.noUrl': 'Solicitação {method} (defina uma URL)',
  'flows.nodeSummary.code.runs': 'Executa código {lang}',
  'flows.nodeSummary.condition.withField': 'Se {field} → verdadeiro / falso',
  'flows.nodeSummary.condition.default': 'Bifurca em verdadeiro / falso',
  'flows.nodeSummary.switch.byExpr': 'Roteia por {expr}',
  'flows.nodeSummary.switch.byExprWithRoutes': 'Roteia por {expr} ({count} rotas)',
  'flows.nodeSummary.switch.byValue': 'Roteia por um valor',
  'flows.nodeSummary.switch.byValueWithRoutes': 'Roteia por um valor ({count} rotas)',
  'flows.nodeSummary.merge': 'Mescla ramificações paralelas',
  'flows.nodeSummary.splitOut.withPath': 'Divide cada {path}',
  'flows.nodeSummary.splitOut.default': 'Divide uma lista em itens',
  'flows.nodeSummary.transform.default': 'Reestrutura cada item',
  'flows.nodeSummary.transform.setFieldsSingular': 'Define {n} campo em cada item',
  'flows.nodeSummary.transform.setFieldsPlural': 'Define {n} campos em cada item',
  'flows.nodeSummary.outputParser': 'Analisa a saída anterior',
  'flows.nodeSummary.subWorkflow': 'Executa um fluxo de trabalho aninhado',
  'flows.nodeSummary.memory.flavourWith': 'Lê o estilo "{flavour}"',
  'flows.nodeSummary.memory.flavour': 'Lê um estilo de memória',
  'flows.nodeSummary.memory.people': 'Consulta a memória de pessoas',
  'flows.nodeSummary.memory.remember': 'Salva um valor neste fluxo de trabalho',
  'flows.nodeSummary.memory.forget': 'Esquece um valor deste fluxo de trabalho',
  'flows.nodeSummary.memory.searchScoped': 'Pesquisa na memória ({scope})',
  'flows.nodeSummary.memory.search': 'Pesquisa na memória',
  'flows.nodeSummary.memory.recallScoped': 'Recupera da memória ({scope})',
  ...
  'flows.cron.customSchedule': 'Agendamento personalizado ({expr})',
  'flows.cron.noScheduleSet': 'Nenhum agendamento definido',
  'flows.cron.weekdays': 'dias úteis',
  'flows.cron.weekends': 'fins de semana',
  'flows.cron.everyMinute': 'A cada minuto',
  'flows.cron.everyMinuteOnDays': 'A cada minuto nos dias {days}',
  'flows.cron.everyNMinutes': 'A cada {n} minutos',
  'flows.cron.everyNMinutesOnDays': 'A cada {n} minutos nos dias {days}',
  'flows.cron.everyHour': 'A cada hora',
  'flows.cron.everyHourOnDays': 'A cada hora nos dias {days}',
  'flows.cron.everyNHours': 'A cada {n} horas',
  'flows.cron.everyNHoursOnDays': 'A cada {n} horas nos dias {days}',
  'flows.cron.everyDayAtTime': 'Todos os dias às {time}',
  'flows.cron.atTimeOnDays': 'Às {time} nos dias {days}',
  'flows.cron.invalidInterval': 'Intervalo inválido',
  'flows.cron.dailyEvery24h': 'Diário (a cada 24 h)',
  'flows.cron.everyNDays': 'A cada {n} dias',
  'flows.cron.everyNHoursShort': 'A cada {n} h',
  'flows.cron.everyNMinutesShort': 'A cada {n} min',
  'flows.cron.everySecond': 'A cada segundo',
  'flows.cron.everyNSeconds': 'A cada {n} s',
  'flows.cron.onceAtRaw': 'Uma vez em {at}',
  'flows.cron.onceAt': 'Uma vez em {at}',
  ...
  'settings.ai.providers.groupCloud': 'Nuvem',
  'settings.ai.providers.groupLocal': 'Ambientes locais',
  'settings.ai.providers.groupCli': 'Logins de CLI',
  'settings.ai.providers.cliDetail': 'Usa um login que outra CLI já possui',
  'settings.ai.providers.connected': 'Conectado',
  'settings.ai.providers.managedDetail': 'O OpenHuman escolhe um modelo para cada tarefa',
  'settings.ai.providers.rowActions': 'Mais ações para {provider}',
  ...
  'settings.ai.providers.addProviderSubtitle':
    'Escolha um provedor para conectar. Você pode adicionar mais quando quiser.',
  'settings.ai.providers.placeholderCloud': 'Escolha um provedor na nuvem…',
  ...
  'settings.ai.providers.localDetail': 'Executa neste dispositivo',
  ...
  'settings.ai.routing.defaultModel': 'Modelo padrão',
  'settings.ai.routing.defaultModelDesc':
    'O modelo em que um turno de chat gerenciado é executado. As cargas de trabalho abaixo que permanecem gerenciadas o usam.',
  'settings.ai.routing.defaultModelUnset': 'Não definido',
  ...
  'settings.ai.routing.workload.chat.hint':
    'Recomendado: um modelo de chat rápido barato ou de custo médio com altos tokens/s e baixa latência. Modelos locais de código aberto podem funcionar bem aqui se forem responsivos.',
  'settings.ai.routing.workload.reasoning.label': 'Reasoning',
  'settings.ai.routing.workload.reasoning.description':
    'Agente principal do chat, resumidor da reunião: modo “Raciocínio” em Conversas',
  'settings.ai.routing.workload.reasoning.hint':
    'Recomendado: uma fronteira mais cara ou um modelo de raciocínio forte para pensamento profundo. Isso é usado para o agente de chat principal, resumos de reuniões e síntese de respostas mais pesadas.',
  'settings.ai.routing.workload.agentic.label': 'Agentic',
  'settings.ai.routing.workload.agentic.description':
    'Executores de subagentes, loops de ferramentas, decisões GIF',
  'settings.ai.routing.workload.agentic.hint':
    'Recomendado: um modelo confiável de seguimento de instruções com forte uso de ferramentas. Os modelos fronteiriços de custo médio são geralmente mais seguros; modelos de código aberto capazes podem funcionar se a chamada de ferramenta for estável.',
  'settings.ai.routing.workload.coding.label': 'Coding',
  'settings.ai.routing.workload.coding.description': 'Geração de código e refatorações',
  'settings.ai.routing.workload.coding.hint':
    'Recomendado: um modelo ajustado para codificação com forte acompanhamento de instruções, qualidade de edição e desempenho em contexto longo. Geralmente vale a pena gastar mais nisso.',
  'settings.ai.routing.workload.vision.label': 'Vision',
  'settings.ai.routing.workload.vision.description':
    'Compreensão da imagem para o subagente da visão: sempre multimodal',
  ...
  'settings.composio.invalidApiKey': 'A chave de API do Composio é inválida.',
  ...
  'settings.mascot.customGifError':
    'Insira uma URL de imagem HTTPS, file:// ou local (PNG, GIF, JPEG, WebP ou BMP), ou envie um arquivo.',
  'settings.mascot.customGifHeading': 'Avatar de imagem personalizado',
  'settings.mascot.customGifLabel': 'URL do avatar de imagem personalizado',
  'settings.mascot.customGifPlaceholder': 'https://example.com/avatar.png',
  'settings.mascot.customGifUpload': 'Enviar imagem',
  'settings.mascot.customGifInvalidType':
    'Tipo de arquivo não suportado. Envie uma imagem PNG, GIF, JPEG, WebP ou BMP.',
  'settings.mascot.customGifTooLarge': 'A imagem é muito grande. Envie um arquivo de até 1,5 MB.',
  'settings.mascot.customGifReadError': 'Não foi possível ler essa imagem. Tente outro arquivo.',
  ...
  'settings.persona.appearanceDesc':
    'A cor do mascote, o avatar de imagem personalizado e a voz de resposta são configurados nas configurações do mascote.',
  ...
  'skills.setup.voice.sttNotReadyDesc':
    'A Inteligência de Voz precisa de um motor de fala para texto funcionando. Escolha um em Configurações › Voz.',
  ...
  'walletBalances.earlyAlphaNotice':
    'Alfa inicial: os saldos da carteira ainda estão em teste. Os valores e as redes compatíveis podem mudar entre versões.',
  'walletBalances.allNetworks': 'Todas as redes',
  'walletBalances.manageTokens': 'Gerenciar tokens',
  'walletBalances.noFilterMatches': 'Nenhum saldo corresponde aos filtros',
  'walletBalances.colToken': 'Token',
  'walletBalances.colNetwork': 'Rede',
  'walletBalances.colAddress': 'Endereço',
  'walletBalances.colBalance': 'Saldo',
  'walletBalances.colActions': 'Ações',
  ...
  'composer.settings.loadingModels': 'Carregando modelos…',
  ...
  'settings.ai.picker.title': 'Escolher provedor e modelo',
  'settings.ai.picker.subtitle':
    'Pesquise entre os provedores configurados e os modelos disponíveis.',
  'settings.ai.picker.useThisModel': 'Usar este modelo',
  'settings.ai.picker.searchPlaceholder': 'Pesquisar modelos',
  ...
  'settings.ai.loops.composioSync.work':
    'Consulta as ferramentas conectadas quando uma sincronização com o provedor está pendente.',
  'settings.ai.loops.composioSync.risk':
    '{count} ativações/semana; verifica {active} conexão(ões) ativa(s).',
  'common.notAvailable': 'n/a',
  'settings.ai.resetsAt': 'reinicia em {time}',
  ...
  'settings.ai.burnRateSampleDetail': '{rows} linhas/h em uma amostra de {hours}h',
  'settings.ai.needTimestampsForBurnRate':
    'São necessários registros de horário de pelo menos duas linhas de gasto.',
  'settings.ai.projectedEmptyDetail': '{hours}h após o último gasto no ritmo de consumo recente',
  'settings.ai.noProjectionWithoutSpend': 'Sem projeção sem gasto horário recente.',
  'settings.ai.readsPerDollar': '{count} leituras/$',
  'settings.ai.apiReadsFormula':
    'leituras de API em segundo plano/semana / restante = {reads} / {remaining}',
  'settings.ai.needUsageToEstimate': 'É necessária a resposta de uso para estimar.',
  ...
  'settings.mcpServer.tools.runSubagent': 'Executa um subagente com um prompt',
  'settings.mcpServer.tools.memorySearch': 'Pesquisa a memória por consulta semântica',
  'settings.mcpServer.tools.memoryRecall': 'Recupera memórias específicas por ID',
  'settings.mcpServer.tools.treeReadChunk': 'Lê um bloco da árvore de memória',
  ...
  'skills.category.channels': 'Canais',
  'skills.category.productivity': 'Produtividade',
  'skills.category.chat': 'Chat',
  'skills.category.toolsAutomation': 'Ferramentas e automação',
  'skills.category.social': 'Social',
  'skills.category.platform': 'Plataforma',
  'skills.category.other': 'Outras',
  'workspace.wipeSuccessTitle': 'Memória apagada',
  'workspace.wipeSuccessMessage':
    'Removida(s) {rows} linha(s) e {dirs} pasta(s); {cursors} cursor(es) de estado de sincronização limpo(s). Clique em Sincronizar em uma fonte conectada para repopular.',
  'workspace.wipeFailedTitle': 'Falha ao redefinir',
  'workspace.resetTreeSuccessTitle': 'Reconstruindo a árvore de memória',
  'workspace.resetTreeSuccessMessage':
    'Removida(s) {treeRows} linha(s) da árvore; {chunks} bloco(s) recolocado(s) na fila ({jobs} tarefas de extração). O grafo será preenchido conforme o worker avança.',
  'workspace.resetTreeFailedTitle': 'Não foi possível redefinir a árvore de memória',
  'workspace.buildTreesFailedTitle': 'Não foi possível gerar as árvores de resumo',
  'invites.redeemHeading': 'Tem um código de indicação?',
  'invites.redeemPlaceholder': 'Código de indicação',
  'invites.redeemSubmit': 'Resgatar',
};
