...
const messages: TranslationMap = {
  ...
  'conversations.chatError.guardrail.title': 'Esta solicitud no pasó una verificación de seguridad',
  'conversations.chatError.guardrail.explanationFallback':
    'Una política bloqueó esta respuesta antes de que se enviara.',
  ...
  'conversations.backgroundTasks.inboxReady': '{count} listas',
  'conversations.backgroundTasks.inboxInFlight': '{count} en curso',
  'conversations.backgroundTasks.memoryJobTitle': 'Sincronización de memoria',
  ...
  'chat.welcomeSuggestion.calendarToday': '¿Qué tengo hoy en el calendario?',
  'chat.welcomeSuggestion.unreadEmail': 'Resume mis correos sin leer.',
  'chat.welcomeSuggestion.draftReply': 'Redacta una respuesta a mi último mensaje.',
  'chat.welcomeSuggestion.followUps': '¿Qué dije que haría de seguimiento esta semana?',
  'chat.welcomeSuggestion.connectIntegration': 'Conecta una nueva integración.',
  ...
  'chat.connectionState.dropped': 'Se perdió la conexión. La ejecución siguió en el servidor.',
  'chat.connectionState.reconnect': 'Reconectar',
  'chat.connectionState.reconnecting': 'Reconectando',
  'chat.connectionState.resumed': 'Se retomó la transmisión.',
  ...
  'chat.reasoning.thoughtFor': 'Pensó durante {n}',
  'chat.reasoning.thoughtBriefly': 'Pensó brevemente',
  ...
  'skills.rows.installedTitle': 'Skills instalados',
  'skills.rows.installedIntro':
    'Los skills que tu agente puede ejecutar en esta máquina. Abre uno para ver sus detalles; ejecútalo, edítalo o elimínalo desde su fila.',
  'skills.rows.registryTitle': 'Registro de skills',
  'skills.rows.registryIntro':
    'Catálogos de skills que puedes instalar. Busca e instala uno en tus skills de usuario.',
  'skills.rows.open': 'Abrir {name}',
  'skills.rows.run': 'Ejecutar {name}',
  'skills.rows.edit': 'Editar {name}',
  'skills.rows.remove': 'Eliminar {name}',
  ...
  'connections.browser.notVerified': 'Sin verificar',
  'connections.browser.localOverride':
    'Se necesita un módulo local hasta que se publiquen los archivos de lanzamiento.',
  'connections.browser.testModule': 'Probar módulo',
  'connections.browser.enabled': 'Activar navegador',
  'connections.browser.headless': 'Sin interfaz',
  'connections.browser.width': 'Ancho de pantalla',
  'connections.browser.height': 'Alto de pantalla',
  'connections.browser.chromePath': 'Ruta de Chrome (opcional)',
  'connections.browser.profileMode': 'Perfil',
  'connections.browser.fresh': 'Perfil nuevo',
  'connections.browser.persistent': 'Perfil persistente',
  'connections.browser.profilePath': 'Carpeta del perfil',
  'connections.browser.downloadDir': 'Carpeta de descargas',
  'connections.browser.maxSteps': 'Máximo de pasos',
  'connections.browser.timeout': 'Tiempo límite (segundos)',
  'connections.browser.allowedWebsites': 'Sitios permitidos',
  'connections.browser.sharedPolicy':
    'El navegador y la búsqueda web comparten la misma política de sitios.',
  'connections.browser.manageWebsites': 'Administrar sitios permitidos',
  'connections.browser.jevRoute': 'Ruta de facturación Jev',
  'connections.browser.routeDirect': 'OpenRouter directo',
  'connections.browser.routeHosted': 'Proxy alojado',
  'connections.browser.testInConversation':
    'Prueba una página en una conversación después de guardar.',
  'connections.browser.save': 'Guardar ajustes',
  'connections.browser.saved': 'Ajustes guardados',
  'connections.browser.testBrowser': 'Probar Chrome',
  'connections.browser.chromeReady': 'Chrome listo',
  'connections.browser.chromeNotReady': 'Chrome no disponible',
  'connections.browser.readinessChecked': 'Estado comprobado',
  'connections.browser.boundsRequired':
    'Usa ancho 320–3840, alto 240–2160, pasos 1–100 y tiempo límite 5–600 segundos.',
  'connections.browser.noneAllowed': 'No hay sitios permitidos',
  'connections.browser.moduleChecked': 'Módulo comprobado',
  ...
  'desktop.approvalSummary': '{operation} «{target}» en {app}',
  'desktop.action.click': 'Haz clic en',
  'desktop.action.type_text': 'Escribe en',
  'desktop.action.check': 'Marca',
  'desktop.action.uncheck': 'Desmarca',
  ...
  'desktop.enabledPending':
    'Activado. Completa la configuración siguiente antes de usar las herramientas de escritorio.',
  'desktop.moduleUnavailable':
    'El módulo de escritorio no está disponible. Revisa su estado y vuelve a intentarlo.',
  'desktop.pendingUnavailable':
    'No se pudieron cargar las aprobaciones pendientes del escritorio. Actualiza para reintentarlo.',
  'desktop.unsupported': 'El control del escritorio no está disponible en este entorno.',
  'desktop.localOnly': 'Este ajuste solo se aplica a este equipo.',
  'desktop.permissions': 'Permisos del sistema',
  'desktop.permission.accessibility': 'Accesibilidad',
  'desktop.permission.screen_recording': 'Grabación de pantalla',
  'desktop.openSettings': 'Abrir ajustes',
  'desktop.captureNote':
    'La grabación de pantalla solo se necesita para las capturas. La accesibilidad permite inspeccionar y controlar aplicaciones.',
  'desktop.testDescription':
    'Comprueba que el núcleo pueda ver las aplicaciones abiertas en este equipo.',
  'desktop.testButton': 'Probar acceso al escritorio',
  'desktop.testPassed': 'El acceso al escritorio funciona.',
  'desktop.testFailed': 'No se pudo verificar el acceso al escritorio.',
  ...
  'settings.costDashboard.monthToDate': 'Mes hasta la fecha',
  'settings.costDashboard.period': 'Período',
  'settings.costDashboard.periodDays': 'Últimos {days} días',
  'settings.costDashboard.all': 'Todos',
  'settings.costDashboard.costSource': 'Origen del costo',
  'settings.costDashboard.estimated': 'Estimado',
  'settings.costDashboard.providerCharged': 'Cobrado por el proveedor',
  'settings.costDashboard.searchModelSession': 'Modelo o sesión',
  'settings.costDashboard.filteredTotal': '{shown} de {loaded} registros cargados • {cost}',
  ...
  'settings.costDashboard.subtitle':
    'Uso local por llamada al proveedor. Los costos pueden ser estimados; la facturación es independiente.',
  ...
  'mcp.rows.showTools': 'Mostrar las herramientas de {name}',
  'mcp.rows.hideTools': 'Ocultar las herramientas de {name}',
  'mcp.rows.toolsLoading': 'Leyendo las herramientas…',
  'mcp.rows.toolsFailed': 'No se pudieron leer las herramientas.',
  'mcp.rows.add': 'Añadir servidor',
  ...
  'mcp.form.authNone': 'Ninguna',
  'mcp.form.authBearer': 'Token Bearer',
  'mcp.form.authHeader': 'Cabecera personalizada',
  'mcp.form.authOauth': 'Iniciar sesión con el navegador (OAuth)',
  ...
  'mcp.form.saving': 'Guardando…',
  'mcp.form.saveFailed': 'No se pudo guardar el servidor.',
  ...
  'mcp.json.saving': 'Guardando…',
  'mcp.json.save': 'Guardar',
  'mcp.json.revert': 'Revertir',
  ...
  'chat.approval.expiresIn': 'Caduca en {time}',
  'chat.elicitation.send': 'Enviar',
  'chat.elicitation.decline': 'Rechazar',
  'chat.elicitation.needsInput': 'necesita información',
  'chat.elicitation.sentTo': 'Enviado a {server}',
  'chat.elicitation.declined': 'Rechazado',
  'chat.elicitation.title': 'Necesita tu respuesta',
  ...
  'composio.connect.cancelNotConfirmed':
    'Composio no confirmó que la conexión se haya eliminado. Inténtalo de nuevo.',
  ...
  'conversations.composer.context.usage': 'Uso del contexto',
  'conversations.composer.context.full': '{percent} % lleno',
  'conversations.composer.context.reasoning': 'Razonamiento',
  'conversations.composer.context.headroom': 'Espacio libre',
  'conversations.composer.context.meterLabel': 'Uso del contexto: {label}',
  'conversations.composer.context.meterValue': '{used} de {limit}',
  'conversations.composer.context.loading': 'Midiendo el contexto…',
  'conversations.composer.context.errorTitle': 'Desglose del contexto no disponible',
  'conversations.composer.context.errorDetail': 'El núcleo no pudo medir el prompt de este hilo.',
  'conversations.composer.context.section.preamble': 'Prompt del sistema',
  'conversations.composer.context.section.tools': 'Herramientas',
  'conversations.composer.context.section.toolSchemas': 'Esquemas de herramientas',
  'conversations.composer.context.section.yourInput': 'Tu entrada',
  'conversations.composer.context.section.history': 'Historial de la conversación',
  ...
  'conversations.composer.command.new': 'Iniciar una conversación nueva',
  'conversations.composer.command.stop': 'Detener la respuesta en curso',
  'conversations.composer.command.plan':
    'Planificar primero: revisa los pasos antes de ejecutar nada',
  'conversations.composer.command.build': 'Construir: deja que el agente actúe directamente',
  'conversations.composer.trigger.back': 'Atrás',
  'conversations.composer.trigger.loading': 'Cargando…',
  'conversations.composer.trigger.emptyCategories': 'No hay elementos disponibles',
  'conversations.composer.slash.empty': 'No hay comandos que coincidan',
  'conversations.composer.mention.empty': 'No hay elementos que coincidan',
  'conversations.composer.mention.memory': 'Memoria',
  'conversations.composer.mention.files': 'Archivos',
  ...
  'conversations.runMode.build': 'Compilación',
  'conversations.runMode.toggleLabel': 'Cambiar entre el modo de plan y compilación',
  ...
  'conversations.tools.inspectDesktop.active': 'Inspeccionando el escritorio',
  'conversations.tools.inspectDesktop.done': 'Escritorio inspeccionado',
  'conversations.tools.controlDesktop.active': 'Controlando el escritorio',
  'conversations.tools.controlDesktop.done': 'Escritorio controlado',
  ...
  'conversations.tools.presentation.title': 'Presentación',
  ...
  'conversations.subagent.transcript.instruction': 'instrucción',
  'conversations.subagent.transcript.agent': 'agente',
  'conversations.subagent.transcript.system': 'sistema',
  'conversations.tasks.taskOne': 'tarea',
  'conversations.tasks.taskOther': 'tareas',
  'conversations.tasks.running': 'en curso',
  'conversations.tasks.waitingForInput': 'esperando entrada',
  'conversations.tasks.done': 'completada',
  'conversations.tasks.failed': 'fallida',
  ...
  'conversations.memoryChips.remembered': '{n} recordado(s)',
  'conversations.memoryChips.idle': 'memoria',
  'conversations.memoryChips.forgetAriaLabel': 'Olvidar "{text}"',
  'conversations.scheduleCard.next': 'siguiente',
  'conversations.scheduleCard.paused': 'pausado',
  'conversations.scheduleCard.recentRuns': 'ejecuciones recientes',
  'conversations.scheduleCard.ok': 'correcto',
  'conversations.scheduleCard.failed': 'fallido',
  'conversations.conversationSearch.placeholder': 'Buscar en la conversación',
  'conversations.conversationSearch.previousMatch': 'Coincidencia anterior',
  'conversations.conversationSearch.nextMatch': 'Siguiente coincidencia',
  'conversations.conversationSearch.timelineToggle': 'Cronología',
  ...
  'flows.nodeConfig.agent.modelManagedTiers': 'Roles de carga de trabajo',
  ...
  'composer.settings.loadingModels': 'Cargando modelos…',
