...
const messages: TranslationMap = {
  ...
  'conversations.toolFailure.notFound.cause': 'Was diese Aktion angefordert hat, existiert nicht oder ist hier nicht verfügbar.',
  'conversations.toolFailure.notFound.next': 'Du musst nichts tun. Der Assistent kann den richtigen Namen suchen und es erneut versuchen.',
  'conversations.toolFailure.unsupported.cause': 'OpenHuman kann das noch nicht automatisch erledigen.',
  'conversations.toolFailure.unsupported.next': 'Erledige es manuell oder bitte um eine andere Option.',
  ...
  'mcp.connectAuth.findToken': 'Wo erhalte ich das Token?',
  ...
  'intelligence.tasks.threadPrefix': 'Gewinde {thread}',
