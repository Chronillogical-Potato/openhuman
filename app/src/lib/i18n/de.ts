...
const messages: TranslationMap = {
  ...
  'conversations.toolFailure.notFound.cause':
    'Das angeforderte Element existiert nicht oder ist hier nicht verfügbar.',
  'conversations.toolFailure.notFound.next':
    'Du musst nichts tun. Der Assistent kann den richtigen Namen suchen und es erneut versuchen.',
  'conversations.toolFailure.unsupported.cause':
    'OpenHuman kann das noch nicht automatisch erledigen.',
  'conversations.toolFailure.unsupported.next':
    'Erledige es manuell oder bitte um eine andere Option.',
  'conversations.backgroundTasks.title': 'Hintergrundaufgaben',
  ...
  'feedback.loadError': 'Feedback konnte nicht geladen werden',
  'feedback.expand': 'Mehr anzeigen',
  'feedback.collapse': 'Weniger anzeigen',
  'feedback.comments': 'Kommentare',
  'feedback.viewIssue': 'Issue ansehen',
  ...
  'feedback.sort.hot': 'Angesagt',
  'feedback.sort.top': 'Top',
  'feedback.sort.new': 'Neu',
  'feedback.filter.allTypes': 'Alle Typen',
  'feedback.filter.allStatuses': 'Alle Status',
  'feedback.vote.up': 'Hochstimmen',
  'feedback.vote.down': 'Runterstimmen',
  'feedback.submit.heading': 'Feedback teilen',
  'feedback.submit.subheading':
    'Schlage eine Funktion vor oder melde einen Bug. Andere können darüber abstimmen.',
  'feedback.submit.titlePlaceholder': 'Titel',
  'feedback.submit.bodyPlaceholder':
    'Beschreibe deine Idee oder das Problem, auf das du gestoßen bist',
  'feedback.submit.action': 'Absenden',
  'feedback.submit.success': 'Danke! Dein Feedback steht jetzt auf dem Board.',
  'feedback.submit.rejected': 'Dein Feedback konnte nicht veröffentlicht werden.',
  'feedback.submit.error': 'Etwas ist schiefgelaufen. Bitte versuche es erneut.',
  'feedback.admin.status': 'Status',
  'feedback.admin.updateFailed': 'Status konnte nicht aktualisiert werden',
  'feedback.comments.empty': 'Noch keine Kommentare.',
  'feedback.comments.placeholder': 'Kommentar hinzufügen',
  'feedback.comments.post': 'Senden',
  'feedback.comments.loadError': 'Kommentare konnten nicht geladen werden',
  'feedback.comments.postError': 'Kommentar konnte nicht gesendet werden',
  'feedback.comments.you': 'Du',
  'conversations.backgroundTasks.titleWithCount': 'Hintergrundaufgaben ({count})',
  'conversations.backgroundTasks.running': '{count} läuft',
  'conversations.backgroundTasks.noneRunning': 'keiner läuft',
  'conversations.backgroundTasks.total': '{count} insgesamt',
  'conversations.backgroundTasks.empty':
    'In diesem Chat gibt es keine Hintergrundaufgaben. Bitten Sie den Assistenten, etwas im Hintergrund zu tun, und es wird hier angezeigt.',
  ...
  'conversations.backgroundTasks.statusNeedsYou': 'Braucht dich',
  'conversations.backgroundTasks.statusCancelled': 'Abgebrochen',
  'conversations.backgroundTasks.toolCallOne': 'Werkzeugaufruf {count}',
  'conversations.backgroundTasks.toolCallOther': '{count} Toolaufrufe',
  'conversations.backgroundTasks.steps': '{count} Schritte',
  'conversations.backgroundTasks.viewDetails': 'Details anzeigen →',
  ...
  'conversations.backgroundTasks.inboxReady': '{count} fertig',
  'conversations.backgroundTasks.inboxInFlight': '{count} laufend',
  'conversations.backgroundTasks.memoryJobTitle': 'Speichersynchronisierung',
  'conversations.backgroundTasks.cancelJob': 'Abbrechen',
  ...
  'nav.discord': 'Unserem Discord beitreten',
  ...
  'settings.tokenUsage.attributedTo': 'Kosten kalkuliert für {model}',
  'settings.tokenUsage.tokensSaved': 'Eingesparte Tokens',
  'settings.tokenUsage.costSaved': 'Eingesparte Kosten',
  'settings.tokenUsage.cacheOccupancy': 'Zwischengespeicherte Originale',
  'settings.tokenUsage.compactions': 'Komprimierungen',
  'settings.tokenUsage.overEvents': 'über {count} Komprimierungen',
  'settings.tokenUsage.byCompressor': 'Nach Kompressor',
  ...
  'home.statusHostedStopped':
    'Die Cloud-Verbindung wurde beendet: Melde dich erneut an, um Integrationen und Kanäle wieder zu aktivieren. Der Chat funktioniert weiter.',
  ...
  'chat.connectionState.dropped': 'Verbindung verloren. Der Lauf ging auf dem Server weiter.',
  'chat.connectionState.reconnect': 'Neu verbinden',
  'chat.connectionState.reconnecting': 'Verbindung wird wiederhergestellt',
  'chat.connectionState.resumed': 'Der Stream läuft wieder.',
  ...
  'chat.reasoning.thinking': 'Denkt nach',
  'chat.reasoning.thoughtFor': '{n} lang nachgedacht',
  'chat.reasoning.thoughtBriefly': 'Kurz nachgedacht',
  'chat.reasoning.thought': 'Nachgedacht',
  ...
  'skills.rows.remove': '{name} entfernen',
  ...
  'connections.browser.notVerified': 'Nicht geprüft',
  'connections.browser.localOverride':
    'Bis zur Veröffentlichung ist ein lokales Modul erforderlich.',
  'connections.browser.testModule': 'Modul testen',
  'connections.browser.enabled': 'Browser aktivieren',
  'connections.browser.headless': 'Ohne Oberfläche',
  'connections.browser.width': 'Fensterbreite',
  'connections.browser.height': 'Fensterhöhe',
  'connections.browser.chromePath': 'Chrome-Pfad (optional)',
  'connections.browser.profileMode': 'Profil',
  'connections.browser.fresh': 'Neues Profil',
  'connections.browser.persistent': 'Dauerhaftes Profil',
  'connections.browser.profilePath': 'Profilordner',
  'connections.browser.downloadDir': 'Downloadordner',
  'connections.browser.maxSteps': 'Maximale Schritte',
  'connections.browser.timeout': 'Zeitlimit (Sekunden)',
  'connections.browser.allowedWebsites': 'Erlaubte Websites',
  'connections.browser.sharedPolicy': 'Browser und Websuche verwenden dieselbe Website-Regel.',
  'connections.browser.manageWebsites': 'Erlaubte Websites verwalten',
  'connections.browser.jevRoute': 'Jev-Abrechnung',
  ...
  'connections.browser.chromeReady': 'Chrome bereit',
  'connections.browser.chromeNotReady': 'Chrome nicht verfügbar',
  'connections.browser.readinessChecked': 'Bereitschaft geprüft',
  'connections.browser.boundsRequired':
    'Breite 320–3840, Höhe 240–2160, Schritte 1–100 und Zeitlimit 5–600 Sekunden verwenden.',
  'connections.browser.noneAllowed': 'Keine Websites erlaubt',
  'connections.browser.moduleChecked': 'Modul geprüft',
  ...
  'desktop.approvalSummary': '{operation} „{target}“ in {app}',
  'desktop.action.click': 'Klicke auf',
  'desktop.action.type_text': 'Befülle',
  ...
  'desktop.enabledPending':
    'Aktiviert. Schließe die Einrichtung unten ab, bevor du Desktopwerkzeuge verwendest.',
  'desktop.moduleUnavailable':
    'Das Desktopmodul ist nicht verfügbar. Prüfe seinen Status und versuche es erneut.',
  'desktop.pendingUnavailable':
    'Ausstehende Desktopfreigaben konnten nicht geladen werden. Aktualisiere die Seite und versuche es erneut.',
  'desktop.unsupported': 'Die Desktopsteuerung ist in dieser Laufzeit nicht verfügbar.',
  'desktop.localOnly': 'Diese Einstellung gilt nur für diesen Computer.',
  'desktop.permissions': 'Systemberechtigungen',
  'desktop.permission.accessibility': 'Bedienungshilfen',
  'desktop.permission.screen_recording': 'Bildschirmaufnahme',
  'desktop.openSettings': 'Einstellungen öffnen',
  'desktop.captureNote':
    'Die Bildschirmaufnahme wird nur für Screenshots benötigt. Bedienungshilfen sind zum Prüfen und Steuern von Apps erforderlich.',
  'desktop.testDescription':
    'Prüfe, ob der Core die laufenden Apps auf diesem Computer sehen kann.',
  'desktop.testButton': 'Desktopzugriff testen',
  'desktop.testPassed': 'Der Desktopzugriff funktioniert.',
  'desktop.testFailed': 'Der Desktopzugriff konnte nicht überprüft werden.',
  ...
  'memory.tab.workflowsDescription':
    'Wiederverwendbare, ausführbare Abläufe: ein Ziel und die Schritte dorthin. Erstellen, über eine URL installieren oder einen Workflow öffnen und ausführen.',
  ...
  'memoryTimeline.title': 'Erinnerungszeitleiste',
  'memoryTimeline.intro':
    'Wann der Assistent über Sie gelernt hat: Fakten gruppiert nach dem Monat der letzten Verstärkung. Zeigt Wachstum, Aktivitätsschübe und ruhige Phasen.',
  'memoryTimeline.loading': 'Zeitleiste wird erstellt…',
  'memoryTimeline.errorPrefix': 'Diagramm konnte nicht geladen werden:',
  'memoryTimeline.retry': 'Retry',
  'memoryTimeline.namespaceLabel': 'Namespace',
  'memoryTimeline.namespaceAll': 'Alle Namensräume',
  'memoryTimeline.empty': 'Noch kein Wissensgraph.',
  'memoryTimeline.emptyHint':
    'Wenn der Assistent Fakten über Sie aufzeichnet, wird die Zeitleiste hier angezeigt.',
  'memoryTimeline.metricTotal': 'Facts',
  'memoryTimeline.metricMonths': 'Aktive Monate',
  'memoryTimeline.metricRecent': 'Letzte 30 Tage',
  'memoryTimeline.heading': 'Pro Monat gelernte Fakten',
  'memoryTimeline.busiestCaption': 'Am aktivsten: {period} ({count})',
  'memoryTimeline.undatedNote': '{count} Fakt(en) ohne aufgezeichnetes Datum.',
  'memoryTimeline.truncated': 'Die {shown} neuesten von {total} Monaten werden angezeigt.',
  ...
  'entityAssociations.empty': 'Noch keine Assoziationen.',
  'entityAssociations.emptyHint':
    'Wenn Entitäten Verbindungen teilen, werden die stärksten Paare hier angezeigt.',
  'entityAssociations.namespaceLabel': 'Namespace',
  'entityAssociations.namespaceAll': 'Alle Namensräume',
  'entityAssociations.metricEntities': 'Entities',
  'entityAssociations.metricPairs': 'Associations',
  'entityAssociations.rankedHeading': 'Stärkste Assoziationen',
  'entityAssociations.linkedBadge': 'linked',
  'entityAssociations.inferredBadge': 'inferred',
  'entityAssociations.linkedTitle': 'Diese Entitäten sind direkt verbunden.',
  ...
  'memoryFreshness.intro':
    'Fakten, die der Assistent nicht kürzlich bestätigt hat, verblassen entlang einer Vergessenskurve. Dies zeigt, was veraltet und überprüfenswert ist, damit alte Fakten nicht als gesichert gelten.',
  'memoryFreshness.loading': 'Frische wird berechnet…',
  'memoryFreshness.errorPrefix': 'Diagramm konnte nicht geladen werden:',
  'memoryFreshness.retry': 'Retry',
  'memoryFreshness.empty': 'Noch kein Wissensgraph.',
  'memoryFreshness.emptyHint':
    'Wenn der Assistent Fakten über Sie aufzeichnet, wird deren Frische hier verfolgt.',
  'memoryFreshness.namespaceLabel': 'Namespace',
  'memoryFreshness.namespaceAll': 'Alle Namensräume',
  'memoryFreshness.metricFresh': 'Fresh',
  'memoryFreshness.metricFading': 'Fading',
  'memoryFreshness.metricStale': 'Stale',
  'memoryFreshness.recallCaption': 'Durchschnittlicher Recall {recall} % über {total} Fakten',
  'memoryFreshness.queueHeading': 'Bestätigungswarteschlange',
  'memoryFreshness.queueTruncated': '{shown} von {total} angezeigt: diese zuerst bearbeiten.',
  'memoryFreshness.allFresh': 'Alle Fakten sind noch frisch: nichts zu bestätigen.',
  'memoryFreshness.statusFading': 'fading',
  'memoryFreshness.statusStale': 'stale',
  'memoryFreshness.ageLabel': '{days} Tage alt',
  'memoryFreshness.recallTitle': '{recall} % Recall · Halbwertszeit {halfLife} Tage',
  ...
  'onboarding.runtimeChoice.cloud.creditHighlight': 'Kostenlose Credits bei der Registrierung',
  ...
  'settings.costDashboard.unknownProvider': 'Keine',
  ...
  'mcp.tab.tablistAria': 'MCP-Ansichten',
  'mcp.rows.showTools': 'Werkzeuge von {name} anzeigen',
  'mcp.rows.hideTools': 'Werkzeuge von {name} ausblenden',
  'mcp.rows.toolsLoading': 'Werkzeuge werden gelesen…',
  'mcp.rows.toolsFailed': 'Die Werkzeuge konnten nicht gelesen werden.',
  'mcp.rows.add': 'Server hinzufügen',
  ...
  'mcp.form.authNone': 'Keine',
  'mcp.form.authBearer': 'Bearer-Token',
  'mcp.form.authHeader': 'Eigener Header',
  'mcp.form.authOauth': 'Im Browser anmelden (OAuth)',
  ...
  'mcp.form.saving': 'Wird gespeichert…',
  'mcp.form.saveFailed': 'Der Server konnte nicht gespeichert werden.',
  'mcp.rows.title': 'Installierte Server',
  'mcp.rows.intro':
    'Die MCP-Server, die dein Agent aufrufen kann, wie in mcp.json deklariert. Öffne einen Server für seine Zugangsdaten und Werkzeuge.',
  'mcp.rows.open': '{name} öffnen',
  'mcp.rows.connect': '{name} verbinden',
  'mcp.rows.disconnect': '{name} trennen',
  'mcp.rows.enable': '{name} aktivieren',
  'mcp.rows.disable': '{name} deaktivieren',
  'mcp.rows.remove': '{name} entfernen',
  'mcp.rows.removeTitle': '{name} entfernen?',
  'mcp.rows.removeBody':
    'Der Server und seine gespeicherten Zugangsdaten werden entfernt. Eine erneute Deklaration in mcp.json beginnt von vorn.',
  'mcp.rows.opFailed': 'Die Aktion ist fehlgeschlagen.',
  'mcp.json.invalidTitle': 'Diese Datei kann noch nicht gespeichert werden',
  'mcp.json.unsaved': 'Ungespeicherte Änderungen',
  'mcp.registry.title': 'MCP-Verzeichnis',
  'mcp.tab.section.servers': 'Server',
  'mcp.tab.section.json': 'mcp.json',
  'mcp.tab.section.registry': 'Verzeichnis',
  'mcp.tab.back': 'Zurück zu den Servern',
  'mcp.tab.action.openPage': 'Seite öffnen',
  ...
  'mcp.json.credentialsNote':
    'Zugangsdaten sind nur schreibbar: env- und headers-Werte werden beim Speichern gespeichert und nie wieder angezeigt. Ein Eintrag ohne sie behält das Gespeicherte; setze einen Schlüssel auf "", um ihn zu entfernen.',
  'mcp.json.editorAria': 'mcp.json-Dokument',
  'mcp.json.refusedTitle': 'Der Kern hat dieses Dokument abgelehnt',
  'mcp.json.saved': 'Gespeichert: {added} hinzugefügt, {updated} aktualisiert, {removed} entfernt.',
  'mcp.json.saving': 'Wird gespeichert…',
  'mcp.json.save': 'Speichern',
  'mcp.json.revert': 'Verwerfen',
  ...
  'mcp.json.parseError.needsUrlOrCommand':
    '`{name}` braucht eine `url` (gehostet) oder ein `command` (lokal ausgeführt).',
  'mcp.json.parseError.bothUrlAndCommand':
    '`{name}` nennt sowohl `url` als auch `command`; ein Server wird auf eine Weise angesprochen.',
  ...
  'mcp.connectAuth.tokenProvider': 'Token beziehen von:',
  ...
  'voice.providers.desc':
    'Wähle, welche gehostete Engine deine Sprache transkribiert und wo die Synthese läuft. Spracherkennung läuft immer in der Cloud; nur für die Sprachausgabe gibt es eine lokale Option (Piper), die du über „Lokal installieren“ einrichtest. Keine manuelle PIPER_BIN-Konfiguration nötig.',
  'voice.providers.sttProvider': 'Speech-to-Text-Anbieter',
  'voice.providers.sttProviderAria': 'STT-Anbieter',
  'voice.providers.backendSttProxy': 'Cloud (Whisper-Proxy)',
  ...
  'mic.retryingTranscription': 'Erneuter Versuch… ({attempt} von {max})',
  ...
  'app.openhumanLink.billing.trialCredit': 'Registrierungs-Credits',
  'app.openhumanLink.billing.trialDesc':
    'Credit-Angebote können je nach Aktion und Kontoberechtigung variieren.',
  ...
  'conversations.composer.context.usage': 'Kontextnutzung',
  'conversations.composer.context.full': '{percent} % belegt',
  'conversations.composer.context.reasoning': 'Schlussfolgerung',
  'conversations.composer.context.headroom': 'Freier Platz',
  'conversations.composer.context.meterLabel': 'Kontextnutzung: {label}',
  ...
  'conversations.composer.context.section.yourInput': 'Deine Eingabe',
  ...
  'conversations.composer.command.stop': 'Laufende Antwort stoppen',
  'conversations.composer.command.plan':
    'Erst planen: Schritte prüfen, bevor etwas ausgeführt wird',
  'conversations.composer.command.build': 'Umsetzen: den Agenten direkt handeln lassen',
  'conversations.composer.trigger.back': 'Zurück',
  'conversations.composer.trigger.loading': 'Wird geladen…',
  'conversations.composer.trigger.emptyCategories': 'Keine Einträge verfügbar',
  'conversations.composer.slash.empty': 'Keine passenden Befehle',
  'conversations.composer.mention.empty': 'Keine passenden Einträge',
  'conversations.composer.mention.memory': 'Gedächtnis',
  'conversations.composer.mention.files': 'Dateien',
  ...
  'conversations.planReview.feedbackPlaceholder': 'Beschreiben Sie, was geändert werden soll…',
  'conversations.planReview.sendFeedback': 'Feedback senden',
  'conversations.planReview.revise': 'Überarbeiten',
  'conversations.runMode.plan': 'Plan',
  'conversations.runMode.build': 'Build',
  'conversations.runMode.toggleLabel': 'Zwischen Plan- und Build-Modus wechseln',
  ...
  'conversations.tools.parallelAgentsAggregating': 'Ergebnisse werden zusammengeführt',
  ...
  'conversations.tools.inspectDesktop.active': 'Desktop wird geprüft',
  'conversations.tools.inspectDesktop.done': 'Desktop wurde geprüft',
  'conversations.tools.controlDesktop.active': 'Desktop wird gesteuert',
  'conversations.tools.controlDesktop.done': 'Desktop wurde gesteuert',
  ...
  'conversations.tools.presentation.title': 'Präsentation',
  ...
  'conversations.subagent.transcript.instruction': 'Anweisung',
  'conversations.subagent.transcript.agent': 'Agent',
  'conversations.subagent.transcript.system': 'System',
  'conversations.tasks.taskOne': 'Aufgabe',
  'conversations.tasks.taskOther': 'Aufgaben',
  'conversations.tasks.running': 'läuft',
  'conversations.tasks.waitingForInput': 'wartet auf Eingabe',
  'conversations.tasks.done': 'erledigt',
  'conversations.tasks.failed': 'fehlgeschlagen',
  'conversations.tasks.of': 'von',
  ...
  'conversations.agentTaskInsights.memoryCitationFallbackTitle': 'Erinnerung',
  'conversations.memoryChips.remembered': '{n} gemerkt',
  'conversations.memoryChips.idle': 'Gedächtnis',
  'conversations.memoryChips.forgetAriaLabel': '"{text}" vergessen',
  'conversations.scheduleCard.next': 'nächster',
  'conversations.scheduleCard.paused': 'pausiert',
  ...
  'intelligence.teams.empty': 'Noch keine Agententeams',
  'intelligence.teams.emptyHint':
    'Teams erscheinen hier, wenn ein Agent koordinierte Unteragenten erzeugt, die ein gemeinsames Ziel verfolgen.',
  'intelligence.teams.refresh': 'Aktualisieren',
  'intelligence.teams.backToList': 'Alle Teams',
  'intelligence.teams.status.active': 'Aktiv',
  'intelligence.teams.status.closed': 'Geschlossen',
  'intelligence.teams.header.lead': 'Leitung',
  'intelligence.teams.header.taskCount': '{count} Aufgaben',
  'intelligence.teams.header.memberCount': '{count} Mitglieder',
  'intelligence.teams.member.active': 'Aktiv',
  'intelligence.teams.member.pending': 'Ausstehend',
  'intelligence.teams.member.idle': 'Inaktiv',
  'intelligence.teams.member.stopped': 'Gestoppt',
  'intelligence.teams.column.todo': 'Zu tun',
  'intelligence.teams.column.ready': 'Bereit',
  'intelligence.teams.column.inProgress': 'In Bearbeitung',
  'intelligence.teams.column.blocked': 'Blockiert',
  'intelligence.teams.column.done': 'Fertig',
  'intelligence.teams.emptyColumn': 'Leer',
  'intelligence.teams.unclaimed': 'Nicht zugewiesen',
  'intelligence.teams.pickedUpBy': 'Übernommen von {name}',
  'intelligence.teams.depLockTitle': '{count} nicht erfüllte Abhängigkeiten',
  'intelligence.teams.gate.pending': 'Prüfung ausstehend',
  'intelligence.teams.gate.passed': 'Prüfung bestanden',
  'intelligence.teams.gate.failed': 'Prüfung fehlgeschlagen',
  'intelligence.teams.gate.label': 'Prüfung: {status}',
  'intelligence.teams.activity.title': 'Teamaktivität',
  'intelligence.teams.activity.empty': 'Noch keine Nachrichten',
  'intelligence.teams.activity.toTeam': 'Team',
  'intelligence.teams.member.start': 'Starten',
  'intelligence.teams.composer.placeholder': 'Einem Teammitglied schreiben…',
  'intelligence.teams.composer.send': 'Senden',
  'intelligence.teams.composer.recipient': 'Empfänger',
  'intelligence.teams.composer.toTeam': 'Gesamtes Team',
  'intelligence.teams.action.blocked': 'Wartet auf Abhängigkeiten',
  'intelligence.teams.action.alreadyClaimed': 'Bereits von einem anderen Teammitglied übernommen',
  'intelligence.teams.action.alreadyActive': 'Teammitglied läuft bereits',
  'intelligence.teams.action.noClaimableTask': 'Keine Aufgabe für dieses Teammitglied bereit',
  'intelligence.teams.action.unknownTask': 'Aufgabe nicht gefunden',
  ...
  'flows.discoveries.title': 'Workflow-Entdeckungen',
  'flows.discoveries.description':
    'Automatisierungen, die der Flow Scout vorschlägt – basierend auf deiner Arbeitsweise.',
  'flows.allRuns.title': 'Workflow-Ausführungen',
  'flows.allRuns.description': 'Jede Workflow-Ausführung in deinem Workspace, neueste zuerst.',
  'flows.allRuns.loading': 'Ausführungen werden geladen…',
  'flows.allRuns.empty': 'Noch keine Workflow-Ausführungen.',
  'flows.allRuns.unknownWorkflow': 'Unbekannter Workflow',
  'flows.allRuns.status.running': 'Läuft',
  'flows.allRuns.status.completed': 'Abgeschlossen',
  'flows.allRuns.status.completed_with_warnings': 'Mit Warnungen abgeschlossen',
  ...
  'flows.nodeKind.tool_call': 'Tool-Aufruf',
  'flows.nodeKind.http_request': 'HTTP-Anfrage',
  'flows.nodeKind.code': 'Code',
  'flows.nodeKind.condition': 'Bedingung',
  'flows.nodeKind.switch': 'Weiche',
  'flows.nodeKind.merge': 'Zusammenführen',
  'flows.nodeKind.split_out': 'Aufteilen',
  ...
  'flows.nodeSummary.trigger.appEvent': 'Wird durch ein App-Ereignis ausgelöst',
  'flows.nodeSummary.trigger.unknownKind': 'Auslöser: {kind}',
  'flows.nodeSummary.agent.defaultModel': 'Standardmodell',
  'flows.nodeSummary.agent.withPrompt': '„{prompt}“ · {model}',
  'flows.nodeSummary.agent.default': 'Fragt {model}',
  'flows.nodeSummary.toolCall.runsNative': 'Führt {name} aus',
  'flows.nodeSummary.toolCall.pickNative': 'Führt ein OpenHuman-Tool aus (eines auswählen)',
  'flows.nodeSummary.toolCall.runs': 'Führt {slug} aus',
  'flows.nodeSummary.toolCall.pick': 'Führt eine App-Aktion aus (eine auswählen)',
  'flows.nodeSummary.http.withUrl': '{method} {url}',
  'flows.nodeSummary.http.noUrl': '{method}-Anfrage (URL festlegen)',
  'flows.nodeSummary.code.runs': 'Führt {lang}-Code aus',
  'flows.nodeSummary.condition.withField': 'Wenn {field} → wahr / falsch',
  'flows.nodeSummary.condition.default': 'Verzweigt in wahr / falsch',
  'flows.nodeSummary.switch.byExpr': 'Leitet nach {expr}',
  'flows.nodeSummary.switch.byExprWithRoutes': 'Leitet nach {expr} ({count} Routen)',
  'flows.nodeSummary.switch.byValue': 'Leitet nach einem Wert',
  'flows.nodeSummary.switch.byValueWithRoutes': 'Leitet nach einem Wert ({count} Routen)',
  'flows.nodeSummary.merge': 'Führt parallele Zweige zusammen',
  'flows.nodeSummary.splitOut.withPath': 'Teilt jedes {path} auf',
  'flows.nodeSummary.splitOut.default': 'Teilt eine Liste in Elemente auf',
  'flows.nodeSummary.transform.default': 'Formt jedes Element um',
  'flows.nodeSummary.transform.setFieldsSingular': 'Setzt {n} Feld auf jedem Element',
  'flows.nodeSummary.transform.setFieldsPlural': 'Setzt {n} Felder auf jedem Element',
  'flows.nodeSummary.outputParser': 'Wertet die vorherige Ausgabe aus',
  'flows.nodeSummary.subWorkflow': 'Führt einen verschachtelten Workflow aus',
  'flows.nodeSummary.memory.flavourWith': 'Liest das Stilprofil „{flavour}“',
  'flows.nodeSummary.memory.flavour': 'Liest ein Stilprofil',
  'flows.nodeSummary.memory.people': 'Durchsucht das Personen-Gedächtnis',
  'flows.nodeSummary.memory.remember': 'Speichert einen Wert in diesem Workflow',
  'flows.nodeSummary.memory.forget': 'Vergisst einen Wert aus diesem Workflow',
  'flows.nodeSummary.memory.searchScoped': 'Durchsucht das Gedächtnis ({scope})',
  'flows.nodeSummary.memory.search': 'Durchsucht das Gedächtnis',
  'flows.nodeSummary.memory.recallScoped': 'Ruft aus dem Gedächtnis ab ({scope})',
  ...
  'flows.cron.customSchedule': 'Benutzerdefinierter Zeitplan ({expr})',
  'flows.cron.noScheduleSet': 'Kein Zeitplan festgelegt',
  'flows.cron.weekdays': 'Wochentage',
  'flows.cron.weekends': 'Wochenenden',
  'flows.cron.everyMinute': 'Jede Minute',
  'flows.cron.everyMinuteOnDays': 'Jede Minute an {days}',
  'flows.cron.everyNMinutes': 'Alle {n} Minuten',
  'flows.cron.everyNMinutesOnDays': 'Alle {n} Minuten an {days}',
  'flows.cron.everyHour': 'Jede Stunde',
  'flows.cron.everyHourOnDays': 'Jede Stunde an {days}',
  'flows.cron.everyNHours': 'Alle {n} Stunden',
  'flows.cron.everyNHoursOnDays': 'Alle {n} Stunden an {days}',
  'flows.cron.everyDayAtTime': 'Jeden Tag um {time}',
  'flows.cron.atTimeOnDays': 'Um {time} an {days}',
  'flows.cron.invalidInterval': 'Ungültiges Intervall',
  'flows.cron.dailyEvery24h': 'Täglich (alle 24 Std.)',
  'flows.cron.everyNDays': 'Alle {n} Tage',
  'flows.cron.everyNHoursShort': 'Alle {n} Std.',
  'flows.cron.everyNMinutesShort': 'Alle {n} Min.',
  'flows.cron.everySecond': 'Jede Sekunde',
  'flows.cron.everyNSeconds': 'Alle {n} Sek.',
  'flows.cron.onceAtRaw': 'Einmalig am {at}',
  'flows.cron.onceAt': 'Einmalig am {at}',
  ...
  'settings.ai.providers.groupLocal': 'Lokale Laufzeiten',
  'settings.ai.providers.groupCli': 'CLI-Anmeldungen',
  'settings.ai.providers.cliDetail': 'Nutzt eine Anmeldung, die eine andere CLI bereits hat',
  'settings.ai.providers.connected': 'Verbunden',
  'settings.ai.providers.managedDetail': 'OpenHuman wählt für jede Aufgabe ein Modell',
  'settings.ai.providers.rowActions': 'Weitere Aktionen für {provider}',
  'settings.ai.providers.replaceKey': 'API-Schlüssel ersetzen',
  'settings.ai.providers.custom': 'Benutzerdefiniert',
  'settings.ai.providers.addProvider': 'Anbieter hinzufügen',
  'settings.ai.providers.addProviderSubtitle':
    'Wählen Sie einen Anbieter zum Verbinden. Sie können jederzeit weitere hinzufügen.',
  'settings.ai.providers.placeholderCloud': 'Cloud-Anbieter auswählen…',
  ...
  'settings.ai.providers.groupConnected': 'Verbunden',
  'settings.ai.providers.localDetail': 'Läuft auf diesem Gerät',
  ...
  'settings.ai.workload.columnHeader': 'Aufgabe',
  ...
  'settings.agentAccess.approvalHistory': 'Genehmigungsverlauf',
  ...
  'settings.approvalHistory.title': 'Genehmigungsverlauf',
  'settings.approvalHistory.subtitle': 'Aktuelle Tool-Genehmigungsentscheidungen, neueste zuerst.',
  'settings.approvalHistory.refresh': 'Refresh',
  'settings.approvalHistory.loading': 'Genehmigungsverlauf wird geladen…',
  'settings.approvalHistory.retry': 'Retry',
  'settings.approvalHistory.emptyState': 'Noch keine Genehmigungsentscheidungen aufgezeichnet.',
  'settings.approvalHistory.errorGeneric':
    'Genehmigungsverlauf konnte nicht geladen werden. Erneut versuchen.',
  ...
  'settings.theme.variantAuto': 'Automatisch',
  'settings.theme.variantAria': 'Theme-Variante',
  'settings.theme.backdropHeading': 'Hintergrund',
  'settings.theme.backdrop.mesh': 'Netz',
  ...
  'settings.theme.group.accents': 'Akzentfarben',
  'settings.theme.showShades': 'Alle Akzenttöne anzeigen',
  'settings.theme.hideShades': 'Alle Akzenttöne ausblenden',
  'settings.theme.fontsHeading': 'Schriftarten',
  'settings.theme.fontRole.title': 'Titel',
  'settings.theme.fontRole.heading': 'Überschrift',
  'settings.theme.fontRole.body': 'Fließtext',
  'settings.theme.fontRole.mono': 'Monospace',
  'settings.theme.fontRole.serif': 'Serif',
  'settings.theme.fontCurrent': 'Aktuell',
  'settings.theme.actions': 'Theme verwalten',
  'settings.theme.reset': 'Überschreibungen zurücksetzen',
  'settings.theme.delete': 'Theme löschen',
  ...
  'skills.resource.tree.examples': 'Beispiele',
  'skills.resource.tree.other': 'Andere',
  'skills.resource.tree.prompts': 'Prompts',
  'skills.resource.tree.references': 'Referenzen',
  'skills.resource.tree.scripts': 'Skripte',
  ...
  'skills.setup.voice.sttNotReadyDesc':
    'Voice Intelligence braucht eine funktionierende Spracherkennung. Wähle eine unter Einstellungen › Sprache.',
  ...
  'workflows.subtitle':
    'Wiederverwendbare, ausführbare Abläufe: ein Ziel und die Schritte dorthin. Erstellen, über eine URL installieren oder einen Workflow öffnen und ausführen.',
  'workflows.createNew': 'Neuer Workflow',
  'workflows.listHeading': 'Workflows',
  'workflows.delete': 'Workflow löschen',
  'workflows.deleteError': 'Workflow konnte nicht gelöscht werden',
  'workflows.warnings': '{count} Warnung(en)',
  ...
  'workflows.create.descriptionPlaceholder': 'Was macht dieser Workflow?',
  'workflows.create.whenToUse': 'Wann verwenden',
  'workflows.create.whenToUsePlaceholder': 'Wann soll der Agent diesen Workflow verwenden?',
  'workflows.create.optional': '(optional)',
  'workflows.create.createBtn': 'Workflow erstellen',
  'workflows.create.creating': 'Creating…',
  'workflows.create.createError': 'Workflow konnte nicht erstellt werden',
  'workflows.create.successTitle': 'Workflow erstellt',
  'workflows.create.successMessage': 'wurde erfolgreich erstellt.',
  'workflows.deleteConfirm.title': 'Workflow löschen',
  'workflows.deleteConfirm.body': '„{name}“ entfernen? Dies kann nicht rückgängig gemacht werden.',
  ...
  'workflows.detail.noPhases': 'Keine Phasen definiert.',
  'workflows.detail.loadError': 'Vollständiger Workflow konnte nicht geladen werden',
  'workflows.phase.rules': 'Rules',
  'workflows.phase.rules.empty': 'Keine Regeln.',
  'workflows.phase.scripts': 'Scripts',
  'workflows.phase.scripts.empty': 'Keine Skripte.',
  'workflows.phase.toolScope': 'Tool-Bereich',
  'workflows.phase.toolScope.allow': 'Allow',
  'workflows.phase.toolScope.deny': 'Deny',
  'workflows.phase.toolScope.inherited': 'Vom Workflow-Standard geerbt.',
  'workflows.phase.toolScope.empty': 'Keine Tool-Einschränkungen.',
  'workflows.phase.context': 'Context',
  'workflows.phase.context.empty': 'Keine Kontextanbieter.',
  ...
  'composer.settings.loadingModels': 'Modelle werden geladen…',
  ...
  'settings.gateway.whereLegend': 'Wo soll er laufen?',
  ...
  'settings.gateway.kind.ssh': 'Auf einem anderen Rechner',
  'settings.gateway.kind.ssh+docker': 'In einem Container auf einem anderen Rechner',
  'settings.gateway.kind.local-process': 'Auf diesem Computer',
  'settings.gateway.idRequired': 'Gib diesem Ort einen Namen.',
  ...
  'settings.ai.picker.searchPlaceholder': 'Modelle suchen',
  ...
  'settings.ai.resetsAt': 'wird zurückgesetzt am {time}',
  'settings.ai.usedAmount': '{amount} verbraucht',
  ...
  'settings.ai.rowsPerBudgetFormula':
    'Zyklusbudget / durchschnittliche Zeile = {budget} / {avgRow}',
  'settings.ai.burnRateSampleDetail': '{rows} Zeilen/Std. über eine Stichprobe von {hours}h',
  'settings.ai.needTimestampsForBurnRate':
    'Es werden Zeitstempel von mindestens zwei Ausgabenzeilen benötigt.',
  'settings.ai.projectedEmptyDetail':
    '{hours}h nach der letzten Ausgabe bei aktueller Verbrauchsrate',
  'settings.ai.noProjectionWithoutSpend': 'Keine Prognose ohne aktuelle stündliche Ausgaben.',
  'settings.ai.readsPerDollar': '{count} Abfragen/$',
  'settings.ai.apiReadsFormula':
    'API-Hintergrundabfragen/Woche / verbleibend = {reads} / {remaining}',
  'settings.ai.needUsageToEstimate': 'Für eine Schätzung wird die Nutzungsantwort benötigt.',
  ...
  'skills.category.all': 'Alle',
  'skills.category.builtIn': 'Integriert',
  'skills.category.channels': 'Kanäle',
  'skills.category.productivity': 'Produktivität',
  'skills.category.chat': 'Chat',
  'skills.category.toolsAutomation': 'Tools und Automatisierung',
