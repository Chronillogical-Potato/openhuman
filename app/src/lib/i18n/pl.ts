...
const messages: TranslationMap = {
  ...
  'conversations.toolFailure.notFound.cause': 'To, o co prosiła ta akcja, nie istnieje lub nie jest tu dostępne.',
  'conversations.toolFailure.notFound.next': 'Nic nie trzeba robić. Asystent może znaleźć właściwą nazwę i spróbować ponownie.',
  'conversations.toolFailure.unsupported.cause': 'OpenHuman nie potrafi jeszcze zrobić tego automatycznie.',
