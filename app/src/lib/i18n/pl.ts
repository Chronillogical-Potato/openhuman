...
const messages: TranslationMap = {
  ...
  'brain.welcome.nav': 'Witamy',
  'brain.welcome.eyebrow': 'Mózg',
  'brain.welcome.title': 'Pamięć Twojego agenta, zmapowana',
  'brain.welcome.body':
    'Mózg to miejsce, w którym Twój agent przechowuje to, co wie: ludzi, rozmowy, źródła i cele, z których korzysta, by pomagać Ci z prawdziwym kontekstem, zamiast zaczynać od zera za każdym razem.',
  ...
  'feedback.welcome.main': 'Tablica opinii',
  ...
  'feedback.welcome.feat3Body': 'Zobacz, co jest zaplanowane, w toku i wdrożone.',
  ...
  'connections.welcome.featsLabel': 'Co możesz tu zrobić',
  'connections.welcome.feat1Title': 'Dodaj kanały',
  'connections.welcome.feat1Body':
    'Slack, WhatsApp, Telegram, Gmail i inne: połączone w kilka kliknięć.',
  'connections.welcome.feat2Title': 'Pozwól agentowi działać',
  'connections.welcome.feat2Body':
    'Czyta, tworzy szkice i odpowiada z pełnym kontekstem ze wszystkiego, co połączone.',
  'connections.welcome.feat3Title': 'Zachowaj kontrolę',
  'connections.welcome.feat3Body':
    'Przyznawaj lub odbieraj dostęp do każdego kanału, kiedy chcesz. Nic nie działa bez Twojej zgody.',
  'alerts.header.desc': 'Aktywność agenta i wszystko, co wymaga Twojej uwagi.',
  'notifications.welcome.nav': 'Witamy',
  'notifications.welcome.main': 'Powiadomienia',
  ...
  'rewards.welcome.feat1Body': 'Codzienne działania i polecenia sumują się z czasem.',
  'rewards.welcome.feat2Title': 'Utrzymuj serię',
  'rewards.welcome.feat2Body': 'Bywaj regularnie, aby odblokować premie za serię.',
  'rewards.welcome.feat3Title': 'Wymieniaj korzyści',
  'rewards.welcome.feat3Body': 'Zamieniaj punkty na kupony i nagrody.',
  'flows.welcome.nav': 'Witamy',
  'flows.welcome.main': 'Przepływy pracy',
  ...
  'flows.welcome.feat3Body': 'Zatwierdzaj wrażliwe kroki, zanim cokolwiek zostanie wysłane.',
  ...
  'feedback.empty':
    'Nie ma jeszcze żadnych opinii. Bądź pierwszą osobą, która podzieli się pomysłem.',
  'feedback.loadMore': 'Wczytaj więcej',
  ...
  'feedback.status.completed': 'Ukończone',
  'feedback.status.closed': 'Zamknięte',
  'feedback.type.feature': 'Funkcja',
  'feedback.type.bug': 'Błąd',
  'feedback.sort.hot': 'Na czasie',
  'feedback.sort.top': 'Najlepsze',
  'feedback.sort.new': 'Najnowsze',
  'feedback.filter.allTypes': 'Wszystkie typy',
  'feedback.filter.allStatuses': 'Wszystkie statusy',
  'feedback.vote.up': 'Głosuj za',
  'feedback.vote.down': 'Głosuj przeciw',
  'feedback.submit.heading': 'Podziel się opinią',
  'feedback.submit.subheading': 'Zaproponuj funkcję lub zgłoś błąd. Inni mogą na to zagłosować.',
  'feedback.submit.titlePlaceholder': 'Tytuł',
  'feedback.submit.bodyPlaceholder': 'Opisz swój pomysł lub napotkany problem',
  'feedback.submit.action': 'Wyślij',
  'feedback.submit.success': 'Dziękujemy! Twoja opinia jest już na tablicy.',
  'feedback.submit.rejected': 'Nie udało się opublikować Twojej opinii.',
  'feedback.submit.error': 'Coś poszło nie tak. Spróbuj ponownie.',
  'feedback.admin.status': 'Status',
  'feedback.admin.updateFailed': 'Nie udało się zaktualizować statusu',
  'feedback.comments.empty': 'Brak komentarzy.',
  'feedback.comments.placeholder': 'Dodaj komentarz',
  'feedback.comments.post': 'Opublikuj',
  'feedback.comments.loadError': 'Nie udało się załadować komentarzy',
  'feedback.comments.postError': 'Nie udało się opublikować komentarza',
  'feedback.comments.you': 'Ty',
  'conversations.backgroundTasks.titleWithCount': 'Zadania w tle ({count})',
  'conversations.backgroundTasks.running': '{count} działa',
  'conversations.backgroundTasks.noneRunning': 'żaden nie biegnie',
  'conversations.backgroundTasks.total': '{count} ogółem',
  'conversations.backgroundTasks.empty':
    'Na tym czacie nie ma zadań w tle. Poproś asystenta, aby zrobił coś w tle, a pojawi się tutaj.',
  ...
  'conversations.backgroundTasks.statusNeedsYou': 'Potrzebuje cię',
  'conversations.backgroundTasks.statusCancelled': 'Anulowano',
  'conversations.backgroundTasks.toolCallOne': 'Wywołanie narzędzia {count}',
  'conversations.backgroundTasks.toolCallOther': 'Wywołania narzędzi {count}',
  'conversations.backgroundTasks.steps': 'Stopnie {count}',
  'conversations.backgroundTasks.viewDetails': 'Zobacz szczegóły →',
  ...
  'conversations.backgroundTasks.inboxReady': '{count} gotowe',
  'conversations.backgroundTasks.inboxInFlight': '{count} w toku',
  'conversations.backgroundTasks.memoryJobTitle': 'Synchronizacja pamięci',
  'conversations.backgroundTasks.cancelJob': 'Anuluj',
  ...
  'nav.discord': 'Dołącz do naszego Discorda',
  ...
  'nav.workflowRuns': 'Uruchomienia przepływów',
  'nav.workflowDiscoveries': 'Odkryj przepływy',

  'wallet.tabs.balance': 'Saldo portfela',
  'wallet.tabs.recovery': 'Odzyskiwanie',
  'wallet.ariaLabel': 'Widoki portfela',
  ...
  'chat.connectionState.dropped': 'Utracono połączenie. Przebieg trwał dalej na serwerze.',
  'chat.connectionState.reconnect': 'Połącz ponownie',
  'chat.connectionState.reconnecting': 'Ponowne łączenie',
  'chat.connectionState.resumed': 'Wznowiono strumień.',
  ...
  'skills.explorer.newSkill': 'Nowy skill',
  ...
  'skills.rows.installedTitle': 'Zainstalowane skille',
  'skills.rows.installedIntro':
    'Skille, które twój agent może uruchomić na tym komputerze. Otwórz jeden, aby zobaczyć szczegóły; uruchom, edytuj lub usuń go z jego wiersza.',
  'skills.rows.registryTitle': 'Rejestr skilli',
  'skills.rows.registryIntro':
    'Katalogi skilli do zainstalowania. Wyszukaj, a następnie zainstaluj jeden do swoich skilli użytkownika.',
  'skills.rows.open': 'Otwórz {name}',
  'skills.rows.run': 'Uruchom {name}',
  'skills.rows.edit': 'Edytuj {name}',
  'skills.rows.remove': 'Usuń {name}',
  ...
  'connections.tabs.browser': 'Sterowanie przeglądarką',
  'connections.browser.description': 'Skonfiguruj zadania przeglądarki i sprawdź gotowość.',
  'connections.earlyAlphaNotice':
    'Wczesna alfa: sterowanie przeglądarką i pulpitem jest nadal testowane. Działania mogą działać nieprzewidywalnie lub zmieniać się między wersjami.',
  'connections.browser.module': 'Moduł',
  'connections.browser.chrome': 'Chrome',
  'connections.browser.unknown': 'Nieznany',
  'connections.browser.notVerified': 'Niezweryfikowany',
  'connections.browser.localOverride': 'Do publikacji archiwów potrzebny jest lokalny moduł.',
  'connections.browser.testModule': 'Sprawdź moduł',
  'connections.browser.enabled': 'Włącz przeglądarkę',
  'connections.browser.headless': 'Bez interfejsu',
  'connections.browser.width': 'Szerokość okna',
  'connections.browser.height': 'Wysokość okna',
  'connections.browser.chromePath': 'Ścieżka Chrome (opcjonalnie)',
  'connections.browser.profileMode': 'Profil',
  'connections.browser.fresh': 'Nowy profil',
  'connections.browser.persistent': 'Trwały profil',
  'connections.browser.profilePath': 'Folder profilu',
  'connections.browser.downloadDir': 'Folder pobierania',
  'connections.browser.maxSteps': 'Maksymalna liczba kroków',
  'connections.browser.timeout': 'Limit czasu (sekundy)',
  'connections.browser.allowedWebsites': 'Dozwolone witryny',
  'connections.browser.sharedPolicy':
    'Przeglądarka i wyszukiwanie korzystają z tej samej polityki witryn.',
  'connections.browser.manageWebsites': 'Zarządzaj witrynami',
  'connections.browser.jevRoute': 'Trasa rozliczeń Jev',
  ...
  'connections.browser.chromeReady': 'Chrome gotowy',
  'connections.browser.chromeNotReady': 'Chrome niedostępny',
  'connections.browser.readinessChecked': 'Gotowość sprawdzona',
  'connections.browser.boundsRequired':
    'Ustaw szerokość 320–3840, wysokość 240–2160, 1–100 kroków i limit 5–600 sekund.',
  'connections.browser.noneAllowed': 'Brak dozwolonych witryn',
  'connections.browser.moduleChecked': 'Moduł sprawdzony',
  'connections.tabs.skills': 'Umiejętności',
  'connections.tabs.meetings': 'Spotkania',
  'connections.groups.integrations': 'Integracje',
  'connections.groups.desktop': 'Pulpit',
  'desktop.approvalSummary': '{operation} „{target}” w {app}',
  'desktop.action.click': 'Kliknij',
  'desktop.action.type_text': 'Wpisz tekst w',
  'desktop.action.check': 'Zaznacz',
  'desktop.action.uncheck': 'Odznacz',
  ...
  'desktop.enabledPending':
    'Włączono. Dokończ konfigurację poniżej przed użyciem narzędzi pulpitu.',
  'desktop.moduleUnavailable':
    'Moduł pulpitu jest niedostępny. Sprawdź jego stan i spróbuj ponownie.',
  'desktop.pendingUnavailable':
    'Nie udało się wczytać oczekujących zgód na dostęp do pulpitu. Odśwież, aby spróbować ponownie.',
  'desktop.unsupported': 'Sterowanie pulpitem jest niedostępne w tym środowisku.',
  'desktop.localOnly': 'To ustawienie dotyczy tylko tego komputera.',
  'desktop.permissions': 'Uprawnienia systemowe',
  'desktop.permission.accessibility': 'Dostępność',
  'desktop.permission.screen_recording': 'Nagrywanie ekranu',
  'desktop.openSettings': 'Otwórz ustawienia',
  'desktop.captureNote':
    'Nagrywanie ekranu jest potrzebne tylko do zrzutów. Dostępność pozwala sprawdzać i obsługiwać aplikacje.',
  'desktop.testDescription': 'Sprawdź, czy rdzeń widzi aplikacje uruchomione na tym komputerze.',
  'desktop.testButton': 'Sprawdź dostęp do pulpitu',
  'desktop.testPassed': 'Dostęp do pulpitu działa.',
  'desktop.testFailed': 'Nie udało się potwierdzić dostępu do pulpitu.',
  ...
  'memoryTimeline.title': 'Oś czasu pamięci',
  'memoryTimeline.intro':
    'Kiedy asystent dowiedział się o Tobie: fakty pogrupowane według miesiąca ostatniego wzmocnienia. Pokazuje wzrost, skoki aktywności i spokojne okresy.',
  'memoryTimeline.loading': 'Budowanie osi czasu…',
  'memoryTimeline.errorPrefix': 'Nie udało się załadować grafu:',
  ...
  'memoryTimeline.heading': 'Fakty poznane w danym miesiącu',
  'memoryTimeline.busiestCaption': 'Najbardziej aktywny: {period} ({count})',
  'memoryTimeline.undatedNote': '{count} fakt(ów) bez zarejestrowanej daty.',
  'memoryTimeline.truncated': 'Wyświetlanie {shown} najnowszych z {total} miesięcy.',
  ...
  'entityAssociations.empty': 'Brak powiązań.',
  'entityAssociations.emptyHint':
    'Gdy encje zaczną dzielić połączenia, najsilniejsze pary pojawią się tutaj.',
  'entityAssociations.namespaceLabel': 'Namespace',
  'entityAssociations.namespaceAll': 'Wszystkie przestrzenie nazw',
  'entityAssociations.metricEntities': 'Entities',
  'entityAssociations.metricPairs': 'Associations',
  'entityAssociations.rankedHeading': 'Najsilniejsze powiązania',
  'entityAssociations.linkedBadge': 'linked',
  'entityAssociations.inferredBadge': 'inferred',
  'entityAssociations.linkedTitle': 'Te encje są bezpośrednio połączone.',
  'entityAssociations.inferredTitle':
    'Brak bezpośredniego powiązania: skojarzone wyłącznie przez wspólne połączenia.',
  'entityAssociations.sharedLabel': '{shared} wspólnych',
  'entityAssociations.pairTitle': '{jaccard}% podobieństwa · {shared} z {union} wspólnych połączeń',
  'entityAssociations.truncated': 'Wyświetlanie {shown} z {total}: najsilniejsze najpierw.',
  'memory.tab.freshness': 'Freshness',
  'memoryFreshness.title': 'Świeżość wiedzy',
  'memoryFreshness.intro':
    'Fakty, których asystent nie potwierdził ostatnio, zanikają wzdłuż krzywej zapominania. To pokazuje, co staje się nieaktualne i warte ponownego sprawdzenia, aby stare fakty nie były traktowane jako nadal pewne.',
  'memoryFreshness.loading': 'Obliczanie świeżości…',
  'memoryFreshness.errorPrefix': 'Nie udało się załadować grafu:',
  'memoryFreshness.retry': 'Retry',
  'memoryFreshness.empty': 'Brak grafu wiedzy.',
  'memoryFreshness.emptyHint':
    'Gdy asystent zapisze fakty o Tobie, ich świeżość będzie śledzona tutaj.',
  'memoryFreshness.namespaceLabel': 'Namespace',
  'memoryFreshness.namespaceAll': 'Wszystkie przestrzenie nazw',
  'memoryFreshness.metricFresh': 'Fresh',
  'memoryFreshness.metricFading': 'Fading',
  'memoryFreshness.metricStale': 'Stale',
  'memoryFreshness.recallCaption': 'Średnie odtworzenie {recall}% z {total} faktów',
  'memoryFreshness.queueHeading': 'Kolejka ponownego potwierdzenia',
  'memoryFreshness.queueTruncated': 'Wyświetlanie {shown} z {total}: zajmij się tymi najpierw.',
  'memoryFreshness.allFresh': 'Wszystkie fakty są wciąż świeże: nic do ponownego potwierdzenia.',
  'memoryFreshness.statusFading': 'fading',
  'memoryFreshness.statusStale': 'stale',
  'memoryFreshness.ageLabel': '{days} dni temu',
  'memoryFreshness.recallTitle': '{recall}% odtworzenia · okres półtrwania {halfLife} dni',
  ...
  'memoryTree.status.storedItemsTile': 'Zapisane elementy',
  ...
  'onboarding.runtimeChoice.cloud.creditHighlight': 'Darmowe kredyty po rejestracji',
  ...
  'settings.costDashboard.unknownProvider': 'Brak',
  ...
  'mcp.rows.showTools': 'Pokaż narzędzia {name}',
  'mcp.rows.hideTools': 'Ukryj narzędzia {name}',
  'mcp.rows.toolsLoading': 'Odczytywanie narzędzi…',
  'mcp.rows.toolsFailed': 'Nie udało się odczytać narzędzi.',
  'mcp.rows.add': 'Dodaj serwer',
  ...
  'mcp.form.transportStdio': 'Lokalne polecenie (stdio)',
  'mcp.form.transportHttp': 'Zdalny URL (HTTP)',
  'mcp.form.command': 'Polecenie',
  ...
  'mcp.form.url': 'URL',
  'mcp.form.auth': 'Uwierzytelnianie',
  'mcp.form.authNone': 'Brak',
  'mcp.form.authBearer': 'Token Bearer',
  'mcp.form.authHeader': 'Własny nagłówek',
  'mcp.form.authOauth': 'Zaloguj się w przeglądarce (OAuth)',
  ...
  'mcp.form.saving': 'Zapisywanie…',
  'mcp.form.saveFailed': 'Nie udało się zapisać serwera.',
  ...
  'mcp.registry.title': 'Katalog MCP',
  'mcp.tab.section.servers': 'Serwery',
  'mcp.tab.section.json': 'mcp.json',
  'mcp.tab.section.registry': 'Rejestr',
  'mcp.tab.back': 'Wróć do serwerów',
  'mcp.tab.action.openPage': 'Otwórz stronę',
  ...
  'mcp.json.credentialsNote':
    'Dane uwierzytelniające są tylko do zapisu: wartości env i headers są zapisywane przy zapisie i nigdy nie są ponownie wyświetlane. Wpis zapisany bez nich zachowuje to, co jest zapisane; ustaw klucz na "", aby go usunąć.',
  'mcp.json.editorAria': 'Dokument mcp.json',
  'mcp.json.refusedTitle': 'Rdzeń odrzucił ten dokument',
  'mcp.json.saved': 'Zapisano: dodano {added}, zaktualizowano {updated}, usunięto {removed}.',
  'mcp.json.saving': 'Zapisywanie…',
  'mcp.json.save': 'Zapisz',
  'mcp.json.revert': 'Przywróć',
  ...
  'mcp.json.parseError.needsUrlOrCommand':
    '`{name}` wymaga `url` (hostowany) lub `command` (uruchamiany lokalnie).',
  'mcp.json.parseError.bothUrlAndCommand':
    '`{name}` podaje zarówno `url`, jak i `command`; serwer łączy się tylko w jeden sposób.',
  ...
  'voice.providers.desc':
    'Wybierz, który silnik w chmurze transkrybuje Twój głos i gdzie działa synteza. Rozpoznawanie mowy zawsze działa w chmurze; tylko synteza ma opcję lokalną (Piper), instalowaną przyciskiem „Zainstaluj lokalnie”. Bez ręcznego ustawiania PIPER_BIN.',
  'voice.providers.sttProvider': 'Dostawca mowy na tekst',
  'voice.providers.sttProviderAria': 'Dostawca STT',
  'voice.providers.backendSttProxy': 'Chmura (proxy Whisper)',
  ...
  'mic.retryingTranscription': 'Ponawianie próby… ({attempt} z {max})',
  ...
  'memorySyncInterval.title': 'Harmonogram synchronizacji',
  'memorySyncInterval.lastSynced': 'Ostatnia synchronizacja',
  'memorySyncInterval.never': 'nigdy',
  'memorySyncInterval.everyHours': 'Co {h} godz.',
  'memorySyncInterval.everyMinutes': 'Co {m} min',
  'memorySyncInterval.manual': 'Tylko ręcznie',
  'memorySyncInterval.saveFailed': 'Nie udało się zaktualizować harmonogramu synchronizacji',
  ...
  'memorySources.folderPathUnavailable':
    'Nie udało się ustalić, gdzie znajduje się ten folder. Zamiast tego wpisz jego pełną ścieżkę.',
  ...
  'composio.connect.disconnectAccount': 'Usuń',
  'composio.connect.addAnotherAccount': 'Dodaj kolejne konto',
  ...
  'conversations.composer.context.usage': 'Użycie kontekstu',
  'conversations.composer.context.full': 'Zapełnione w {percent}%',
  'conversations.composer.context.reasoning': 'Rozumowanie',
  'conversations.composer.context.headroom': 'Wolne miejsce',
  'conversations.composer.context.meterLabel': 'Użycie kontekstu: {label}',
  'conversations.composer.context.meterValue': '{used} z {limit}',
  'conversations.composer.context.loading': 'Mierzenie kontekstu…',
  'conversations.composer.context.errorTitle': 'Podział kontekstu niedostępny',
  ...
  'conversations.composer.trigger.emptyCategories': 'Brak dostępnych elementów',
  'conversations.composer.slash.empty': 'Brak pasujących poleceń',
  'conversations.composer.mention.empty': 'Brak pasujących elementów',
  'conversations.composer.mention.memory': 'Pamięć',
  'conversations.composer.mention.files': 'Pliki',
  ...
  'conversations.planReview.feedbackPlaceholder': 'Opisz, co zmienić…',
  'conversations.planReview.sendFeedback': 'Wyślij opinię',
  'conversations.planReview.revise': 'Zmień',
  'conversations.runMode.plan': 'Plan',
  'conversations.runMode.build': 'Build',
  'conversations.runMode.toggleLabel': 'Przełącz między trybem planu i budowania',
  ...
  'conversations.tools.inspectDesktop.active': 'Sprawdzanie pulpitu',
  'conversations.tools.inspectDesktop.done': 'Sprawdzono pulpit',
  'conversations.tools.controlDesktop.active': 'Sterowanie pulpitem',
  'conversations.tools.controlDesktop.done': 'Sterowano pulpitem',
  ...
  'conversations.tools.document.title': 'Dokument',
  'conversations.tools.presentation.title': 'Prezentacja',
  ...
  'conversations.subagent.transcript.instruction': 'instrukcja',
  'conversations.subagent.transcript.agent': 'agent',
  'conversations.subagent.transcript.system': 'system',
  'conversations.tasks.taskOne': 'zadanie',
  'conversations.tasks.taskOther': 'zadań',
  'conversations.tasks.running': 'w trakcie',
  'conversations.tasks.waitingForInput': 'czeka na odpowiedź',
  'conversations.tasks.done': 'zakończone',
  'conversations.tasks.failed': 'niepowodzenie',
  'conversations.tasks.of': 'z',
  ...
  'conversations.agentTaskInsights.memoryCitationFallbackTitle': 'Pamięć',
  'conversations.memoryChips.remembered': 'zapamiętano {n}',
  'conversations.memoryChips.idle': 'pamięć',
  'conversations.memoryChips.forgetAriaLabel': 'Zapomnij "{text}"',
  'conversations.scheduleCard.next': 'następny',
  'conversations.scheduleCard.paused': 'wstrzymano',
  'conversations.scheduleCard.recentRuns': 'ostatnie uruchomienia',
  'conversations.scheduleCard.ok': 'ok',
  'conversations.scheduleCard.failed': 'niepowodzenie',
  'conversations.conversationSearch.placeholder': 'Znajdź w rozmowie',
  'conversations.conversationSearch.previousMatch': 'Poprzednie dopasowanie',
  'conversations.conversationSearch.nextMatch': 'Następne dopasowanie',
  'conversations.conversationSearch.timelineToggle': 'Linia czasu',
  ...
  'intelligence.agentWork.bucket.working': 'W toku',
  'intelligence.agentWork.bucket.completed': 'Ukończone',
  'intelligence.agentWork.bucket.failed': 'Niepowodzenie',
  'intelligence.agentWork.bucket.stopped': 'Zatrzymane',
  'intelligence.agentWork.column.agent': 'Agent',
  'intelligence.agentWork.column.status': 'Status',
  'intelligence.agentWork.column.elapsed': 'Czas trwania',
  'intelligence.agentWork.column.cost': 'Koszt',
  'intelligence.agentWork.column.tokens': 'Tokeny',
  'intelligence.agentWork.status.pending': 'Oczekujące',
  'intelligence.agentWork.status.running': 'W toku',
  'intelligence.agentWork.status.awaitingUser': 'Wymaga reakcji',
  'intelligence.agentWork.status.paused': 'Wstrzymane',
  'intelligence.agentWork.status.completed': 'Ukończone',
  'intelligence.agentWork.status.failed': 'Niepowodzenie',
  'intelligence.agentWork.status.cancelled': 'Anulowane',
  'intelligence.agentWork.status.interrupted': 'Przerwane',
  'intelligence.agentWork.kind.subagent': 'Podagent',
  'intelligence.agentWork.kind.workerThread': 'Wątek workera',
  'intelligence.agentWork.kind.backgroundAgent': 'Agent w tle',
  'intelligence.agentWork.kind.teamMember': 'Członek zespołu',
  ...
  'intelligence.teams.empty': 'Brak zespołów agentów',
  'intelligence.teams.emptyHint':
    'Zespoły pojawiają się tutaj, gdy agent tworzy skoordynowane podagenty, aby dzielić wspólny cel.',
  'intelligence.teams.refresh': 'Odśwież',
  'intelligence.teams.backToList': 'Wszystkie zespoły',
  'intelligence.teams.status.active': 'Aktywny',
  'intelligence.teams.status.closed': 'Zamknięty',
  'intelligence.teams.header.lead': 'lider',
  'intelligence.teams.header.taskCount': '{count} zadań',
  'intelligence.teams.header.memberCount': '{count} członków',
  'intelligence.teams.member.active': 'Aktywny',
  'intelligence.teams.member.pending': 'Oczekujący',
  'intelligence.teams.member.idle': 'Bezczynny',
  'intelligence.teams.member.stopped': 'Zatrzymany',
  'intelligence.teams.column.todo': 'Do zrobienia',
  'intelligence.teams.column.ready': 'Gotowe',
  'intelligence.teams.column.inProgress': 'W toku',
  'intelligence.teams.column.blocked': 'Zablokowane',
  'intelligence.teams.column.done': 'Zrobione',
  'intelligence.teams.emptyColumn': 'Puste',
  'intelligence.teams.unclaimed': 'Nieprzypisane',
  'intelligence.teams.pickedUpBy': 'Przejęte przez {name}',
  'intelligence.teams.depLockTitle': '{count} niespełnionych zależności',
  'intelligence.teams.gate.pending': 'Bramka oczekuje',
  'intelligence.teams.gate.passed': 'Bramka zaliczona',
  'intelligence.teams.gate.failed': 'Bramka niezaliczona',
  'intelligence.teams.gate.label': 'Bramka: {status}',
  'intelligence.teams.activity.title': 'Aktywność zespołu',
  'intelligence.teams.activity.empty': 'Brak wiadomości',
  'intelligence.teams.activity.toTeam': 'zespół',
  'intelligence.teams.member.start': 'Uruchom',
  'intelligence.teams.composer.placeholder': 'Wiadomość do członka zespołu…',
  'intelligence.teams.composer.send': 'Wyślij',
  'intelligence.teams.composer.recipient': 'Odbiorca',
  ...
  'notifications.flow.approveTitle': 'Przepływ pracy wymaga zatwierdzenia',
  'notifications.flow.approve': 'Zatwierdź',
  'notifications.flow.approving': 'Zatwierdzanie…',
  'notifications.flow.dismiss': 'Odrzuć',
  'notifications.flow.error': 'Nie udało się wznowić przepływu pracy. Spróbuj ponownie.',
  ...
  'flowRuns.inspector.output': 'Pokaż surowe dane wyjściowe',
  'flowRuns.inspector.summary.failedPrefix': 'Nie udało się ukończyć:',
  'flowRuns.inspector.summary.unknownError': 'coś poszło nie tak',
  'flowRuns.inspector.summary.itemsFetched': 'Pobrano {count} element(y)',
  'flowRuns.inspector.summary.completed': 'Krok zakończony',
  'flowRuns.inspector.summary.noOutput': 'Nie wygenerowano żadnych danych wyjściowych',
  ...
  'flows.discoveries.title': 'Odkrycia przepływów',
  'flows.discoveries.description':
    'Automatyzacje sugerowane przez Flow Scout na podstawie tego, jak pracujesz.',
  'flows.allRuns.title': 'Uruchomienia przepływów',
  'flows.allRuns.description': 'Każde uruchomienie przepływu w Twoim workspace, od najnowszych.',
  'flows.allRuns.loading': 'Ładowanie uruchomień…',
  'flows.allRuns.empty': 'Brak uruchomień przepływów.',
  'flows.allRuns.unknownWorkflow': 'Nieznany przepływ',
  'flows.allRuns.status.running': 'W toku',
  'flows.allRuns.status.completed': 'Ukończono',
  'flows.allRuns.status.completed_with_warnings': 'Ukończono z ostrzeżeniami',
  ...
  'flows.nodeKind.tool_call': 'Wywołanie narzędzia',
  'flows.nodeKind.http_request': 'Żądanie HTTP',
  'flows.nodeKind.code': 'Kod',
  'flows.nodeKind.condition': 'Warunek',
  'flows.nodeKind.switch': 'Przełącznik',
  'flows.nodeKind.merge': 'Scal',
  'flows.nodeKind.split_out': 'Podziel wyjście',
  ...
  'flows.nodeSummary.trigger.appEvent': 'Uruchamia się przy zdarzeniu aplikacji',
  'flows.nodeSummary.trigger.unknownKind': 'Wyzwalacz: {kind}',
  'flows.nodeSummary.agent.defaultModel': 'model domyślny',
  ...
  'flows.nodeSummary.http.noUrl': 'Żądanie {method} (ustaw adres URL)',
  'flows.nodeSummary.code.runs': 'Uruchamia kod {lang}',
  'flows.nodeSummary.condition.withField': 'Jeśli {field} → prawda / fałsz',
  'flows.nodeSummary.condition.default': 'Rozgałęzia się na prawda / fałsz',
  'flows.nodeSummary.switch.byExpr': 'Kieruje według {expr}',
  'flows.nodeSummary.switch.byExprWithRoutes': 'Kieruje według {expr} ({count} tras)',
  'flows.nodeSummary.switch.byValue': 'Kieruje według wartości',
  'flows.nodeSummary.switch.byValueWithRoutes': 'Kieruje według wartości ({count} tras)',
  'flows.nodeSummary.merge': 'Scala równoległe gałęzie',
  'flows.nodeSummary.splitOut.withPath': 'Dzieli każde {path}',
  'flows.nodeSummary.splitOut.default': 'Dzieli listę na elementy',
  'flows.nodeSummary.transform.default': 'Przekształca każdy element',
  'flows.nodeSummary.transform.setFieldsSingular': 'Ustawia {n} pole w każdym elemencie',
  'flows.nodeSummary.transform.setFieldsPlural': 'Ustawia {n} pól w każdym elemencie',
  'flows.nodeSummary.outputParser': 'Analizuje poprzednie dane wyjściowe',
  'flows.nodeSummary.subWorkflow': 'Uruchamia zagnieżdżony przepływ pracy',
  'flows.nodeSummary.memory.flavourWith': 'Odczytuje styl "{flavour}"',
  'flows.nodeSummary.memory.flavour': 'Odczytuje styl z pamięci',
  'flows.nodeSummary.memory.people': 'Przeszukuje pamięć osób',
  'flows.nodeSummary.memory.remember': 'Zapisuje wartość w tym przepływie pracy',
  'flows.nodeSummary.memory.forget': 'Zapomina wartość z tego przepływu pracy',
  'flows.nodeSummary.memory.searchScoped': 'Przeszukuje pamięć ({scope})',
  'flows.nodeSummary.memory.search': 'Przeszukuje pamięć',
  'flows.nodeSummary.memory.recallScoped': 'Przywołuje z pamięci ({scope})',
  ...
  'flows.cron.customSchedule': 'Niestandardowy harmonogram ({expr})',
  'flows.cron.noScheduleSet': 'Nie ustawiono harmonogramu',
  'flows.cron.weekdays': 'dni robocze',
  'flows.cron.weekends': 'weekendy',
  'flows.cron.everyMinute': 'Co minutę',
  'flows.cron.everyMinuteOnDays': 'Co minutę w {days}',
  'flows.cron.everyNMinutes': 'Co {n} minut',
  'flows.cron.everyNMinutesOnDays': 'Co {n} minut w {days}',
  'flows.cron.everyHour': 'Co godzinę',
  'flows.cron.everyHourOnDays': 'Co godzinę w {days}',
  'flows.cron.everyNHours': 'Co {n} godzin',
  'flows.cron.everyNHoursOnDays': 'Co {n} godzin w {days}',
  'flows.cron.everyDayAtTime': 'Codziennie o {time}',
  'flows.cron.atTimeOnDays': 'O {time} w {days}',
  'flows.cron.invalidInterval': 'Nieprawidłowy interwał',
  'flows.cron.dailyEvery24h': 'Codziennie (co 24 godz.)',
  'flows.cron.everyNDays': 'Co {n} dni',
  'flows.cron.everyNHoursShort': 'Co {n} godz.',
  'flows.cron.everyNMinutesShort': 'Co {n} min',
  'flows.cron.everySecond': 'Co sekundę',
  'flows.cron.everyNSeconds': 'Co {n} s',
  'flows.cron.onceAtRaw': 'Raz, {at}',
  'flows.cron.onceAt': 'Raz, {at}',
  ...
  'settings.ai.providers.groupCloud': 'Chmura',
  'settings.ai.providers.groupLocal': 'Lokalne środowiska',
  ...
  'settings.ai.providers.placeholderCloud': 'Wybierz dostawcę w chmurze…',
  ...
  'settings.ai.providers.localDetail': 'Działa na tym urządzeniu',
  ...
  'settings.ai.routing.workload.chat.hint':
    'Zalecane: tani lub średni model szybkiego czatu z dużą liczbą tokenów/s i niskim opóźnieniem. Modele lokalne typu open source mogą się tutaj dobrze sprawdzić, jeśli wydają się responsywne.',
  'settings.ai.routing.workload.reasoning.label': 'Reasoning',
  'settings.ai.routing.workload.reasoning.description':
    'Główny agent czatu, podsumowanie spotkania: tryb „Rozumowanie” w Rozmowach',
  'settings.ai.routing.workload.reasoning.hint':
    'Zalecane: droższy model graniczny lub silny model rozumowania do głębokiego myślenia. Służy do głównego agenta czatu, podsumowań spotkań i cięższej syntezy odpowiedzi.',
  'settings.ai.routing.workload.agentic.label': 'Agentic',
  'settings.ai.routing.workload.agentic.description':
    'Biegacze podagenci, pętle narzędzi, decyzje GIF',
  'settings.ai.routing.workload.agentic.hint':
    'Zalecane: niezawodny model zgodny z instrukcją i wymagający dużego użycia narzędzi. Modele graniczne o średniej cenie są zwykle najbezpieczniejsze; zdolne modele open source mogą działać, jeśli wywoływanie narzędzi jest stabilne.',
  'settings.ai.routing.workload.coding.label': 'Coding',
  'settings.ai.routing.workload.coding.description':
    'Generowanie kodu i refaktoryzacja przebiegają',
  'settings.ai.routing.workload.coding.hint':
    'Zalecane: model dostosowany do kodowania z dokładnym przestrzeganiem instrukcji, jakością edycji i wydajnością w długim kontekście. Zwykle warto na to wydać więcej.',
  'settings.ai.routing.workload.vision.label': 'Vision',
  'settings.ai.routing.workload.vision.description':
    'Zrozumienie obrazu dla subagenta ds. wizji: zawsze multimodalne',
  ...
  'settings.ai.workload.columnHeader': 'Zadanie',
  ...
  'settings.agentAccess.approvalHistory': 'Historia zatwierdzeń',
  ...
  'settings.theme.variantAuto': 'Automatyczny',
  'settings.theme.variantAria': 'Wariant motywu',
  'settings.theme.backdropHeading': 'Tło',
  'settings.theme.backdrop.mesh': 'Siatka',
  ...
  'settings.theme.group.accents': 'Kolory akcentów',
  'settings.theme.showShades': 'Pokaż wszystkie odcienie akcentów',
  'settings.theme.hideShades': 'Ukryj wszystkie odcienie akcentów',
  'settings.theme.fontsHeading': 'Czcionki',
  'settings.theme.fontRole.title': 'Tytuł',
  'settings.theme.fontRole.heading': 'Nagłówek',
  'settings.theme.fontRole.body': 'Tekst podstawowy',
  'settings.theme.fontRole.mono': 'Czcionka o stałej szerokości',
  'settings.theme.fontRole.serif': 'Szeryfowa',
  'settings.theme.fontCurrent': 'Bieżąca',
  'settings.theme.actions': 'Zarządzaj motywem',
  'settings.theme.reset': 'Zresetuj zmiany',
  'settings.theme.delete': 'Usuń motyw',
  'settings.theme.export': 'Kopiuj JSON',
  'settings.theme.copied': 'Skopiowano!',
  'settings.theme.import': 'Importuj motyw',
  'settings.theme.importHint': 'Wklej wyeksportowany JSON motywu, aby dodać go jako własny motyw.',
  'settings.theme.importApply': 'Importuj',
  'settings.theme.importError': 'Nie udało się przetworzyć tego JSON motywu.',
  ...
  'settings.persona.menuDesc': 'Imię, osobowość, awatar i głos: Twój asystent jako jedna tożsamość',
  ...
  'skills.resource.tree.assets': 'Zasoby',
  'skills.resource.tree.examples': 'Przykłady',
  'skills.resource.tree.other': 'Inne',
  'skills.resource.tree.prompts': 'Prompty',
  'skills.resource.tree.references': 'Referencje',
  'skills.resource.tree.scripts': 'Skrypty',
  ...
  'skills.setup.voice.sttNotReadyDesc':
    'Inteligencja głosowa wymaga działającego silnika rozpoznawania mowy. Wybierz go w Ustawieniach › Głos.',
  ...
  'walletBalances.earlyAlphaNotice':
    'Wczesna alfa: salda portfela są nadal testowane. Kwoty i obsługiwane sieci mogą zmieniać się między wersjami.',
  'walletBalances.allNetworks': 'Wszystkie sieci',
  'walletBalances.manageTokens': 'Zarządzaj tokenami',
  'walletBalances.noFilterMatches': 'Żadne saldo nie pasuje do filtrów',
  ...
  'workflows.deleteError': 'Nie udało się usunąć przepływu pracy',
  'workflows.warnings': '{count} ostrzeżeń',
  'workflows.empty.title': 'Brak przepływów pracy',
  'workflows.empty.body':
    'Utwórz przepływ pracy, aby zdefiniować reguły i skrypty dla faz cyklu życia zadań.',
  'workflows.create.title': 'Nowy przepływ pracy',
  'workflows.create.subtitle': 'Zdefiniuj zestaw reguł powiązany z cyklem życia agenta.',
  'workflows.create.name': 'Name',
  'workflows.create.namePlaceholder': 'np. Przepływ pracy projektu Python',
  'workflows.create.description': 'Description',
  'workflows.create.descriptionPlaceholder': 'Co robi ten przepływ pracy?',
  'workflows.create.whenToUse': 'Kiedy używać',
  'workflows.create.whenToUsePlaceholder': 'Kiedy agent powinien użyć tego przepływu pracy?',
  'workflows.create.optional': '(opcjonalne)',
  'workflows.create.createBtn': 'Utwórz przepływ pracy',
  'workflows.create.creating': 'Creating…',
  'workflows.create.createError': 'Nie udało się utworzyć przepływu pracy',
  'workflows.create.successTitle': 'Przepływ pracy utworzony',
  'workflows.create.successMessage': 'został pomyślnie utworzony.',
  'workflows.deleteConfirm.title': 'Usuń przepływ pracy',
  'workflows.deleteConfirm.body': 'Usunąć „{name}”? Tej operacji nie można cofnąć.',
  ...
  'workflows.detail.noPhases': 'Brak zdefiniowanych faz.',
  'workflows.detail.loadError': 'Nie udało się załadować pełnego przepływu pracy',
  'workflows.phase.rules': 'Rules',
  'workflows.phase.rules.empty': 'Brak reguł.',
  'workflows.phase.scripts': 'Scripts',
  'workflows.phase.scripts.empty': 'Brak skryptów.',
  'workflows.phase.toolScope': 'Zakres narzędzi',
  'workflows.phase.toolScope.allow': 'Allow',
  'workflows.phase.toolScope.deny': 'Deny',
  'workflows.phase.toolScope.inherited': 'Odziedziczone z domyślnych ustawień przepływu pracy.',
  'workflows.phase.toolScope.empty': 'Brak ograniczeń narzędzi.',
  'workflows.phase.context': 'Context',
  'workflows.phase.context.empty': 'Brak dostawców kontekstu.',
  ...
  'composer.settings.loadingModels': 'Ładowanie modeli…',
