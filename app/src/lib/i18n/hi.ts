...
const messages: TranslationMap = {
  ...
  'conversations.backgroundTasks.inboxReady': '{count} तैयार',
  'conversations.backgroundTasks.inboxInFlight': '{count} चल रहा है',
  'conversations.backgroundTasks.memoryJobTitle': 'मेमोरी सिंक',
  'conversations.backgroundTasks.cancelJob': 'रद्द करें',
  ...
  'nav.discord': 'हमारे Discord से जुड़ें',
  ...
  'skills.explorer.colSkill': 'स्किल',
  'skills.explorer.colDescription': 'विवरण',
  'skills.explorer.colProvider': 'प्रदाता',
  'skills.explorer.colAction': 'कार्रवाई',
  'sync.runs': 'सिंक रन',
  'sync.totalCost': 'कुल',
  'sync.when': 'कब',
  'sync.source': 'स्रोत',
  ...
  'sync.status.partial': 'प्राप्त हुआ, मेमोरी में दर्ज नहीं हुआ',
  'sync.nowSyncing.title': 'अभी सिंक हो रहा है',
  'sync.nowSyncing.empty': 'अभी कुछ भी सिंक नहीं हो रहा है।',
  'common.error': 'एरर',
  'common.success': 'सफल',
  'common.back': 'वापस',
  'common.next': 'आगे',
  ...
  'settings.tokenUsage.savingsTitle': 'बचत',
  'settings.tokenUsage.attributedTo': '{model} के लिए लागत निर्धारित',
  'settings.tokenUsage.tokensSaved': 'बचाए गए टोकन',
  'settings.tokenUsage.costSaved': 'बचाई गई लागत',
  'settings.tokenUsage.cacheOccupancy': 'कैश की गई मूल प्रतियाँ',
  'settings.tokenUsage.compactions': 'संपीड़न',
  'settings.tokenUsage.overEvents': '{count} संपीड़न में',
  'settings.tokenUsage.byCompressor': 'कंप्रेसर के अनुसार',
  ...
  'home.statusHostedStopped':
    'क्लाउड कनेक्शन रुक गया है: इंटीग्रेशन और चैनल फिर से चालू करने के लिए दोबारा साइन इन करें। चैट काम करती रहेगी।',
  ...
  'chat.newWindowPrompt': 'आज मैं आपकी कैसे मदद कर सकता हूँ?',
  'chat.welcomeSuggestion.calendarToday': 'आज मेरे कैलेंडर में क्या है?',
  'chat.welcomeSuggestion.unreadEmail': 'मेरे बिना पढ़े ईमेल का सारांश दो।',
  'chat.welcomeSuggestion.draftReply': 'मेरे पिछले संदेश का जवाब तैयार करो।',
  'chat.welcomeSuggestion.followUps': 'मैंने इस हफ़्ते किन चीज़ों पर आगे बढ़ने को कहा था?',
  ...
  'chat.connectionState.dropped': 'कनेक्शन टूट गया। रन सर्वर पर चलता रहा।',
  'chat.connectionState.reconnect': 'फिर से कनेक्ट करें',
  'chat.connectionState.reconnecting': 'फिर से कनेक्ट हो रहा है',
  'chat.connectionState.resumed': 'स्ट्रीम फिर से शुरू हो गई।',
  ...
  'chat.reasoning.thinking': 'सोच रहा है',
  'chat.reasoning.thoughtFor': '{n} तक सोचा',
  'chat.reasoning.thoughtBriefly': 'थोड़ा सोचा',
  'chat.reasoning.thought': 'सोचा',
  'chat.reasoning.elapsedSeconds': '{n} से',
  'chat.reasoning.elapsedMinutes': '{m} मि {s} से',
  ...
  'connections.tabs.browser': 'ब्राउज़र नियंत्रण',
  'connections.browser.description': 'ब्राउज़र कार्य सेट करें और तैयारी जाँचें।',
  'connections.earlyAlphaNotice':
    'प्रारंभिक अल्फ़ा: ब्राउज़र और डेस्कटॉप नियंत्रण का अभी परीक्षण चल रहा है। क्रियाएँ अप्रत्याशित ढंग से काम कर सकती हैं या नए संस्करणों में बदल सकती हैं।',
  'connections.browser.module': 'मॉड्यूल',
  'connections.browser.chrome': 'Chrome',
  'connections.browser.unknown': 'अज्ञात',
  'connections.browser.notVerified': 'जाँच नहीं हुई',
  'connections.browser.localOverride': 'रिलीज़ फ़ाइलें आने तक स्थानीय मॉड्यूल आवश्यक है।',
  'connections.browser.testModule': 'मॉड्यूल जाँचें',
  'connections.browser.enabled': 'ब्राउज़र चालू करें',
  'connections.browser.headless': 'बिना विंडो',
  'connections.browser.width': 'विंडो की चौड़ाई',
  'connections.browser.height': 'विंडो की ऊँचाई',
  'connections.browser.chromePath': 'Chrome पथ (वैकल्पिक)',
  'connections.browser.profileMode': 'प्रोफ़ाइल',
  'connections.browser.fresh': 'नई प्रोफ़ाइल',
  'connections.browser.persistent': 'स्थायी प्रोफ़ाइल',
  'connections.browser.profilePath': 'प्रोफ़ाइल फ़ोल्डर',
  'connections.browser.downloadDir': 'डाउनलोड फ़ोल्डर',
  'connections.browser.maxSteps': 'अधिकतम कार्य चरण',
  'connections.browser.timeout': 'समय सीमा (सेकंड)',
  'connections.browser.allowedWebsites': 'अनुमत वेबसाइटें',
  'connections.browser.sharedPolicy': 'ब्राउज़र और वेब खोज की वेबसाइट नीति एक ही है।',
  'connections.browser.manageWebsites': 'अनुमत वेबसाइटें प्रबंधित करें',
  'connections.browser.jevRoute': 'Jev बिलिंग मार्ग',
  ...
  'connections.browser.chromeReady': 'Chrome तैयार है',
  'connections.browser.chromeNotReady': 'Chrome उपलब्ध नहीं',
  'connections.browser.readinessChecked': 'तैयारी जाँची गई',
  'connections.browser.boundsRequired':
    'चौड़ाई 320–3840, ऊँचाई 240–2160, चरण 1–100 और समय सीमा 5–600 सेकंड रखें।',
  'connections.browser.noneAllowed': 'कोई वेबसाइट अनुमत नहीं',
  'connections.browser.moduleChecked': 'मॉड्यूल जाँचा गया',
  ...
  'desktop.approvalSummary': '{app} में “{target}” पर {operation}',
  'desktop.action.click': 'क्लिक करें',
  'desktop.action.type_text': 'लिखें',
  'desktop.action.check': 'चुनें',
  'desktop.action.uncheck': 'चयन हटाएँ',
  'desktop.action.expand': 'फैलाएँ',
  'desktop.action.collapse': 'समेटें',
  'desktop.action.scroll': 'स्क्रॉल करें',
  ...
  'desktop.moduleUnavailable':
    'डेस्कटॉप मॉड्यूल उपलब्ध नहीं है। इसकी स्थिति जाँचकर फिर कोशिश करें।',
  'desktop.pendingUnavailable':
    'लंबित डेस्कटॉप अनुमोदन लोड नहीं हो सके। फिर कोशिश करने के लिए रीफ़्रेश करें।',
  'desktop.unsupported': 'इस रनटाइम में डेस्कटॉप नियंत्रण उपलब्ध नहीं है।',
  'desktop.localOnly': 'यह सेटिंग केवल इस कंप्यूटर पर लागू होती है।',
  'desktop.permissions': 'सिस्टम अनुमतियाँ',
  'desktop.permission.accessibility': 'एक्सेसिबिलिटी',
  'desktop.permission.screen_recording': 'स्क्रीन रिकॉर्डिंग',
  'desktop.openSettings': 'सेटिंग्स खोलें',
  'desktop.captureNote':
    'स्क्रीन रिकॉर्डिंग केवल स्क्रीनशॉट के लिए चाहिए। ऐप्स देखने और नियंत्रित करने के लिए एक्सेसिबिलिटी चाहिए।',
  'desktop.testDescription': 'जाँचें कि कोर इस कंप्यूटर पर चल रहे ऐप्स देख सकता है।',
  'desktop.testButton': 'डेस्कटॉप एक्सेस जाँचें',
  'desktop.testPassed': 'डेस्कटॉप एक्सेस काम कर रहा है।',
  'desktop.testFailed': 'डेस्कटॉप एक्सेस सत्यापित नहीं हो सका।',
  ...
  'memoryTree.status.jobQueue':
    'मेमोरी कार्य: {ready} प्रतीक्षा में, {running} चल रहे हैं, {failed} विफल',
  ...
  'mcp.tab.tablistAria': 'MCP दृश्य',
  'mcp.rows.showTools': '{name} के टूल दिखाएँ',
  'mcp.rows.hideTools': '{name} के टूल छिपाएँ',
  'mcp.rows.toolsLoading': 'टूल पढ़े जा रहे हैं…',
  'mcp.rows.toolsFailed': 'टूल पढ़े नहीं जा सके।',
  'mcp.rows.add': 'सर्वर जोड़ें',
  'mcp.rows.edit': '{name} संपादित करें',
  'mcp.form.addTitle': 'MCP सर्वर जोड़ें',
  'mcp.form.editTitle': '{name} संपादित करें',
  'mcp.form.subtitle':
    'एक स्थानीय कमांड या दूरस्थ एंडपॉइंट, और प्रमाणीकरण के लिए जो चाहिए। आपकी mcp.json में लिखा जाता है।',
  'mcp.form.name': 'नाम',
  'mcp.form.nameHint': 'अक्षर, अंक, बिंदु, डैश। यह mcp.json में कुंजी है।',
  'mcp.form.transport': 'ट्रांसपोर्ट',
  'mcp.form.transportStdio': 'स्थानीय कमांड (stdio)',
  'mcp.form.transportHttp': 'दूरस्थ URL (HTTP)',
  'mcp.form.command': 'कमांड',
  'mcp.form.args': 'आर्ग्युमेंट',
  'mcp.form.argsHint': 'स्पेस से अलग करें; स्पेस वाले आर्ग्युमेंट को उद्धरण चिह्नों में रखें।',
  'mcp.form.env': 'एनवायरनमेंट वेरिएबल',
  'mcp.form.envHint':
    'कमांड को दिए जाते हैं। मान एन्क्रिप्ट करके संग्रहीत होते हैं और फिर कभी नहीं दिखाए जाते।',
  ...
  'mcp.form.authNone': 'कोई नहीं',
  'mcp.form.authBearer': 'Bearer टोकन',
  'mcp.form.authHeader': 'कस्टम हेडर',
  'mcp.form.authOauth': 'ब्राउज़र से साइन इन करें (OAuth)',
  'mcp.form.token': 'टोकन',
  'mcp.form.tokenHint': 'Authorization: Bearer <token> के रूप में भेजा जाता है।',
  'mcp.form.headerName': 'हेडर नाम',
  'mcp.form.headerValue': 'हेडर मान',
  'mcp.form.oauthHint':
    'सेव करने के बाद आपका ब्राउज़र सर्वर का साइन-इन पेज खोलता है; लौटने पर कनेक्शन पूरा होता है।',
  'mcp.form.add': 'सर्वर जोड़ें',
  'mcp.form.save': 'सेव करें',
  'mcp.form.saveAndSignIn': 'सेव करें और साइन इन करें',
  'mcp.form.saving': 'सेव हो रहा है…',
  'mcp.form.saveFailed': 'सर्वर सेव नहीं किया जा सका।',
  'mcp.rows.title': 'इंस्टॉल किए गए सर्वर',
  'mcp.rows.intro':
    'mcp.json में घोषित, वे MCP सर्वर जिन्हें आपका एजेंट कॉल कर सकता है। क्रेडेंशियल और टूल देखने के लिए सर्वर खोलें।',
  'mcp.rows.open': '{name} खोलें',
  'mcp.rows.connect': '{name} कनेक्ट करें',
  'mcp.rows.disconnect': '{name} डिस्कनेक्ट करें',
  'mcp.rows.enable': '{name} सक्षम करें',
  'mcp.rows.disable': '{name} अक्षम करें',
  'mcp.rows.remove': '{name} हटाएँ',
  'mcp.rows.removeTitle': '{name} हटाएँ?',
  'mcp.rows.removeBody':
    'सर्वर और उसके संग्रहीत क्रेडेंशियल हटा दिए जाएँगे। mcp.json में फिर से घोषित करने पर शुरुआत से शुरू होगा।',
  'mcp.rows.opFailed': 'कार्रवाई विफल रही।',
  ...
  'mcp.tab.action.openPage': 'पेज खोलें',
  ...
  'mcp.json.saving': 'सेव हो रहा है…',
  'mcp.json.save': 'सेव करें',
  'mcp.json.revert': 'पूर्ववत करें',
  ...
  'voice.providers.desc':
    'चुनें कि आपकी आवाज़ किस होस्टेड इंजन से ट्रांसक्राइब हो और सिंथेसिस कहाँ चले। वाक्-से-पाठ हमेशा क्लाउड में चलता है; केवल सिंथेसिस के लिए स्थानीय विकल्प (Piper) है, जिसे Install locally बटन से इंस्टॉल करें। PIPER_BIN की मैन्युअल सेटअप ज़रूरत नहीं।',
  'voice.providers.sttProvider': 'वाक्-से-पाठ प्रदाता',
  'voice.providers.sttProviderAria': 'एसटीटी प्रदाता',
  'voice.providers.backendSttProxy': 'बादल (कानाफूसी प्रॉक्सी)',
  ...
  'memorySources.stage.requested': 'शुरू हो रहा है',
  'memorySources.stage.running': 'सिंक हो रहा है',
  'memorySources.stage.fetching': 'प्राप्त किया जा रहा है',
  'memorySources.stage.stored': 'सहेजा जा रहा है',
  'memorySources.stage.queued': 'मेमोरी में जोड़ा जा रहा है',
  'memorySources.stage.ingesting': 'मेमोरी में जोड़ा जा रहा है',
  'memorySources.stage.unknown': 'सिंक हो रहा है',
  'time.justNow': 'अभी',
  ...
  'chat.approval.expiresIn': '{time} आलगय समाप्त होगा',
  'chat.elicitation.send': 'भेजें',
  'chat.elicitation.decline': 'अस्वीकार करें',
  'chat.elicitation.needsInput': 'इनपुट आवश्यक',
  'chat.elicitation.sentTo': '{server} को भेजा गया',
  'chat.elicitation.declined': 'अस्वीकृत',
  'chat.elicitation.title': 'आपकी प्रतिक्रिया आवश्यक हे',
  ...
  'conversations.composer.context.usage': 'कॉन्टेक्स्ट उपयोग',
  'conversations.composer.context.full': '{percent}% भरा',
  'conversations.composer.context.reasoning': 'तर्क',
  'conversations.composer.context.headroom': 'शेष स्थान',
  'conversations.composer.context.meterLabel': '{label} कॉन्टेक्स्ट उपयोग',
  'conversations.composer.context.meterValue': '{limit} में से {used}',
  'conversations.composer.context.loading': 'कॉन्टेक्स्ट मापा जा रहा है…',
  'conversations.composer.context.errorTitle': 'कॉन्टेक्स्ट विवरण उपलब्ध नहीं',
  ...
  'conversations.composer.command.new': 'नई बातचीत शुरू करें',
  'conversations.composer.command.stop': 'चल रहा जवाब रोकें',
  'conversations.composer.command.plan': 'पहले योजना: कुछ भी चलने से पहले चरण देखें',
  'conversations.composer.command.build': 'बिल्ड: एजेंट को सीधे काम करने दें',
  'conversations.composer.trigger.back': 'वापस',
  'conversations.composer.trigger.loading': 'लोड हो रहा है…',
  'conversations.composer.trigger.emptyCategories': 'कोई आइटम उपलब्ध नहीं',
  'conversations.composer.slash.empty': 'कोई मेल खाता कमांड नहीं',
  'conversations.composer.mention.empty': 'कोई मेल खाता आइटम नहीं',
  'conversations.composer.mention.memory': 'मेमोरी',
  'conversations.composer.mention.files': 'फ़ाइलें',
  ...
  'conversations.planReview.approve': 'स्वीकृत करें और चलाएँ',
  'conversations.planReview.reject': 'अस्वीकार करें',
  'conversations.planReview.feedbackLabel': 'बदलाव का अनुरोध करें',
  'conversations.planReview.feedbackPlaceholder': 'वर्णन करें कि क्या बदलना है…',
  'conversations.planReview.sendFeedback': 'प्रतिक्रिया भेजें',
  'conversations.planReview.revise': 'संशोधित करें',
  'conversations.runMode.plan': 'योजना',
  'conversations.runMode.build': 'बिल्ड',
  'conversations.runMode.toggleLabel': 'योजना और बिल्ड मोड के बीच स्विच करें',
  ...
  'conversations.tools.inspectDesktop.active': 'डेस्कटॉप की जाँच की जा रही है',
  'conversations.tools.inspectDesktop.done': 'डेस्कटॉप की जाँच की गई',
  'conversations.tools.controlDesktop.active': 'डेस्कटॉप नियंत्रित किया जा रहा है',
  'conversations.tools.controlDesktop.done': 'डेस्कटॉप नियंत्रित किया गया',
  ...
  'conversations.tools.document.title': 'दस्तावेज़',
  'conversations.tools.presentation.title': 'प्रस्तुति',
  ...
  'conversations.subagent.transcript.instruction': 'निर्देश',
  'conversations.subagent.transcript.agent': 'एजेंट',
  'conversations.subagent.transcript.system': 'सिस्टम',
  'conversations.tasks.taskOne': 'कार्य',
  'conversations.tasks.taskOther': 'कार्य',
  'conversations.tasks.running': 'चल रहा है',
  'conversations.tasks.waitingForInput': 'इनपुट की प्रतीक्षा में',
  'conversations.tasks.done': 'पूर्ण',
  'conversations.tasks.failed': 'विफल',
  'conversations.tasks.of': 'में से',
  ...
  'conversations.memoryChips.remembered': '{n} याद रखा गया',
  'conversations.memoryChips.idle': 'स्मृति',
  'conversations.memoryChips.forgetAriaLabel': '"{text}" भूल जाएं',
  'conversations.scheduleCard.next': 'अगला',
  'conversations.scheduleCard.paused': 'रुका हुआ',
  'conversations.scheduleCard.recentRuns': 'हाल की रन',
  'conversations.scheduleCard.ok': 'ठीक',
  'conversations.scheduleCard.failed': 'विफल',
  'conversations.conversationSearch.placeholder': 'बातचीत में खोजें',
  'conversations.conversationSearch.previousMatch': 'पिछला मिलान',
  'conversations.conversationSearch.nextMatch': 'अगला मिलान',
  'conversations.conversationSearch.timelineToggle': 'समयरेखा',
  ...
  'intelligence.teams.member.start': 'शुरू करें',
  'intelligence.teams.composer.placeholder': 'साथी को संदेश…',
  'intelligence.teams.composer.send': 'भेजें',
  'intelligence.teams.composer.recipient': 'प्राप्तकर्ता',
  ...
  'notifications.flow.approveTitle': 'वर्कफ़्लो को अनुमोदन की आवश्यकता है',
  'notifications.flow.approve': 'अनुमोदित करें',
  'notifications.flow.approving': 'अनुमोदित किया जा रहा है…',
  'notifications.flow.dismiss': 'खारिज करें',
  'notifications.flow.error': 'वर्कफ़्लो फिर से शुरू नहीं हो सका। कृपया पुनः प्रयास करें।',
  ...
  'flowRuns.inspector.output': 'कच्चा आउटपुट दिखाएं',
  'flowRuns.inspector.summary.failedPrefix': 'पूरा नहीं हो सका:',
  'flowRuns.inspector.summary.unknownError': 'कुछ गड़बड़ हो गई',
  'flowRuns.inspector.summary.itemsFetched': '{count} आइटम प्राप्त हुए',
  'flowRuns.inspector.summary.completed': 'चरण पूरा हुआ',
  'flowRuns.inspector.summary.noOutput': 'कोई आउटपुट नहीं बना',
  ...
  'flows.page.emptyTitle': 'अभी तक कोई वर्कफ़्लो नहीं',
  ...
  'flows.list.runNow': 'चलाएं',
  'flows.list.running': 'चल रहा है…',
  'flows.list.viewRuns': 'रन देखें',
  ...
  'flows.nodeKind.tool_call': 'टूल कॉल',
  'flows.nodeKind.http_request': 'HTTP अनुरोध',
  'flows.nodeKind.code': 'कोड',
  'flows.nodeKind.condition': 'शर्त',
  'flows.nodeKind.switch': 'स्विच',
  'flows.nodeKind.merge': 'मर्ज करें',
  'flows.nodeKind.split_out': 'स्प्लिट आउट',
  ...
  'flows.nodeSummary.trigger.appEvent': 'ऐप इवेंट पर चलता है',
  'flows.nodeSummary.trigger.unknownKind': 'ट्रिगर: {kind}',
  'flows.nodeSummary.agent.defaultModel': 'डिफ़ॉल्ट मॉडल',
  'flows.nodeSummary.agent.withPrompt': '“{prompt}” · {model}',
  'flows.nodeSummary.agent.default': '{model} से पूछता है',
  'flows.nodeSummary.toolCall.runsNative': '{name} चलाता है',
  'flows.nodeSummary.toolCall.pickNative': 'एक OpenHuman टूल चलाता है (एक चुनें)',
  'flows.nodeSummary.toolCall.runs': '{slug} चलाता है',
  'flows.nodeSummary.toolCall.pick': 'एक ऐप एक्शन चलाता है (एक चुनें)',
  'flows.nodeSummary.http.withUrl': '{method} {url}',
  'flows.nodeSummary.http.noUrl': '{method} अनुरोध (एक URL सेट करें)',
  'flows.nodeSummary.code.runs': '{lang} कोड चलाता है',
  'flows.nodeSummary.condition.withField': 'यदि {field} → सही / गलत',
  'flows.nodeSummary.condition.default': 'सही / गलत में शाखा बनाता है',
  'flows.nodeSummary.switch.byExpr': '{expr} के अनुसार रूट करता है',
  'flows.nodeSummary.switch.byExprWithRoutes': '{expr} के अनुसार रूट करता है ({count} मार्ग)',
  'flows.nodeSummary.switch.byValue': 'एक मान के अनुसार रूट करता है',
  'flows.nodeSummary.switch.byValueWithRoutes': 'एक मान के अनुसार रूट करता है ({count} मार्ग)',
  'flows.nodeSummary.merge': 'समानांतर शाखाओं को मर्ज करता है',
  'flows.nodeSummary.splitOut.withPath': 'हर {path} को विभाजित करता है',
  'flows.nodeSummary.splitOut.default': 'एक सूची को आइटम में विभाजित करता है',
  'flows.nodeSummary.transform.default': 'हर आइटम को फिर से आकार देता है',
  'flows.nodeSummary.transform.setFieldsSingular': 'हर आइटम पर {n} फ़ील्ड सेट करता है',
  'flows.nodeSummary.transform.setFieldsPlural': 'हर आइटम पर {n} फ़ील्ड सेट करता है',
  'flows.nodeSummary.outputParser': 'पिछले आउटपुट को पार्स करता है',
  'flows.nodeSummary.subWorkflow': 'एक नेस्टेड वर्कफ़्लो चलाता है',
  'flows.nodeSummary.memory.flavourWith': '"{flavour}" शैली पढ़ता है',
  'flows.nodeSummary.memory.flavour': 'एक मेमोरी शैली पढ़ता है',
  'flows.nodeSummary.memory.people': 'लोगों की मेमोरी खोजता है',
  'flows.nodeSummary.memory.remember': 'इस वर्कफ़्लो में एक मान याद रखता है',
  'flows.nodeSummary.memory.forget': 'इस वर्कफ़्लो से एक मान भूल जाता है',
  'flows.nodeSummary.memory.searchScoped': 'मेमोरी खोजता है ({scope})',
  'flows.nodeSummary.memory.search': 'मेमोरी खोजता है',
  'flows.nodeSummary.memory.recallScoped': 'मेमोरी से याद करता है ({scope})',
  ...
  'flows.cron.customSchedule': 'कस्टम शेड्यूल ({expr})',
  'flows.cron.noScheduleSet': 'कोई शेड्यूल सेट नहीं है',
  'flows.cron.weekdays': 'कार्यदिवस',
  'flows.cron.weekends': 'सप्ताहांत',
  'flows.cron.everyMinute': 'हर मिनट',
  'flows.cron.everyMinuteOnDays': '{days} को हर मिनट',
  'flows.cron.everyNMinutes': 'हर {n} मिनट',
  'flows.cron.everyNMinutesOnDays': '{days} को हर {n} मिनट',
  'flows.cron.everyHour': 'हर घंटे',
  'flows.cron.everyHourOnDays': '{days} को हर घंटे',
  'flows.cron.everyNHours': 'हर {n} घंटे',
  'flows.cron.everyNHoursOnDays': '{days} को हर {n} घंटे',
  'flows.cron.everyDayAtTime': 'हर दिन {time} बजे',
  'flows.cron.atTimeOnDays': '{days} को {time} बजे',
  'flows.cron.invalidInterval': 'अमान्य अंतराल',
  'flows.cron.dailyEvery24h': 'दैनिक (हर 24 घंटे)',
  'flows.cron.everyNDays': 'हर {n} दिन',
  'flows.cron.everyNHoursShort': 'हर {n} घंटे',
  'flows.cron.everyNMinutesShort': 'हर {n} मिनट',
  'flows.cron.everySecond': 'हर सेकंड',
  'flows.cron.everyNSeconds': 'हर {n} सेकंड',
  'flows.cron.onceAtRaw': '{at} पर एक बार',
  'flows.cron.onceAt': '{at} पर एक बार',
  ...
  'settings.ai.providers.groupLocal': 'लोकल रनटाइम',
  'settings.ai.providers.groupCli': 'CLI लॉगिन',
  'settings.ai.providers.cliDetail': 'किसी अन्य CLI के मौजूदा लॉगिन का उपयोग करता है',
  'settings.ai.providers.connected': 'कनेक्टेड',
  'settings.ai.providers.managedDetail': 'OpenHuman हर काम के लिए मॉडल चुनता है',
  'settings.ai.providers.rowActions': '{provider} के लिए और विकल्प',
  ...
  'settings.ai.providers.addProviderSubtitle':
    'जोड़ने के लिए प्रदाता चुनें। आप कभी भी और जोड़ सकते हैं।',
  'settings.ai.providers.placeholderCloud': 'क्लाउड प्रदाता चुनें…',
  'settings.ai.providers.placeholderLocal': 'लोकल रनटाइम चुनें…',
  ...
  'settings.ai.providers.localDetail': 'इसी डिवाइस पर चलता है',
  ...
  'settings.ai.routing.defaultModel': 'डिफ़ॉल्ट मॉडल',
  'settings.ai.routing.defaultModelDesc':
    'वह मॉडल जिस पर प्रबंधित चैट टर्न चलता है। नीचे के जो कार्यभार प्रबंधित रहते हैं, वे इसका उपयोग करते हैं।',
  'settings.ai.routing.defaultModelUnset': 'सेट नहीं',
  ...
  'settings.theme.variantAuto': 'स्वचालित',
  'settings.theme.variantAria': 'थीम वैरिएंट',
  'settings.theme.backdropHeading': 'पृष्ठभूमि',
  'settings.theme.backdrop.mesh': 'मेश',
  ...
  'settings.theme.group.accents': 'एक्सेंट रंग',
  'settings.theme.showShades': 'सभी एक्सेंट शेड दिखाएँ',
  'settings.theme.hideShades': 'सभी एक्सेंट शेड छिपाएँ',
  'settings.theme.fontsHeading': 'फ़ॉन्ट',
  'settings.theme.fontRole.title': 'शीर्षक',
  'settings.theme.fontRole.heading': 'मथालेख',
  'settings.theme.fontRole.body': 'मुख्य पाठ',
  'settings.theme.fontRole.mono': 'मोनोस्पेस',
  'settings.theme.fontRole.serif': 'सेरिफ़',
  'settings.theme.fontCurrent': 'वर्तमान',
  'settings.theme.actions': 'थीम प्रबंधित करें',
  'settings.theme.reset': 'ओवरराइड रीसेट करें',
  'settings.theme.delete': 'थीम हटाएँ',
  ...
  'skills.setup.voice.sttNotReadyDesc':
    'Voice Intelligence को एक चालू वाक्-से-पाठ इंजन चाहिए। सेटिंग्स › वॉइस में जाकर एक चुनें।',
  ...
  'walletBalances.earlyAlphaNotice':
    'प्रारंभिक अल्फ़ा: वॉलेट बैलेंस का अभी परीक्षण चल रहा है। राशि और समर्थित नेटवर्क नए संस्करणों में बदल सकते हैं।',
  'walletBalances.allNetworks': 'सभी नेटवर्क',
  'walletBalances.manageTokens': 'टोकन प्रबंधित करें',
  'walletBalances.noFilterMatches': 'आपके फ़िल्टर से कोई बैलेंस मेल नहीं खाता',
  'walletBalances.colToken': 'टोकन',
  ...
  'composer.settings.loadingModels': 'मॉडल लोड हो रहे हैं…',
  ...
  'settings.ai.openaiOauthTitle': 'ChatGPT से साइन इन करें',
  'settings.ai.openaiOauthDescription':
    'API कुंजी के बिना OpenAI मॉडल उपयोग करने के लिए अपने ChatGPT खाते से साइन इन करें।',
  'settings.ai.openaiOauthConnect': 'ChatGPT से साइन इन करें',
  'settings.ai.openaiOauthConnected': 'ChatGPT से कनेक्टेड',
  'settings.ai.openaiOauthOpening': 'साइन-इन खोला जा रहा है…',
  'settings.ai.openaiOauthCallbackHint':
    'साइन इन करने के बाद अपने ब्राउज़र से पूरा रीडायरेक्ट URL चिपकाएँ (http://127.0.0.1:1455/ से शुरू होता है)।',
  'settings.ai.openaiOauthCallbackPlaceholder':
    'http://127.0.0.1:1455/auth/callback?code=...&state=...',
  'settings.ai.openaiOauthFinish': 'ChatGPT साइन-इन पूरा करें',
  'settings.ai.openaiOauthDisconnect': 'ChatGPT डिस्कनेक्ट करें',
  'settings.ai.openaiOauthDesktopOnly': 'ChatGPT साइन-इन केवल डेस्कटॉप ऐप में उपलब्ध है।',
  'settings.ai.openaiOauthStartError':
    'ChatGPT साइन-इन शुरू नहीं हो सका। फिर कोशिश करें या API कुंजी का उपयोग करें।',
  ...
  'settings.ai.openaiOauthCallbackRequired':
    'साइन इन करने के बाद अपने ब्राउज़र से रीडायरेक्ट URL चिपकाएँ।',
  'settings.ai.openaiOauthDisconnectError': 'ChatGPT डिस्कनेक्ट नहीं हो सका। कृपया फिर कोशिश करें।',
  ...
  'common.notAvailable': 'एन/ए',
  'settings.ai.resetsAt': '{time} पर रीसेट होगा',
  'settings.ai.usedAmount': '{amount} उपयोग किया गया',
  ...
  'settings.ai.burnRateSampleDetail': '{hours} घंटे के नमूने में {rows} पंक्ति/घंटा',
  'settings.ai.needTimestampsForBurnRate': 'कम से कम दो खर्च पंक्तियों के टाइमस्टैंप चाहिए।',
  'settings.ai.projectedEmptyDetail': 'हालिया खर्च दर पर अंतिम खर्च के {hours} घंटे बाद',
  'settings.ai.noProjectionWithoutSpend': 'हालिया प्रति घंटा खर्च के बिना कोई अनुमान नहीं।',
  'settings.ai.readsPerDollar': '{count} रीड/$',
  'settings.ai.apiReadsFormula': 'बैकग्राउंड API रीड/सप्ताह / शेष = {reads} / {remaining}',
  'settings.ai.needUsageToEstimate': 'अनुमान के लिए उपयोग प्रतिक्रिया चाहिए।',
  ...
  'skills.category.all': 'सभी',
  'skills.category.builtIn': 'बिल्ट-इन',
  'skills.category.channels': 'चैनल',
  'skills.category.productivity': 'प्रोडक्टिविटी',
  'skills.category.chat': 'चैट',
  'skills.category.toolsAutomation': 'टूल्स और ऑटोमेशन',
  'skills.category.social': 'सोशल',
  'skills.category.platform': 'प्लेटफ़ॉर्म',
  'skills.category.other': 'अन्य',
  'workspace.wipeSuccessTitle': 'मेमोरी मिटा दी गई',
  'workspace.wipeSuccessMessage':
    '{rows} पंक्ति और {dirs} फ़ोल्डर हटाए गए; {cursors} सिंक-स्थिति कर्सर साफ़ किए गए। फिर से भरने के लिए किसी जुड़े स्रोत पर सिंक पर क्लिक करें।',
  'workspace.wipeFailedTitle': 'रीसेट विफल',
  'workspace.resetTreeSuccessTitle': 'मेमोरी ट्री का पुनर्निर्माण हो रहा है',
  'workspace.resetTreeSuccessMessage':
    '{treeRows} ट्री पंक्ति हटाई गई; {chunks} अंश फिर से कतार में डाले गए ({jobs} एक्सट्रैक्ट कार्य)। वर्कर के आगे बढ़ने पर ग्राफ़ फिर से भर जाएगा।',
  'workspace.resetTreeFailedTitle': 'मेमोरी ट्री रीसेट नहीं की जा सकी',
  'workspace.buildTreesFailedTitle': 'सार ट्री नहीं बनाए जा सके',
  'invites.redeemHeading': 'क्या आपके पास रेफ़रल कोड है?',
  'invites.redeemPlaceholder': 'रेफ़रल कोड',
  'invites.redeemSubmit': 'रिडीम करें',
};
