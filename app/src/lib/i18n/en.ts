...
const en: TranslationMap = {
  ...
  'settings.tokenUsage.saved': 'Saved',
  ...
  'chat.welcomeSuggestion.calendarToday': "What's on my calendar today?",
  'chat.welcomeSuggestion.unreadEmail': 'Summarize my unread email.',
  'chat.welcomeSuggestion.draftReply': 'Draft a reply to my last message.',
  'chat.welcomeSuggestion.followUps': "What did I say I'd follow up on this week?",
  ...
  'chat.connectionState.dropped': 'Connection lost. The run kept going on the server.',
  'chat.connectionState.reconnect': 'Reconnect',
  'chat.connectionState.reconnecting': 'Reconnecting',
  'chat.connectionState.resumed': 'Picked the stream back up.',
  ...
  'chat.reasoning.thoughtFor': 'Thought for {n}',
  'chat.reasoning.thoughtBriefly': 'Thought briefly',
  'chat.reasoning.thought': 'Thought',
  'chat.reasoning.elapsedSeconds': '{n}s',
  'chat.reasoning.elapsedMinutes': '{m}m {s}s',
  ...
  'skills.rows.remove': 'Remove {name}',
  ...
  'connections.browser.notVerified': 'Not verified',
  'connections.browser.localOverride':
    'A local module override is required until release archives are published.',
  'connections.browser.testModule': 'Test module',
  'connections.browser.enabled': 'Enable browser',
  'connections.browser.headless': 'Headless',
  'connections.browser.width': 'Viewport width',
  'connections.browser.height': 'Viewport height',
  'connections.browser.chromePath': 'Chrome path (optional)',
  'connections.browser.profileMode': 'Profile',
  'connections.browser.fresh': 'Fresh profile',
  'connections.browser.persistent': 'Persistent profile',
  'connections.browser.profilePath': 'Profile folder',
  'connections.browser.downloadDir': 'Download folder',
  'connections.browser.maxSteps': 'Maximum task steps',
  'connections.browser.timeout': 'Task timeout (seconds)',
  'connections.browser.allowedWebsites': 'Allowed websites',
  'connections.browser.sharedPolicy': 'Browser and web search share one website policy.',
  'connections.browser.manageWebsites': 'Manage allowed websites',
  'connections.browser.jevRoute': 'Jev billing route',
  ...
  'connections.browser.chromeReady': 'Chrome ready',
  'connections.browser.chromeNotReady': 'Chrome unavailable',
  'connections.browser.readinessChecked': 'Readiness checked',
  'connections.browser.boundsRequired':
    'Use width 320–3840, height 240–2160, steps 1–100, and timeout 5–600 seconds.',
  'connections.browser.noneAllowed': 'No websites allowed',
  'connections.browser.moduleChecked': 'Module checked',
  ...
  'desktop.action.click': 'Click',
  'desktop.action.type_text': 'Enter text in',
  'desktop.action.check': 'Check',
  'desktop.action.uncheck': 'Uncheck',
  ...
  'desktop.pendingUnavailable': 'Could not load pending desktop approvals. Refresh to try again.',
  'desktop.unsupported': 'Desktop control is unavailable in this runtime.',
  'desktop.localOnly': 'This setting applies only to this computer.',
  'desktop.permissions': 'System permissions',
  ...
  'desktop.testButton': 'Test desktop access',
  'desktop.testPassed': 'Desktop access works.',
  'desktop.testFailed': 'Desktop access could not be verified.',
  ...
  'settings.costDashboard.period': 'Period',
  'settings.costDashboard.periodDays': 'Last {days} days',
  'settings.costDashboard.all': 'All',
  'settings.costDashboard.costSource': 'Cost source',
  'settings.costDashboard.estimated': 'Estimated',
  'settings.costDashboard.providerCharged': 'Provider charged',
  'settings.costDashboard.searchModelSession': 'Model or session',
  'settings.costDashboard.filteredTotal': '{shown} of {loaded} loaded records • {cost}',
  ...
  'settings.costDashboard.subtitle':
    'Local provider-call usage. Costs may be estimated; hosted billing is separate.',
  ...
  'mcp.rows.showTools': "Show {name}'s tools",
  'mcp.rows.hideTools': "Hide {name}'s tools",
  'mcp.rows.toolsLoading': 'Reading the tools…',
  'mcp.rows.toolsFailed': "Couldn't read the tools.",
  'mcp.rows.add': 'Add server',
  ...
  'mcp.form.transportStdio': 'Local command (stdio)',
  'mcp.form.transportHttp': 'Remote URL (HTTP)',
  'mcp.form.command': 'Command',
  'mcp.form.args': 'Arguments',
  'mcp.form.argsHint': 'Space-separated; quote an argument that contains spaces.',
  'mcp.form.env': 'Environment variables',
  'mcp.form.envHint': 'Passed to the command. Values are stored encrypted and never shown again.',
  ...
  'mcp.form.authNone': 'None',
  'mcp.form.authBearer': 'Bearer token',
  'mcp.form.authHeader': 'Custom header',
  'mcp.form.authOauth': 'Sign in with browser (OAuth)',
  ...
  'mcp.form.saveFailed': 'Couldn’t save the server.',
  ...
  'mcp.tab.action.openPage': 'Open page',
  ...
  'mcp.json.saving': 'Saving…',
  'mcp.json.save': 'Save',
  'mcp.json.revert': 'Revert',
  ...
  'composio.connect.cancelNotConfirmed':
    'Composio did not confirm the connection was removed. Try again.',
  ...
  'conversations.composer.context.usage': 'Context usage',
  'conversations.composer.context.full': '{percent}% full',
  'conversations.composer.context.reasoning': 'Reasoning',
  'conversations.composer.context.headroom': 'Headroom',
  'conversations.composer.context.meterLabel': '{label} context usage',
  ...
  'conversations.composer.command.plan': 'Plan first: review the steps before anything runs',
  'conversations.composer.command.build': 'Build: let the agent act directly',
  'conversations.composer.trigger.back': 'Back',
  'conversations.composer.trigger.loading': 'Loading…',
  'conversations.composer.trigger.emptyCategories': 'No items available',
  'conversations.composer.slash.empty': 'No matching commands',
  'conversations.composer.mention.empty': 'No matching items',
  'conversations.composer.mention.memory': 'Memory',
  'conversations.composer.mention.files': 'Files',
  ...
  'conversations.planReview.revise': 'Revise',
  'conversations.runMode.plan': 'Plan',
  'conversations.runMode.build': 'Build',
  'conversations.runMode.toggleLabel': 'Switch between plan and build mode',
  ...
  'conversations.tools.inspectDesktop.active': 'Inspecting desktop',
  'conversations.tools.inspectDesktop.done': 'Inspected desktop',
  'conversations.tools.controlDesktop.active': 'Controlling desktop',
  'conversations.tools.controlDesktop.done': 'Controlled desktop',
  ...
  'conversations.tools.presentation.title': 'Presentation',
  ...
  'conversations.tasks.taskOne': 'task',
  'conversations.tasks.taskOther': 'tasks',
  'conversations.tasks.running': 'running',
  'conversations.tasks.waitingForInput': 'waiting for input',
  'conversations.tasks.done': 'done',
  'conversations.tasks.failed': 'failed',
  'conversations.tasks.of': 'of',
  ...
  'conversations.memoryChips.remembered': 'remembered {n}',
  'conversations.memoryChips.idle': 'memory',
  'conversations.memoryChips.forgetAriaLabel': 'Forget "{text}"',
  'conversations.scheduleCard.next': 'next',
  'conversations.scheduleCard.paused': 'paused',
  'conversations.scheduleCard.recentRuns': 'recent runs',
  'conversations.scheduleCard.ok': 'ok',
  'conversations.scheduleCard.failed': 'failed',
  'conversations.conversationSearch.placeholder': 'Find in conversation',
  'conversations.conversationSearch.previousMatch': 'Previous match',
  'conversations.conversationSearch.nextMatch': 'Next match',
  'conversations.conversationSearch.timelineToggle': 'Timeline',
  ...
  'notifications.flow.approveTitle': 'Workflow needs approval',
  'notifications.flow.approve': 'Approve',
  'notifications.flow.approving': 'Approving…',
  'notifications.flow.dismiss': 'Dismiss',
  ...
  'settings.ai.providers.groupLocal': 'Local runtimes',
  'settings.ai.providers.groupCli': 'CLI logins',
  'settings.ai.providers.cliDetail': 'Uses a login another CLI already holds',
  'settings.ai.providers.connected': 'Connected',
  ...
  'settings.ai.providers.placeholderCloud': 'Choose a cloud provider…',
  'settings.ai.providers.placeholderLocal': 'Choose a local runtime…',
  'settings.ai.providers.placeholderCli': 'Choose a CLI login…',
  'settings.ai.providers.helperCloud': 'Hosted models. You supply an API key.',
  'settings.ai.providers.helperLocal': 'Models running on this machine. You supply the endpoint.',
  ...
  'settings.ai.providers.localDetail': 'Runs on this machine',
  'settings.ai.localOllama': 'Local (Ollama)',
  'settings.ai.modelLabel': 'Model',
  'settings.ai.picker.title': 'Choose provider and model',
  'settings.ai.picker.subtitle': 'Search configured providers and available models.',
  'settings.ai.picker.useThisModel': 'Use this model',
  ...
  'settings.ai.burnRateSampleDetail': '{rows} rows/hr across {hours}h sample',
  'settings.ai.needTimestampsForBurnRate': 'Need timestamps from at least two spend rows.',
  'settings.ai.projectedEmptyDetail': '{hours}h after latest spend at recent burn rate',
  'settings.ai.noProjectionWithoutSpend': 'No projection without recent hourly spend.',
  'settings.ai.readsPerDollar': '{count} reads/$',
  ...
  'settings.mcpServer.tools.listSubagents': 'List available subagents',
  'settings.mcpServer.tools.runSubagent': 'Run a subagent with a prompt',
  'settings.mcpServer.tools.memorySearch': 'Search memory by semantic query',
  'settings.mcpServer.tools.memoryRecall': 'Recall specific memories by ID',
  'settings.mcpServer.tools.treeReadChunk': 'Read a memory tree chunk',
  ...
  'settings.theme.actions': 'Manage theme',
  'settings.theme.reset': 'Reset overrides',
  'settings.theme.delete': 'Delete theme',
  'settings.theme.export': 'Copy JSON',
  'settings.theme.copied': 'Copied!',
  ...
  'composer.settings.loadingModels': 'Loading models…',
