...
const messages: TranslationMap = {
  ...
  'conversations.backgroundTasks.inboxReady': '{count} siap',
  'conversations.backgroundTasks.inboxInFlight': '{count} berjalan',
  'conversations.backgroundTasks.memoryJobTitle': 'Sinkronisasi memori',
  'conversations.backgroundTasks.cancelJob': 'Batalkan',
  ...
  'chat.connectionState.dropped': 'Koneksi terputus. Proses tetap berjalan di server.',
  'chat.connectionState.reconnect': 'Sambungkan ulang',
  'chat.connectionState.reconnecting': 'Menyambungkan ulang',
  'chat.connectionState.resumed': 'Aliran dilanjutkan kembali.',
  ...
  'connections.tabs.browser': 'Kontrol peramban',
  'connections.browser.description': 'Atur tugas peramban dan periksa kesiapan.',
  'connections.earlyAlphaNotice':
    'Alfa awal: kontrol browser dan desktop masih diuji. Tindakan dapat berperilaku tidak terduga atau berubah antar-rilis.',
  'connections.browser.module': 'Modul',
  'connections.browser.chrome': 'Chrome',
  'connections.browser.unknown': 'Tidak diketahui',
  'connections.browser.notVerified': 'Belum diverifikasi',
  'connections.browser.localOverride': 'Modul lokal diperlukan sampai arsip rilis diterbitkan.',
  'connections.browser.testModule': 'Uji modul',
  'connections.browser.enabled': 'Aktifkan peramban',
  'connections.browser.headless': 'Tanpa tampilan',
  'connections.browser.width': 'Lebar tampilan',
  'connections.browser.height': 'Tinggi tampilan',
  'connections.browser.chromePath': 'Lokasi Chrome (opsional)',
  'connections.browser.profileMode': 'Profil',
  'connections.browser.fresh': 'Profil baru',
  'connections.browser.persistent': 'Profil tetap',
  'connections.browser.profilePath': 'Folder profil',
  'connections.browser.downloadDir': 'Folder unduhan',
  'connections.browser.maxSteps': 'Maksimum langkah',
  'connections.browser.timeout': 'Batas waktu (detik)',
  'connections.browser.allowedWebsites': 'Situs yang diizinkan',
  'connections.browser.sharedPolicy':
    'Peramban dan pencarian web memakai kebijakan situs yang sama.',
  'connections.browser.manageWebsites': 'Kelola situs yang diizinkan',
  'connections.browser.jevRoute': 'Rute tagihan Jev',
  ...
  'connections.browser.chromeReady': 'Chrome siap',
  'connections.browser.chromeNotReady': 'Chrome tidak tersedia',
  'connections.browser.readinessChecked': 'Kesiapan diperiksa',
  'connections.browser.boundsRequired':
    'Gunakan lebar 320–3840, tinggi 240–2160, langkah 1–100, dan batas waktu 5–600 detik.',
  'connections.browser.noneAllowed': 'Tidak ada situs yang diizinkan',
  'connections.browser.moduleChecked': 'Modul diperiksa',
  ...
  'desktop.approvalSummary': '{operation} “{target}” di {app}',
  'desktop.action.click': 'Klik',
  'desktop.action.type_text': 'Masukkan teks ke',
  'desktop.action.check': 'Centang',
  'desktop.action.uncheck': 'Hapus centang',
  ...
  'desktop.enabledPending':
    'Diaktifkan. Selesaikan penyiapan di bawah sebelum memakai alat desktop.',
  'desktop.moduleUnavailable': 'Modul desktop tidak tersedia. Periksa statusnya dan coba lagi.',
  'desktop.pendingUnavailable':
    'Persetujuan desktop yang tertunda tidak dapat dimuat. Segarkan untuk mencoba lagi.',
  'desktop.unsupported': 'Kontrol desktop tidak tersedia di lingkungan ini.',
  'desktop.localOnly': 'Pengaturan ini hanya berlaku untuk komputer ini.',
  'desktop.permissions': 'Izin sistem',
  'desktop.permission.accessibility': 'Aksesibilitas',
  'desktop.permission.screen_recording': 'Perekaman layar',
  'desktop.openSettings': 'Buka pengaturan',
  'desktop.captureNote':
    'Perekaman layar hanya diperlukan untuk tangkapan layar. Aksesibilitas diperlukan untuk memeriksa dan mengendalikan aplikasi.',
  'desktop.testDescription':
    'Periksa apakah inti dapat melihat aplikasi yang berjalan di komputer ini.',
  'desktop.testButton': 'Uji akses desktop',
  'desktop.testPassed': 'Akses desktop berfungsi.',
  'desktop.testFailed': 'Akses desktop tidak dapat diverifikasi.',
  ...
  'mcp.rows.showTools': 'Tampilkan alat {name}',
  'mcp.rows.hideTools': 'Sembunyikan alat {name}',
  'mcp.rows.toolsLoading': 'Membaca alat…',
  'mcp.rows.toolsFailed': 'Tidak dapat membaca alat.',
  'mcp.rows.add': 'Tambah server',
  ...
  'mcp.form.transportStdio': 'Perintah lokal (stdio)',
  'mcp.form.transportHttp': 'URL jarak jauh (HTTP)',
  'mcp.form.command': 'Perintah',
  ...
  'mcp.form.url': 'URL',
  'mcp.form.auth': 'Autentikasi',
  'mcp.form.authNone': 'Tidak ada',
  'mcp.form.authBearer': 'Token Bearer',
  'mcp.form.authHeader': 'Header kustom',
  'mcp.form.authOauth': 'Masuk dengan browser (OAuth)',
  ...
  'mcp.form.saving': 'Menyimpan…',
  'mcp.form.saveFailed': 'Tidak dapat menyimpan server.',
  ...
  'mcp.tab.action.openPage': 'Buka halaman',
  ...
  'mcp.json.saving': 'Menyimpan…',
  'mcp.json.save': 'Simpan',
  'mcp.json.revert': 'Kembalikan',
  ...
  'conversations.composer.context.usage': 'Penggunaan konteks',
  'conversations.composer.context.full': '{percent}% terisi',
  'conversations.composer.context.reasoning': 'Penalaran',
  'conversations.composer.context.headroom': 'Ruang tersisa',
  'conversations.composer.context.meterLabel': 'Penggunaan konteks {label}',
  'conversations.composer.context.meterValue': '{used} dari {limit}',
  'conversations.composer.context.loading': 'Mengukur konteks…',
  'conversations.composer.context.errorTitle': 'Rincian konteks tidak tersedia',
  ...
  'conversations.composer.trigger.emptyCategories': 'Tidak ada item',
  'conversations.composer.slash.empty': 'Tidak ada perintah yang cocok',
  'conversations.composer.mention.empty': 'Tidak ada item yang cocok',
  'conversations.composer.mention.memory': 'Memori',
  'conversations.composer.mention.files': 'Berkas',
  ...
  'conversations.planReview.revise': 'Revisi',
  'conversations.runMode.plan': 'Rencana',
  'conversations.runMode.build': 'Build',
  'conversations.runMode.toggleLabel': 'Beralih antara mode rencana dan build',
  ...
  'conversations.tools.inspectDesktop.active': 'Memeriksa desktop',
  'conversations.tools.inspectDesktop.done': 'Desktop diperiksa',
  'conversations.tools.controlDesktop.active': 'Mengendalikan desktop',
  'conversations.tools.controlDesktop.done': 'Desktop dikendalikan',
  ...
  'conversations.tools.document.title': 'Dokumen',
  'conversations.tools.presentation.title': 'Presentasi',
  ...
  'conversations.subagent.transcript.instruction': 'instruksi',
  'conversations.subagent.transcript.agent': 'agen',
  'conversations.subagent.transcript.system': 'sistem',
  'conversations.tasks.taskOne': 'tugas',
  'conversations.tasks.taskOther': 'tugas',
  'conversations.tasks.running': 'berjalan',
  'conversations.tasks.waitingForInput': 'menunggu masukan',
  'conversations.tasks.done': 'selesai',
  'conversations.tasks.failed': 'gagal',
  'conversations.tasks.of': 'dari',
  ...
  'conversations.memoryChips.remembered': '{n} diingat',
  'conversations.memoryChips.idle': 'memori',
  'conversations.memoryChips.forgetAriaLabel': 'Lupakan "{text}"',
  'conversations.scheduleCard.next': 'berikutnya',
  'conversations.scheduleCard.paused': 'dijeda',
  'conversations.scheduleCard.recentRuns': 'eksekusi terbaru',
  'conversations.scheduleCard.ok': 'ok',
  'conversations.scheduleCard.failed': 'gagal',
  'conversations.conversationSearch.placeholder': 'Cari dalam percakapan',
  'conversations.conversationSearch.previousMatch': 'Kecocokan sebelumnya',
  'conversations.conversationSearch.nextMatch': 'Kecocokan berikutnya',
  'conversations.conversationSearch.timelineToggle': 'Linimasa',
  ...
  'walletBalances.earlyAlphaNotice':
    'Alfa awal: saldo dompet masih diuji. Jumlah dan jaringan yang didukung dapat berubah antar-rilis.',
  'walletBalances.allNetworks': 'Semua jaringan',
  'walletBalances.manageTokens': 'Kelola token',
  'walletBalances.noFilterMatches': 'Tidak ada saldo yang cocok dengan filter',
