...
const messages: TranslationMap = {
  ...
  'conversations.toolFailure.notFound.next': 'কিছু করার দরকার নেই। সহকারী সঠিক নামটি খুঁজে আবার চেষ্টা করতে পারে।',
  'conversations.toolFailure.unsupported.cause': 'OpenHuman এখনও এটি স্বয়ংক্রিয়ভাবে করতে পারে না।',
  'conversations.toolFailure.unsupported.next': 'এটি নিজে করুন, অথবা অন্য একটি বিকল্প চান।',
