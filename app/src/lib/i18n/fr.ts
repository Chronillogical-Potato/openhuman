...
const messages: TranslationMap = {
  ...
  'share.modalSubtitle': 'Publiez ce que votre agent a fait sur X ou LinkedIn',
  'share.drafting': 'Création de votre carte...',
  'share.cardAlt': 'Aperçu de la carte de partage',
  'share.imageError': "Impossible de générer l'image. Réessayez.",
  'share.captionLabel': 'Légende',
  'share.captionPlaceholder': 'Rédigez une légende...',
  'share.privacyNote':
    "Seuls le titre, la légende, le nom de l'agent et la marque sont partagés. Votre conversation, votre mémoire et vos fichiers restent privés.",
  'share.defaultHeadline': 'Regardez ce que mon agent OpenHuman vient de faire',
  'share.defaultAgentName': 'Mon agent',
  'share.defaultCaption': 'Regardez ce que mon agent OpenHuman vient de faire.',
  'share.captionWithHeadline': '{headline}. Réalisé avec mon agent OpenHuman.',
  'share.linkedInHint': 'Légende copiée. Collez-la dans votre publication LinkedIn.',
  'share.shareX': 'Partager sur X',
  'share.shareLinkedIn': 'Partager sur LinkedIn',
  'share.copyImage': "Copier l'image",
  'share.copiedImage': 'Image copiée',
  'share.copyCaption': 'Copier la légende',
  'share.copiedCaption': 'Légende copiée',
  'brain.header.graph':
  ...
  'brain.welcome.nav': 'Bienvenue',
  'brain.welcome.eyebrow': 'Cerveau',
  'brain.welcome.title': 'La mémoire de votre agent, cartographiée',
  'brain.welcome.body':
    'Le Cerveau, c’est là où votre agent conserve ce qu’il sait: les personnes, conversations, sources et objectifs sur lesquels il s’appuie pour vous aider avec un vrai contexte plutôt que de repartir de zéro à chaque fois.',
  ...
  'feedback.welcome.nav': 'Bienvenue',
  'feedback.welcome.main': 'Tableau des retours',
  'feedback.welcome.eyebrow': 'Retours',
  'feedback.welcome.title': 'Aidez à façonner ce que nous construisons',
  'feedback.welcome.body':
    'Dites-nous ce qui fonctionne, ce qui manque et ce qui rendrait OpenHuman meilleur. Proposez une idée, votez pour celles des autres et regardez les meilleures remonter en tête de notre feuille de route.',
  'feedback.welcome.ctaShare': 'Partager une idée',
  ...
  'connections.welcome.featsLabel': 'Ce que vous pouvez faire ici',
  'connections.welcome.feat1Title': 'Intégrez vos canaux',
  'connections.welcome.feat1Body':
    'Slack, WhatsApp, Telegram, Gmail et bien d’autres: reliés en quelques clics.',
  'connections.welcome.feat2Title': 'Laissez votre agent agir',
  'connections.welcome.feat2Body':
    'Il lit, rédige et répond avec tout le contexte de ce qui est connecté.',
  'connections.welcome.feat3Title': 'Gardez le contrôle',
  'connections.welcome.feat3Body':
    'Accordez ou révoquez l’accès pour chaque canal, à tout moment. Rien ne s’exécute sans votre accord.',
  'alerts.header.desc': 'L’activité des agents et tout ce qui requiert votre attention.',
  'notifications.welcome.nav': 'Bienvenue',
  'notifications.welcome.main': 'Alertes',
  ...
  'rewards.welcome.nav': 'Bienvenue',
  'rewards.welcome.main': 'Récompenses',
  ...
  'rewards.welcome.feat3Body': 'Transformez vos points en coupons et récompenses.',
  'flows.welcome.nav': 'Bienvenue',
  'flows.welcome.main': 'Flux de travail',
  ...
  'privacy.mode.description':
    'Contrôle la quantité de vos données pouvant quitter cet appareil. Distinct du mode d’accès de l’agent.',
  'privacy.mode.localOnly': 'Local uniquement',
  'privacy.mode.localOnlyDesc':
    'Uniquement les modèles sur l’appareil. Les appels aux modèles externes sont bloqués.',
  ...
  'privacy.mode.sensitiveDesc':
    'Précautions supplémentaires pour les données sensibles. D’autres contrôles arrivent bientôt.',
  ...
  'conversations.toolFailure.notFound.cause':
    "Ce que cette action demandait n'existe pas ou n'est pas disponible ici.",
  'conversations.toolFailure.notFound.next':
    "Aucune action nécessaire. L'assistant peut chercher le bon nom et réessayer.",
  'conversations.toolFailure.unsupported.cause':
    'OpenHuman ne peut pas encore faire cela automatiquement.',
  'conversations.toolFailure.unsupported.next':
    'Faites-le manuellement ou demandez une autre option.',
  ...
  'conversations.backgroundTasks.running': "{count} en cours d'exécution",
  'conversations.backgroundTasks.noneRunning': 'aucun ne fonctionne',
  'conversations.backgroundTasks.total': 'Total {count}',
  'conversations.backgroundTasks.empty':
    "Aucune tâche en arrière-plan dans ce chat. Demandez à l'assistant de faire quelque chose en arrière-plan et cela apparaîtra ici.",
  ...
  'conversations.backgroundTasks.statusNeedsYou': 'A besoin de toi',
  'conversations.backgroundTasks.statusCancelled': 'Annulé',
  'conversations.backgroundTasks.toolCallOne': "Appel d'outil {count}",
  'conversations.backgroundTasks.toolCallOther': "Appels d'outil {count}",
  'conversations.backgroundTasks.steps': 'Étapes {count}',
  ...
  'conversations.backgroundTasks.inboxReady': '{count} prêtes',
  'conversations.backgroundTasks.inboxInFlight': '{count} en cours',
  'conversations.backgroundTasks.memoryJobTitle': 'Synchronisation de la mémoire',
  'conversations.backgroundTasks.cancelJob': 'Annuler',
  ...
  'nav.discord': 'Rejoindre notre Discord',
  ...
  'nav.brain': 'Cerveau',
  'nav.flows': 'Workflows',
  'nav.workflowRuns': 'Exécutions de workflows',
  'nav.workflowDiscoveries': 'Découvrir des workflows',
  ...
  'skills.explorer.colSkill': 'Compétence',
  'skills.explorer.colDescription': 'Description',
  'skills.explorer.colProvider': 'Fournisseur',
  ...
  'sync.nowSyncing.title': 'Synchronisation en cours',
  'sync.nowSyncing.empty': 'Aucune synchronisation en cours.',
  'common.error': 'Erreur',
  ...
  'settings.tokenUsage.attributedTo': 'Coût calculé pour {model}',
  'settings.tokenUsage.tokensSaved': 'Tokens économisés',
  'settings.tokenUsage.costSaved': 'Coût économisé',
  'settings.tokenUsage.cacheOccupancy': 'Originaux mis en cache',
  'settings.tokenUsage.compactions': 'Compactages',
  'settings.tokenUsage.overEvents': 'sur {count} compactages',
  'settings.tokenUsage.byCompressor': 'Par compresseur',
  ...
  'chat.connectionState.dropped': 'Connexion perdue. L’exécution a continué sur le serveur.',
  'chat.connectionState.reconnect': 'Se reconnecter',
  'chat.connectionState.reconnecting': 'Reconnexion en cours',
  'chat.connectionState.resumed': 'Le flux a repris.',
  ...
  'chat.reasoning.thoughtFor': 'A réfléchi pendant {n}',
  'chat.reasoning.thoughtBriefly': 'A réfléchi brièvement',
  ...
  'skills.explorer.sourceFilterAria': 'Filtrer par source',
  ...
  'skills.rows.installedTitle': 'Skills installés',
  'skills.rows.installedIntro':
    'Les skills que votre agent peut exécuter sur cette machine. Ouvrez-en un pour ses détails ; exécutez, modifiez ou supprimez-le depuis sa ligne.',
  'skills.rows.registryTitle': 'Annuaire des skills',
  'skills.rows.registryIntro':
    'Catalogues de skills à installer. Cherchez, puis installez-en un dans vos skills utilisateur.',
  'skills.rows.open': 'Ouvrir {name}',
  'skills.rows.run': 'Exécuter {name}',
  'skills.rows.edit': 'Modifier {name}',
  'skills.rows.remove': 'Supprimer {name}',
  ...
  'skills.explorer.notInstallable': 'Non installable',
  'skills.explorer.notInstallableHint':
    "Cette entrée n'a pas de SKILL.md à télécharger, elle ne peut donc pas être installée ici.",
  ...
  'connections.browser.notVerified': 'Non vérifié',
  'connections.browser.localOverride':
    'Un module local est requis avant la publication des archives.',
  'connections.browser.testModule': 'Tester le module',
  'connections.browser.enabled': 'Activer le navigateur',
  'connections.browser.headless': 'Sans interface',
  'connections.browser.width': 'Largeur de fenêtre',
  'connections.browser.height': 'Hauteur de fenêtre',
  'connections.browser.chromePath': 'Chemin de Chrome (facultatif)',
  'connections.browser.profileMode': 'Profil',
  'connections.browser.fresh': 'Nouveau profil',
  'connections.browser.persistent': 'Profil persistant',
  'connections.browser.profilePath': 'Dossier du profil',
  'connections.browser.downloadDir': 'Dossier de téléchargement',
  'connections.browser.maxSteps': 'Nombre maximal d’étapes',
  'connections.browser.timeout': 'Délai (secondes)',
  'connections.browser.allowedWebsites': 'Sites autorisés',
  'connections.browser.sharedPolicy':
    'Le navigateur et la recherche Web partagent la même règle de sites.',
  'connections.browser.manageWebsites': 'Gérer les sites autorisés',
  'connections.browser.jevRoute': 'Facturation Jev',
  'connections.browser.routeDirect': 'OpenRouter direct',
  ...
  'connections.browser.chromeReady': 'Chrome prêt',
  'connections.browser.chromeNotReady': 'Chrome indisponible',
  'connections.browser.readinessChecked': 'État vérifié',
  'connections.browser.boundsRequired':
    'Utilisez une largeur de 320–3840, une hauteur de 240–2160, 1–100 étapes et un délai de 5–600 secondes.',
  'connections.browser.noneAllowed': 'Aucun site autorisé',
  'connections.browser.moduleChecked': 'Module vérifié',
  ...
  'desktop.approvalSummary': '{operation} « {target} » dans {app}',
  'desktop.action.click': 'Cliquez sur',
  'desktop.action.type_text': 'Saisissez du texte dans',
  'desktop.action.check': 'Cochez',
  'desktop.action.uncheck': 'Décochez',
  ...
  'desktop.enabledPending':
    'Activé. Terminez la configuration ci-dessous avant d’utiliser les outils du bureau.',
  'desktop.moduleUnavailable':
    'Le module du bureau est indisponible. Vérifiez son état et réessayez.',
  'desktop.pendingUnavailable':
    'Impossible de charger les approbations du bureau en attente. Actualisez pour réessayer.',
  'desktop.unsupported': 'Le contrôle du bureau n’est pas disponible dans cet environnement.',
  'desktop.localOnly': 'Ce réglage ne s’applique qu’à cet ordinateur.',
  'desktop.permissions': 'Autorisations système',
  'desktop.permission.accessibility': 'Accessibilité',
  'desktop.permission.screen_recording': 'Enregistrement de l’écran',
  'desktop.openSettings': 'Ouvrir les réglages',
  'desktop.captureNote':
    'L’enregistrement de l’écran ne sert qu’aux captures. L’accessibilité permet d’inspecter et de contrôler les applications.',
  'desktop.testDescription':
    'Vérifiez que le cœur peut voir les applications ouvertes sur cet ordinateur.',
  'desktop.testButton': 'Tester l’accès au bureau',
  'desktop.testPassed': 'L’accès au bureau fonctionne.',
  'desktop.testFailed': 'Impossible de vérifier l’accès au bureau.',
  ...
  'memoryTree.status.storedItemsTile': 'Éléments stockés',
  ...
  'memoryTree.status.jobQueue':
    'Tâches de mémoire : {ready} en attente, {running} en cours, {failed} en échec',
  ...
  'settings.costDashboard.unknownProvider': 'Aucun',
  ...
  'mcp.tab.tablistAria': 'Vues MCP',
  'mcp.rows.showTools': 'Afficher les outils de {name}',
  'mcp.rows.hideTools': 'Masquer les outils de {name}',
  'mcp.rows.toolsLoading': 'Lecture des outils…',
  'mcp.rows.toolsFailed': 'Impossible de lire les outils.',
  'mcp.rows.add': 'Ajouter un serveur',
  ...
  'mcp.form.transportStdio': 'Commande locale (stdio)',
  ...
  'mcp.form.authNone': 'Aucune',
  'mcp.form.authBearer': 'Jeton Bearer',
  'mcp.form.authHeader': 'En-tête personnalisé',
  'mcp.form.authOauth': 'Se connecter avec le navigateur (OAuth)',
  'mcp.form.token': 'Jeton',
  ...
  'mcp.form.saving': 'Enregistrement…',
  'mcp.form.saveFailed': 'Impossible d’enregistrer le serveur.',
  'mcp.rows.title': 'Serveurs installés',
  'mcp.rows.intro':
    'Les serveurs MCP que votre agent peut appeler, tels que déclarés dans mcp.json. Ouvrez un serveur pour ses identifiants et ses outils.',
  'mcp.rows.open': 'Ouvrir {name}',
  'mcp.rows.connect': 'Connecter {name}',
  'mcp.rows.disconnect': 'Déconnecter {name}',
  'mcp.rows.enable': 'Activer {name}',
  'mcp.rows.disable': 'Désactiver {name}',
  'mcp.rows.remove': 'Supprimer {name}',
  'mcp.rows.removeTitle': 'Supprimer {name} ?',
  'mcp.rows.removeBody':
    'Le serveur et ses identifiants stockés sont supprimés. Le déclarer à nouveau dans mcp.json repart de zéro.',
  'mcp.rows.opFailed': 'L’action a échoué.',
  ...
  'mcp.tab.action.openPage': 'Ouvrir la page',
  ...
  'mcp.json.saving': 'Enregistrement…',
  'mcp.json.save': 'Enregistrer',
  'mcp.json.revert': 'Annuler les modifications',
  ...
  'token.popInput': 'Jetons d’entrée',
  ...
  'memorySources.stage.requested': 'Démarrage',
  'memorySources.stage.running': 'Synchronisation',
  'memorySources.stage.fetching': 'Récupération',
  'memorySources.stage.stored': 'Enregistrement',
  'memorySources.stage.queued': 'Traitement dans la mémoire',
  'memorySources.stage.ingesting': 'Traitement dans la mémoire',
  'memorySources.stage.unknown': 'Synchronisation',
  ...
  'welcome.gatewaySessionErrorFallback':
    'La connexion n’a pas pu être terminée pour le moment. Le stockage de session n’a pas répondu à temps (même après plusieurs tentatives). Redémarrez OpenHuman et réessayez.',
  ...
  'composio.colApp': 'Application',
  'composio.colStatus': 'Statut',
  'composio.colAccounts': 'Comptes',
  ...
  'chat.approval.expiresIn': 'Expire dans {time}',
  'chat.elicitation.send': 'Envoyer',
  'chat.elicitation.decline': 'Refuser',
  'chat.elicitation.needsInput': 'besoin d’informations',
  'chat.elicitation.sentTo': 'Envoyé à {server}',
  'chat.elicitation.declined': 'Refusé',
  'chat.elicitation.title': 'Nécessite votre réponse',
  ...
  'composio.connect.cancelNotConfirmed':
    "Composio n'a pas confirmé la suppression de la connexion. Réessayez.",
  ...
  'conversations.composer.context.usage': 'Utilisation du contexte',
  'conversations.composer.context.full': 'Rempli à {percent} %',
  'conversations.composer.context.reasoning': 'Raisonnement',
  'conversations.composer.context.headroom': 'Marge restante',
  'conversations.composer.context.meterLabel': 'Utilisation du contexte : {label}',
  'conversations.composer.context.meterValue': '{used} sur {limit}',
  'conversations.composer.context.loading': 'Mesure du contexte…',
  'conversations.composer.context.errorTitle': 'Répartition du contexte indisponible',
  ...
  'conversations.composer.command.stop': 'Arrêter la réponse en cours',
  'conversations.composer.command.plan':
    'Planifier d’abord : relire les étapes avant toute exécution',
  'conversations.composer.command.build': 'Construire : laisser l’agent agir directement',
  'conversations.composer.trigger.back': 'Retour',
  'conversations.composer.trigger.loading': 'Chargement…',
  'conversations.composer.trigger.emptyCategories': 'Aucun élément disponible',
  'conversations.composer.slash.empty': 'Aucune commande correspondante',
  'conversations.composer.mention.empty': 'Aucun élément correspondant',
  'conversations.composer.mention.memory': 'Mémoire',
  'conversations.composer.mention.files': 'Fichiers',
  ...
  'conversations.planReview.approve': 'Approuver et exécuter',
  'conversations.planReview.reject': 'Rejeter',
  'conversations.planReview.feedbackLabel': 'Demander des modifications',
  'conversations.planReview.feedbackPlaceholder': 'Décrivez ce qu’il faut changer…',
  'conversations.planReview.sendFeedback': 'Envoyer un retour',
  'conversations.planReview.revise': 'Réviser',
  'conversations.runMode.plan': 'Plan',
  'conversations.runMode.build': 'Build',
  'conversations.runMode.toggleLabel': 'Basculer entre le mode plan et le mode build',
  ...
  'conversations.tools.parallelAgentsAggregating': 'Agrégation des résultats',
  ...
  'conversations.tools.inspectDesktop.active': 'Inspection du bureau en cours',
  'conversations.tools.inspectDesktop.done': 'Bureau inspecté',
  'conversations.tools.controlDesktop.active': 'Contrôle du bureau en cours',
  'conversations.tools.controlDesktop.done': 'Bureau contrôlé',
  ...
  'conversations.tools.document.title': 'Document',
  'conversations.tools.presentation.title': 'Présentation',
  ...
  'conversations.subagent.transcript.instruction': 'instruction',
  'conversations.subagent.transcript.agent': 'agent',
  'conversations.subagent.transcript.system': 'système',
  'conversations.tasks.taskOne': 'tâche',
  'conversations.tasks.taskOther': 'tâches',
  'conversations.tasks.running': 'en cours',
  'conversations.tasks.waitingForInput': 'en attente de réponse',
  'conversations.tasks.done': 'terminée',
  'conversations.tasks.failed': 'échouée',
  'conversations.tasks.of': 'sur',
  ...
  'conversations.memoryChips.remembered': '{n} mémorisé(s)',
  'conversations.memoryChips.idle': 'mémoire',
  'conversations.memoryChips.forgetAriaLabel': 'Oublier « {text} »',
  'conversations.scheduleCard.next': 'prochain',
  'conversations.scheduleCard.paused': 'en pause',
  'conversations.scheduleCard.recentRuns': 'exécutions récentes',
  'conversations.scheduleCard.ok': 'ok',
  'conversations.scheduleCard.failed': 'échoué',
  'conversations.conversationSearch.placeholder': 'Rechercher dans la conversation',
  'conversations.conversationSearch.previousMatch': 'Correspondance précédente',
  'conversations.conversationSearch.nextMatch': 'Correspondance suivante',
  'conversations.conversationSearch.timelineToggle': 'Chronologie',
  ...
  'conversations.agentTaskInsights.done': 'Terminé',
  'conversations.agentTaskInsights.failed': 'Échec',
  'conversations.agentTaskInsights.running': 'En cours',
  'conversations.agentTaskInsights.cancelled': 'Annulé',
  'conversations.agentTaskInsights.awaitingUser': 'En attente de saisie',
  'conversations.agentTaskInsights.viewDetails': 'Voir les détails',
  'conversations.agentTaskInsights.subagentsHeading': 'Sous-agents',
  ...
  'notifications.flow.approveTitle': 'Le workflow nécessite une approbation',
  'notifications.flow.approve': 'Approuver',
  'notifications.flow.approving': 'Approbation en cours…',
  'notifications.flow.dismiss': 'Ignorer',
  'notifications.flow.error': 'Impossible de reprendre le workflow. Veuillez réessayer.',
  ...
  'flowRuns.inspector.output': 'Afficher la sortie brute',
  'flowRuns.inspector.summary.failedPrefix': 'Impossible de terminer :',
  'flowRuns.inspector.summary.unknownError': "une erreur s'est produite",
  'flowRuns.inspector.summary.itemsFetched': '{count} élément(s) récupéré(s)',
  'flowRuns.inspector.summary.completed': 'Étape terminée',
  'flowRuns.inspector.summary.noOutput': 'Aucune sortie produite',
  ...
  'flows.page.description':
    'Automatisations enregistrées que vous pouvez activer, exécuter et surveiller.',
  'flows.page.emptyTitle': "Aucun workflow pour l'instant",
  ...
  'flows.discoveries.title': 'Découvertes de workflows',
  'flows.discoveries.description':
    'Automatisations suggérées par Flow Scout, selon votre façon de travailler.',
  'flows.allRuns.title': 'Exécutions de workflows',
  'flows.allRuns.description':
    'Chaque exécution de workflow de votre espace, les plus récentes en premier.',
  'flows.allRuns.loading': 'Chargement des exécutions…',
  'flows.allRuns.empty': 'Aucune exécution de workflow pour l’instant.',
  'flows.allRuns.unknownWorkflow': 'Workflow inconnu',
  'flows.allRuns.status.running': 'En cours',
  'flows.allRuns.status.completed': 'Terminé',
  'flows.allRuns.status.completed_with_warnings': 'Terminé avec avertissements',
  ...
  'flows.list.runNow': 'Exécuter',
  'flows.list.running': 'Exécution…',
  'flows.list.viewRuns': 'Voir les exécutions',
  'flows.list.toggleEnabled': 'Activer le workflow',
  ...
  'flows.copilot.tool.proposing': 'Proposition du workflow…',
  ...
  'flows.nodeKind.tool_call': "Appel d'outil",
  'flows.nodeKind.http_request': 'Requête HTTP',
  'flows.nodeKind.code': 'Code',
  'flows.nodeKind.condition': 'Condition',
  'flows.nodeKind.switch': 'Aiguillage',
  'flows.nodeKind.merge': 'Fusionner',
  'flows.nodeKind.split_out': 'Répartition de sortie',
  ...
  'flows.nodeSummary.trigger.appEvent': "Se déclenche sur un événement d'application",
  'flows.nodeSummary.trigger.unknownKind': 'Déclencheur : {kind}',
  'flows.nodeSummary.agent.defaultModel': 'modèle par défaut',
  'flows.nodeSummary.agent.withPrompt': '“{prompt}” · {model}',
  'flows.nodeSummary.agent.default': 'Interroge {model}',
  'flows.nodeSummary.toolCall.runsNative': 'Exécute {name}',
  'flows.nodeSummary.toolCall.pickNative': 'Exécute un outil OpenHuman (à choisir)',
  'flows.nodeSummary.toolCall.runs': 'Exécute {slug}',
  'flows.nodeSummary.toolCall.pick': "Exécute une action d'app (à choisir)",
  'flows.nodeSummary.http.withUrl': '{method} {url}',
  'flows.nodeSummary.http.noUrl': 'Requête {method} (définissez une URL)',
  'flows.nodeSummary.code.runs': 'Exécute du code {lang}',
  'flows.nodeSummary.condition.withField': 'Si {field} → vrai / faux',
  'flows.nodeSummary.condition.default': 'Se ramifie en vrai / faux',
  'flows.nodeSummary.switch.byExpr': 'Route selon {expr}',
  'flows.nodeSummary.switch.byExprWithRoutes': 'Route selon {expr} ({count} routes)',
  'flows.nodeSummary.switch.byValue': 'Route selon une valeur',
  'flows.nodeSummary.switch.byValueWithRoutes': 'Route selon une valeur ({count} routes)',
  'flows.nodeSummary.merge': 'Fusionne les branches parallèles',
  'flows.nodeSummary.splitOut.withPath': 'Divise chaque {path}',
  'flows.nodeSummary.splitOut.default': 'Divise une liste en éléments',
  'flows.nodeSummary.transform.default': 'Remodèle chaque élément',
  'flows.nodeSummary.transform.setFieldsSingular': 'Définit {n} champ sur chaque élément',
  'flows.nodeSummary.transform.setFieldsPlural': 'Définit {n} champs sur chaque élément',
  'flows.nodeSummary.outputParser': 'Analyse la sortie précédente',
  'flows.nodeSummary.subWorkflow': 'Exécute un workflow imbriqué',
  'flows.nodeSummary.memory.flavourWith': 'Lit le style « {flavour} »',
  'flows.nodeSummary.memory.flavour': 'Lit un style de mémoire',
  'flows.nodeSummary.memory.people': 'Consulte la mémoire des personnes',
  'flows.nodeSummary.memory.remember': 'Enregistre une valeur dans ce workflow',
  'flows.nodeSummary.memory.forget': 'Oublie une valeur de ce workflow',
  'flows.nodeSummary.memory.searchScoped': 'Recherche dans la mémoire ({scope})',
  'flows.nodeSummary.memory.search': 'Recherche dans la mémoire',
  'flows.nodeSummary.memory.recallScoped': 'Rappelle depuis la mémoire ({scope})',
  ...
  'flows.cron.customSchedule': 'Planning personnalisé ({expr})',
  'flows.cron.noScheduleSet': 'Aucun planning défini',
  'flows.cron.weekdays': 'jours de semaine',
  'flows.cron.weekends': 'week-ends',
  'flows.cron.everyMinute': 'Toutes les minutes',
  'flows.cron.everyMinuteOnDays': 'Toutes les minutes les {days}',
  'flows.cron.everyNMinutes': 'Toutes les {n} minutes',
  'flows.cron.everyNMinutesOnDays': 'Toutes les {n} minutes les {days}',
  'flows.cron.everyHour': 'Toutes les heures',
  'flows.cron.everyHourOnDays': 'Toutes les heures les {days}',
  'flows.cron.everyNHours': 'Toutes les {n} heures',
  'flows.cron.everyNHoursOnDays': 'Toutes les {n} heures les {days}',
  'flows.cron.everyDayAtTime': 'Tous les jours à {time}',
  'flows.cron.atTimeOnDays': 'À {time} les {days}',
  'flows.cron.invalidInterval': 'Intervalle invalide',
  'flows.cron.dailyEvery24h': 'Quotidien (toutes les 24 h)',
  'flows.cron.everyNDays': 'Tous les {n} jours',
  'flows.cron.everyNHoursShort': 'Toutes les {n} h',
  'flows.cron.everyNMinutesShort': 'Toutes les {n} min',
  'flows.cron.everySecond': 'Toutes les secondes',
  'flows.cron.everyNSeconds': 'Toutes les {n} s',
  'flows.cron.onceAtRaw': 'Une fois le {at}',
  'flows.cron.onceAt': 'Une fois le {at}',
  ...
  'pages.settings.account.migration': 'Importer',
  ...
  'settings.ai.providers.groupLocal': 'Environnements locaux',
  'settings.ai.providers.groupCli': 'Connexions CLI',
  'settings.ai.providers.cliDetail': 'Utilise une connexion que possède déjà une autre CLI',
  'settings.ai.providers.connected': 'Connecté',
  'settings.ai.providers.managedDetail': 'OpenHuman choisit un modèle pour chaque tâche',
  'settings.ai.providers.rowActions': 'Autres actions pour {provider}',
  'settings.ai.providers.replaceKey': 'Remplacer la clé API',
  'settings.ai.providers.custom': 'Personnalisé',
  'settings.ai.providers.addProvider': 'Ajouter un fournisseur',
  'settings.ai.providers.addProviderSubtitle':
    'Choisissez un fournisseur à connecter. Vous pouvez en ajouter à tout moment.',
  'settings.ai.providers.placeholderCloud': 'Choisissez un fournisseur cloud…',
  ...
  'settings.ai.providers.groupConnected': 'Connecté',
  'settings.ai.providers.localDetail': 'Fonctionne sur cet appareil',
  ...
  'settings.ai.routing.workload.chat.hint':
    'Recommandé : un modèle de chat rapide bon marché ou moyen avec un nombre élevé de jetons/s et une faible latence. Les modèles locaux open source peuvent bien fonctionner ici s’ils se sentent réactifs.',
  'settings.ai.routing.workload.reasoning.label': 'Reasoning',
  'settings.ai.routing.workload.reasoning.description':
    'Agent de chat principal, synthétiseur de réunion : mode « Raisonnement » dans Conversations',
  'settings.ai.routing.workload.reasoning.hint':
    "Recommandé : une frontière plus coûteuse ou un modèle de raisonnement solide pour une réflexion approfondie. Ceci est utilisé pour l'agent de chat principal, les résumés de réunions et la synthèse de réponses plus lourde.",
  'settings.ai.routing.workload.agentic.label': 'Agentic',
  'settings.ai.routing.workload.agentic.description':
    "Exécuteurs de sous-agents, boucles d'outils, décisions GIF",
  'settings.ai.routing.workload.agentic.hint':
    'Recommandé : un modèle fiable qui suit les instructions et utilise fortement les outils. Les modèles frontières à prix moyen sont généralement les plus sûrs ; les modèles open source compatibles peuvent fonctionner si l’appel de l’outil est stable.',
  'settings.ai.routing.workload.coding.label': 'Coding',
  'settings.ai.routing.workload.coding.description':
    'Génération de code et passes de refactorisation',
  'settings.ai.routing.workload.coding.hint':
    "Recommandé : un modèle adapté au codage avec un suivi des instructions solide, une qualité d'édition et des performances dans un contexte long. Cela vaut généralement la peine de dépenser plus.",
  'settings.ai.routing.workload.vision.label': 'Vision',
  'settings.ai.routing.workload.vision.description':
    "Compréhension d'images pour le sous-agent vision : toujours multimodale",
  ...
  'settings.theme.variantAuto': 'Automatique',
  'settings.theme.variantAria': 'Variante de thème',
  'settings.theme.backdropHeading': 'Arrière-plan',
  ...
  'settings.theme.group.accents': "Couleurs d'accentuation",
  'settings.theme.showShades': "Afficher toutes les nuances d'accentuation",
  'settings.theme.hideShades': "Masquer toutes les nuances d'accentuation",
  'settings.theme.fontsHeading': 'Polices',
  'settings.theme.fontRole.title': 'Titre',
  'settings.theme.fontRole.heading': 'En-tête',
  'settings.theme.fontRole.body': 'Corps de texte',
  'settings.theme.fontRole.mono': 'Largeur fixe',
  'settings.theme.fontRole.serif': 'Serif',
  'settings.theme.fontCurrent': 'Actuelle',
  'settings.theme.actions': 'Gérer le thème',
  'settings.theme.reset': 'Réinitialiser les remplacements',
  'settings.theme.delete': 'Supprimer le thème',
  ...
  'skills.meetingBots.history.participantCount': 'Participant {count}',
  'skills.meetingBots.history.participantCountPlural': 'Participants au {count}',
  ...
  'skills.meetingBots.upcoming.participants': 'Participants au {count}',
  ...
  'settings.gateway.use': 'Utiliser celui-ci',
  'settings.gateway.inUse': 'Utilisé',
  'settings.gateway.activating': 'Connexion…',
  'settings.gateway.activatingStep': 'Connexion : {step}',
  'settings.gateway.connected': 'Connecté à {endpoint}',
  'settings.gateway.failed': 'Connexion impossible : {reason}',
  'settings.gateway.nameLabel': 'Nom',
  'settings.gateway.namePlaceholder': 'Serveur de build',
  'settings.gateway.whereLegend': 'Où doit-il s’exécuter ?',
  ...
  'settings.gateway.kind.desktop': 'Dans cette application',
  'settings.gateway.kind.remote': 'Un cœur à une URL',
  'settings.gateway.kind.docker': 'Dans un conteneur ici',
  'settings.gateway.kind.ssh': 'Sur une autre machine',
  'settings.gateway.kind.ssh+docker': 'Dans un conteneur sur une autre machine',
  'settings.gateway.kind.local-process': 'Sur cet ordinateur',
  'settings.gateway.idRequired': 'Donnez un nom à cet emplacement.',
  'settings.gateway.idReserved': 'Ce nom est réservé au cœur intégré de l’application.',
  'settings.gateway.destinationRequired': 'Indiquez la machine à laquelle se connecter.',
  'settings.gateway.imageRequired': 'Indiquez l’image de conteneur à exécuter.',
  ...
  'settings.ai.picker.searchPlaceholder': 'Rechercher des modèles',
