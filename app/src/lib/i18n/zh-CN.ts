...
const messages: TranslationMap = {
  ...
  'conversations.assistantUi.edit.ariaLabel': '编辑你的消息',
  'conversations.assistantUi.edit.discardedRepliesOne': '发送将丢弃 {count} 条回复',
  'conversations.assistantUi.edit.discardedRepliesOther': '发送将丢弃 {count} 条回复',
  'conversations.assistantUi.stoppedRun.reasonUserStop': '已停止',
  'conversations.assistantUi.stoppedRun.reasonSuperseded': '已被新消息替代',
  ...
  'conversations.toolFailure.notFound.cause': '此操作请求的内容不存在，或在此处不可用。',
  'conversations.toolFailure.notFound.next': '无需任何操作。助手可以查找正确的名称后重试。',
  'conversations.toolFailure.unsupported.cause': 'OpenHuman 目前还无法自动完成此操作。',
  'conversations.toolFailure.unsupported.next': '请手动完成，或换一个选项。',
  ...
  'conversations.backgroundTasks.inboxReady': '{count} 个已完成',
  'conversations.backgroundTasks.inboxInFlight': '{count} 个进行中',
  'conversations.backgroundTasks.memoryJobTitle': '记忆同步',
  'conversations.backgroundTasks.cancelJob': '取消',
  ...
  'sync.nowSyncing.title': '当前同步',
  'sync.nowSyncing.empty': '目前没有正在进行的同步。',
  'common.error': '错误',
  'common.success': '成功',
  'common.back': '返回',
  'common.next': '下一步',
  ...
  'chat.welcomeSuggestion.calendarToday': '我今天的日程有什么？',
  'chat.welcomeSuggestion.unreadEmail': '总结我的未读邮件。',
  'chat.welcomeSuggestion.draftReply': '为我最近收到的消息起草一条回复。',
  'chat.welcomeSuggestion.followUps': '我这周说过要跟进什么？',
  ...
  'chat.messageQueue.running': '运行中',
  'chat.messageQueue.queuedCount': '{count} 条排队中',
  'chat.messageQueue.pendingHint': '完成后发送',
  'chat.messageQueue.remove': '从队列中移除“{text}”',
  'chat.connectionState.dropped': '连接已断开。运行仍在服务器上继续。',
  'chat.connectionState.reconnect': '重新连接',
  'chat.connectionState.reconnecting': '正在重新连接',
  'chat.connectionState.resumed': '已重新接上数据流。',
  ...
  'skills.rows.run': '运行 {name}',
  'skills.rows.edit': '编辑 {name}',
  'skills.rows.remove': '移除 {name}',
  ...
  'connections.tabs.browser': '浏览器控制',
  'connections.browser.description': '设置浏览器任务并检查就绪状态。',
  'connections.earlyAlphaNotice':
    '早期 Alpha：浏览器和桌面控制仍在测试中。操作可能出现意外行为，也可能在不同版本间发生变化。',
  'connections.browser.module': '模块',
  'connections.browser.chrome': 'Chrome',
  'connections.browser.unknown': '未知',
  'connections.browser.notVerified': '未验证',
  'connections.browser.localOverride': '发布存档前需要本地模块覆盖。',
  'connections.browser.testModule': '测试模块',
  'connections.browser.enabled': '启用浏览器',
  'connections.browser.headless': '无头模式',
  'connections.browser.width': '视口宽度',
  'connections.browser.height': '视口高度',
  'connections.browser.chromePath': 'Chrome 路径（可选）',
  'connections.browser.profileMode': '配置文件',
  'connections.browser.fresh': '全新配置文件',
  'connections.browser.persistent': '持久配置文件',
  'connections.browser.profilePath': '配置文件目录',
  'connections.browser.downloadDir': '下载目录',
  'connections.browser.maxSteps': '最大任务步骤数',
  'connections.browser.timeout': '超时（秒）',
  'connections.browser.allowedWebsites': '允许的网站',
  'connections.browser.sharedPolicy': '浏览器和网页搜索共用网站策略。',
  'connections.browser.manageWebsites': '管理允许的网站',
  'connections.browser.jevRoute': 'Jev 计费路线',
  'connections.browser.routeDirect': '直连 OpenRouter',
  'connections.browser.routeHosted': '托管代理',
  'connections.browser.testInConversation': '保存后在对话中测试网页。',
  'connections.browser.save': '保存设置',
  'connections.browser.saved': '设置已保存',
  'connections.browser.testBrowser': '测试 Chrome',
  'connections.browser.chromeReady': 'Chrome 已就绪',
  'connections.browser.chromeNotReady': 'Chrome 不可用',
  'connections.browser.readinessChecked': '就绪状态已检查',
  'connections.browser.boundsRequired':
    '宽度须为 320–3840，高度 240–2160，步骤数 1–100，超时 5–600 秒。',
  'connections.browser.noneAllowed': '没有允许的网站',
  'connections.browser.moduleChecked': '模块已检查',
  'connections.tabs.skills': '技能',
  'connections.tabs.meetings': '会议',
  'connections.groups.integrations': '集成',
  'connections.groups.desktop': '桌面',
  'desktop.approvalSummary': '在 {app} 中{operation}“{target}”',
  'desktop.action.click': '点击',
  'desktop.action.type_text': '输入文字到',
  'desktop.action.check': '勾选',
  'desktop.action.uncheck': '取消勾选',
  'desktop.action.expand': '展开',
  'desktop.action.collapse': '折叠',
  'desktop.action.scroll': '滚动',
  'desktop.title': '桌面控制',
  'desktop.description': '让智能体操作这台电脑上的应用。',
  'desktop.enabledPending': '已启用。使用桌面工具前，请完成下方设置。',
  'desktop.moduleUnavailable': '桌面模块不可用。请检查其状态并重试。',
  'desktop.pendingUnavailable': '无法加载待处理的桌面操作审批。请刷新后重试。',
  'desktop.unsupported': '此运行环境不支持桌面控制。',
  'desktop.localOnly': '此设置仅适用于这台电脑。',
  'desktop.permissions': '系统权限',
  'desktop.permission.accessibility': '辅助功能',
  'desktop.permission.screen_recording': '屏幕录制',
  'desktop.openSettings': '打开设置',
  'desktop.captureNote': '仅截图需要屏幕录制权限。查看和控制应用需要辅助功能权限。',
  'desktop.testDescription': '检查核心能否看到这台电脑上运行的应用。',
  'desktop.testButton': '测试桌面访问',
  'desktop.testPassed': '桌面访问正常。',
  'desktop.testFailed': '无法验证桌面访问。',
  ...
  'memoryTree.status.jobQueue': '记忆任务：{ready} 个等待中，{running} 个运行中，{failed} 个失败',
  ...
  'settings.usage.menuDesc': '费用、Token 节省、使用记录和后台活动',
  'settings.costDashboard.monthToDate': '本月至今',
  'settings.costDashboard.period': '时间范围',
  'settings.costDashboard.periodDays': '最近 {days} 天',
  'settings.costDashboard.all': '全部',
  'settings.costDashboard.costSource': '费用来源',
  'settings.costDashboard.estimated': '估算',
  'settings.costDashboard.providerCharged': '服务商计费',
  'settings.costDashboard.searchModelSession': '模型或会话',
  'settings.costDashboard.filteredTotal': '已加载 {loaded} 条，显示 {shown} 条 • {cost}',
  ...
  'settings.costDashboard.subtitle': '本地服务商调用用量。费用可能是估算值；托管计费单独计算。',
  ...
  'mcp.rows.showTools': '显示 {name} 的工具',
  'mcp.rows.hideTools': '隐藏 {name} 的工具',
  'mcp.rows.toolsLoading': '正在读取工具…',
  'mcp.rows.toolsFailed': '无法读取工具。',
  'mcp.rows.add': '添加服务器',
  'mcp.rows.edit': '编辑 {name}',
  'mcp.form.addTitle': '添加 MCP 服务器',
  'mcp.form.editTitle': '编辑 {name}',
  'mcp.form.subtitle': '本地命令或远程端点，以及认证所需的信息。会写入你的 mcp.json。',
  'mcp.form.name': '名称',
  'mcp.form.nameHint': '字母、数字、点、短横线。这是 mcp.json 中的键。',
  'mcp.form.transport': '传输方式',
  'mcp.form.transportStdio': '本地命令 (stdio)',
  'mcp.form.transportHttp': '远程 URL (HTTP)',
  'mcp.form.command': '命令',
  'mcp.form.args': '参数',
  'mcp.form.argsHint': '以空格分隔；含空格的参数请加引号。',
  'mcp.form.env': '环境变量',
  'mcp.form.envHint': '传递给命令。值会加密存储且不再显示。',
  'mcp.form.envKey': '变量名',
  'mcp.form.envValue': '值',
  'mcp.form.value': '值',
  ...
  'mcp.form.auth': '认证',
  'mcp.form.authNone': '无',
  'mcp.form.authBearer': 'Bearer 令牌',
  'mcp.form.authHeader': '自定义请求头',
  'mcp.form.authOauth': '使用浏览器登录 (OAuth)',
  'mcp.form.token': '令牌',
  'mcp.form.tokenHint': '以 Authorization: Bearer <token> 形式发送。',
  'mcp.form.headerName': '请求头名称',
  'mcp.form.headerValue': '请求头值',
  'mcp.form.oauthHint': '保存后，浏览器会打开服务器的登录页面；返回后连接即完成。',
  'mcp.form.add': '添加服务器',
  'mcp.form.save': '保存',
  'mcp.form.saveAndSignIn': '保存并登录',
  'mcp.form.saving': '正在保存…',
  'mcp.form.saveFailed': '无法保存服务器。',
  ...
  'mcp.rows.enable': '启用 {name}',
  'mcp.rows.disable': '禁用 {name}',
  'mcp.rows.remove': '移除 {name}',
  'mcp.rows.removeTitle': '移除 {name}？',
  'mcp.rows.removeBody': '服务器及其存储的凭据将被移除。在 mcp.json 中重新声明会从头开始。',
  'mcp.rows.opFailed': '操作失败。',
  ...
  'memorySources.folderPathUnavailable': '无法确定该文件夹的位置。请改为输入其完整路径。',
  ...
  'memorySources.stage.requested': '正在开始',
  'memorySources.stage.running': '正在同步',
  'memorySources.stage.fetching': '正在获取',
  'memorySources.stage.stored': '正在保存',
  'memorySources.stage.queued': '正在存入记忆',
  'memorySources.stage.ingesting': '正在存入记忆',
  'memorySources.stage.unknown': '正在同步',
  'time.justNow': '刚刚',
  ...
  'chat.approval.expiresIn': '{time}后过期',
  'chat.elicitation.send': '发送',
  'chat.elicitation.decline': '拒绝',
  'chat.elicitation.needsInput': '需要输入',
  'chat.elicitation.sentTo': '已发送至 {server}',
  'chat.elicitation.declined': '已拒绝',
  'chat.elicitation.title': '需要您的回复',
  ...
  'conversations.composer.context.usage': '上下文用量',
  'conversations.composer.context.full': '已用 {percent}%',
  'conversations.composer.context.reasoning': '推理',
  'conversations.composer.context.headroom': '剩余空间',
  'conversations.composer.context.meterLabel': '{label} 上下文用量',
  'conversations.composer.context.meterValue': '{used}（共 {limit}）',
  'conversations.composer.context.loading': '正在测量上下文…',
  'conversations.composer.context.errorTitle': '上下文明细不可用',
  ...
  'conversations.composer.command.plan': '先规划：在执行前审阅步骤',
  'conversations.composer.command.build': '构建：让代理直接执行',
  'conversations.composer.trigger.back': '返回',
  'conversations.composer.trigger.loading': '加载中…',
  'conversations.composer.trigger.emptyCategories': '没有可用项目',
  'conversations.composer.slash.empty': '没有匹配的命令',
  'conversations.composer.mention.empty': '没有匹配的项目',
  'conversations.composer.mention.memory': '记忆',
  ...
  'conversations.planReview.revise': '修改',
  'conversations.runMode.plan': '计划',
  'conversations.runMode.build': '构建',
  'conversations.runMode.toggleLabel': '在计划模式和构建模式之间切换',
  ...
  'conversations.tools.inspectDesktop.active': '正在检查桌面',
  'conversations.tools.inspectDesktop.done': '已检查桌面',
  'conversations.tools.controlDesktop.active': '正在控制桌面',
  'conversations.tools.controlDesktop.done': '已控制桌面',
  ...
  'conversations.tools.document.title': '文档',
  'conversations.tools.presentation.title': '演示文稿',
  ...
  'conversations.subagent.transcript.instruction': '指令',
  'conversations.subagent.transcript.agent': '智能体',
  'conversations.subagent.transcript.system': '系统',
  'conversations.tasks.taskOne': '任务',
  'conversations.tasks.taskOther': '任务',
  'conversations.tasks.running': '运行中',
  'conversations.tasks.waitingForInput': '等待输入',
  'conversations.tasks.done': '已完成',
  'conversations.tasks.failed': '失败',
  'conversations.tasks.of': '共',
  ...
  'conversations.memoryChips.remembered': '已记住 {n} 项',
  'conversations.memoryChips.idle': '记忆',
  'conversations.memoryChips.forgetAriaLabel': '忘记"{text}"',
  'conversations.scheduleCard.next': '下一次',
  'conversations.scheduleCard.paused': '已暂停',
  'conversations.scheduleCard.recentRuns': '最近运行',
  'conversations.scheduleCard.ok': '成功',
  'conversations.scheduleCard.failed': '失败',
  'conversations.conversationSearch.placeholder': '在对话中查找',
  'conversations.conversationSearch.previousMatch': '上一个匹配项',
  'conversations.conversationSearch.nextMatch': '下一个匹配项',
  'conversations.conversationSearch.timelineToggle': '时间线',
  ...
  'settings.ai.managedSourceDetail': '由 TinyHumans 管理',
  ...
  'settings.developerMenu.eventLog.workspaceScope': '工作区范围',
  'settings.developerMenu.eventLog.workspaceScopeActive': '当前工作区',
  'settings.developerMenu.eventLog.workspaceScopeAll': '所有工作区',
  ...
  'walletBalances.earlyAlphaNotice':
    '早期 Alpha：钱包余额仍在测试中。金额和支持的网络可能在不同版本间发生变化。',
  'walletBalances.allNetworks': '所有网络',
  'walletBalances.manageTokens': '管理代币',
  'walletBalances.noFilterMatches': '没有符合筛选条件的余额',
  'walletBalances.colToken': '代币',
  ...
  'composer.settings.loadingModels': '正在加载模型…',
  ...
  'settings.ai.picker.searchPlaceholder': '搜索模型',
  ...
  'settings.ai.resetsAt': '将于 {time} 重置',
  'settings.ai.usedAmount': '已用 {amount}',
  ...
  'settings.ai.plannerSyncBreakdown': '规划器 {planner} + 同步 {sync}',
  'settings.ai.memoryPollsDetail': '{count} 次记忆轮询',
  'settings.ai.rowsLeftFormula': '剩余额度 / 平均单条 = {remaining} / {avgRow}',
  'settings.ai.needSpendRowsToEstimate': '需要最近的支出记录才能估算。',
  'settings.ai.rowsPerBudgetFormula': '周期预算 / 平均单条 = {budget} / {avgRow}',
  'settings.ai.burnRateSampleDetail': '在 {hours} 小时样本中每小时 {rows} 条',
  'settings.ai.needTimestampsForBurnRate': '需要至少两条支出记录的时间戳。',
  'settings.ai.projectedEmptyDetail': '按最近的消耗速度，将在最后一次支出后 {hours} 小时耗尽',
  'settings.ai.noProjectionWithoutSpend': '没有最近的每小时支出数据，无法预测。',
  'settings.ai.readsPerDollar': '每美元 {count} 次读取',
  'settings.ai.apiReadsFormula': '每周后台 API 读取次数 / 剩余额度 = {reads} / {remaining}',
  'settings.ai.needUsageToEstimate': '需要用量响应才能估算。',
  'settings.ai.composioSyncScansDetail': '{count} 个活跃集成连接，每 20 分钟扫描一次',
  'settings.ai.totalApiReadBudgetDetail': '日历规划器读取 + 定期集成扫描；不含用户发起的聊天工具',
  'settings.ai.memoryWorkerPollsDetail': '4 个工作进程每 5 秒轮询一次；仅对排队任务调用大模型',
  'settings.mcpServer.tools.listTools': '列出所有可用的 MCP 工具',
  'settings.mcpServer.tools.toolInstructions': '获取某个工具的使用说明',
  'settings.mcpServer.tools.listSubagents': '列出可用的子智能体',
  'settings.mcpServer.tools.runSubagent': '使用提示词运行子智能体',
  'settings.mcpServer.tools.memorySearch': '通过语义查询搜索记忆',
  'settings.mcpServer.tools.memoryRecall': '按 ID 检索特定记忆',
  ...
  'settings.notifications.category.skills.desc': '技能同步事件和 OAuth 状态变更。',
  'settings.notifications.category.system.title': '系统',
  'settings.notifications.category.system.desc': '连接问题、后台进程错误、更新。',
  'settings.notifications.category.meetings.title': '会议',
  'settings.notifications.category.meetings.desc': '由心跳检测到的即将到来的会议和日历事件。',
  'settings.notifications.category.reminders.title': '提醒',
  'settings.notifications.category.reminders.desc': '即将到来的提醒和 cron 任务安排的工作。',
  'settings.notifications.category.important.title': '重要事件',
  'settings.notifications.category.important.desc': '来自已连接来源的紧急或时效性事件。',
  ...
  'settings.cron.jobs.scheduleEvery': '每 {ms} 毫秒',
  'skills.category.all': '全部',
  'skills.category.builtIn': '内置',
  'skills.category.channels': '渠道',
  'skills.category.productivity': '效率工具',
  'skills.category.chat': '聊天',
  'skills.category.toolsAutomation': '工具与自动化',
  'skills.category.social': '社交',
  'skills.category.platform': '平台',
  'skills.category.other': '其他',
  'workspace.wipeSuccessTitle': '记忆已清除',
  'workspace.wipeSuccessMessage':
    '已移除 {rows} 行、{dirs} 个文件夹；已清除 {cursors} 个同步状态游标。请在已连接的来源上点击“同步”以重新填充。',
  'workspace.wipeFailedTitle': '重置失败',
  'workspace.resetTreeSuccessTitle': '正在重建记忆树',
  'workspace.resetTreeSuccessMessage':
    '已清除 {treeRows} 行树数据；已将 {chunks} 个片段重新排队（{jobs} 个提取任务）。随着工作进程推进，图谱将逐步填充。',
  'workspace.resetTreeFailedTitle': '无法重置记忆树',
  'workspace.buildTreesFailedTitle': '无法生成摘要树',
  'invites.redeemHeading': '有邀请码吗？',
  'invites.redeemPlaceholder': '邀请码',
  'invites.redeemSubmit': '兑换',
};
